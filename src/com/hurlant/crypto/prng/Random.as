package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         this.var_170 = new ByteArray();
         this.var_125 = 0;
         while(this.var_125 < this.psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = this.var_125++;
            this.var_170[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            this.var_170[_loc4_ = this.var_125++] = _loc2_ & 255;
         }
         this.var_125 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = this.var_125++;
         this.var_170[_loc2_] ^= param1 & 255;
         var _loc3_:* = this.var_125++;
         this.var_170[_loc3_] ^= param1 >> 8 & 255;
         var _loc4_:*;
         this.var_170[_loc4_ = this.var_125++] = this.var_170[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_170[_loc5_ = this.var_125++] = this.var_170[_loc5_] ^ param1 >> 24 & 255;
         this.var_125 %= this.psize;
         this.var_2482 = true;
      }
      ...
      public function nextByte() : int
      {
         if(!this.ready)
         {
            ...
            this.state.init(this.var_170);
            this.var_170.length = 0;
            this.var_125 = 0;
            this.ready = true;
         }
      ...
      {
         var _loc1_:int = 0;
         while(_loc1_ < this.var_170.length)
         {
            this.var_170[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         this.var_170.length = 0;
         this.var_170 = null;
