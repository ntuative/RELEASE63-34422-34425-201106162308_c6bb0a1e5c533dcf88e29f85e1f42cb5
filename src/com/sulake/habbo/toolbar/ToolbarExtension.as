package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1640:uint = 16777215;
      
      private static const const_1638:uint = 12247545;
      
      private static const const_1639:String = "HELP";
      
      private static const const_1641:String = "ROOMINFO";
      ...
      private var var_361:IWindow;
      
      private var var_700:IWindowContainer;
      
      private const const_789:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_361 = this._window.findChildByName("roominfo_region");
         this.var_67 = this._window.findChildByName("list") as IItemListWindow;
         var _loc7_:* = [];
         this.var_67.groupListItemsWithTag("REGION",_loc7_);
      ...
      {
         this.var_67.removeListItem(this.var_361);
      }
      
      public function showRoomInfo() : void
      {
         this.var_67.addListItemAt(this.var_361,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_852;
         _loc3_.y = this.const_789;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_700)
         {
            this.var_700 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1639);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1641);
               break;
            case "confirm":
               if(false)
               {
