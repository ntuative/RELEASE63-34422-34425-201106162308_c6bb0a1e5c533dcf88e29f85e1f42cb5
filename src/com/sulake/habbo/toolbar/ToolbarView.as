package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1521:Point = new Point(3,3);
      
      private static const const_1556:uint = 7433577;
      
      private static const const_1555:uint = 5723213;
      
      private static const const_469:String = "_hover";
      
      private static const const_470:String = "_normal";
      
      private static const const_468:int = 5;
      
      private static const const_1550:int = 600;
      
      private static const const_1554:int = 80;
      
      private static const const_1553:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1549:int = -2;
      
      private static const const_1551:int = 5;
      
      private static const const_1552:int = 10;
      ...
      private var var_1534:BitmapData;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1521;
         this._window.addEventListener(WindowEvent.const_658,this.onParentResized);
         ...
         {
            this.method_4(_loc11_,const_470);
         }
         ...
         this.var_218 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_218);
         var _loc14_:ITextWindow = this.var_218.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_218.x = _loc13_.width - this.var_218.width - const_468;
         this.var_218.y = const_468;
         this.var_2611 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1550;
         if(!param1 && _loc2_ == this.var_1536)
         {
            return;
         }
         this.var_1536 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1553) : int(const_1554);
         var _loc4_:int = !!_loc2_ ? int(const_1549) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1551 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1552;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_218 != null && this.var_2611)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_844:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_821:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.method_4(_loc4_,const_469);
               this.setIconBgHoverState(_loc3_,const_469);
               break;
            case WindowMouseEvent.const_25:
               this.method_4(_loc4_,const_470);
               this.setIconBgHoverState(_loc3_,const_470);
         }
      }
      
      private function method_4(param1:IBitmapWrapperWindow, param2:String) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:* = null;
         ...
         {
            _loc4_ = param2 == const_469 ? this.var_1535 : this.var_1534;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_469)
         {
            param1.color = const_1556;
         }
         else
         {
            param1.color = const_1555;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1536 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1536 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1534 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1535)
         {
            this.var_1535.dispose();
         }
         this.var_1535 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1006.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_468;
            _loc2_.y = const_468;
            this.var_1006.add(param1,_loc2_);
         }
         return _loc2_;
      }
