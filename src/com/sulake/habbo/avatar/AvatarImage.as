package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1568:String = "Default";
      
      private static const const_1569:int = 2;
      
      private static const const_1570:String = AvatarSetType.const_41;
      ...
      protected var var_307:IActiveActionData;
      ...
      protected var var_269:AvatarImageCache;
      
      protected var _figure:AvatarFigureContainer;
      
      protected var var_601:IAvatarDataContainer;
      
      protected var var_353:Array;
      
      protected var var_48:BitmapData;
      
      private var var_1018:IActiveActionData;
      ...
      protected var var_1401:Boolean = false;
      ...
      private var var_2907:String = null;
      
      private var var_2908:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         if(this._scale == null)
         {
            this._scale = AvatarScaleType.const_59;
         }
         if(param3 == null)
         {
         ...
         this._figure = param3;
         this.var_269 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1570,const_1569);
         this.var_353 = new Array();
         this.var_1018 = new ActiveActionData(AvatarAction.const_389);
         this.var_1018.definition = this._structure.getActionDefinition(const_1568);
         this.resetActions();
      ...
      {
         param2 += this.var_1955;
         if(param2 < AvatarDirectionAngle.const_1371)
         {
            param2 = AvatarDirectionAngle.const_343 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_343)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_51 || param1 == AvatarSetType.const_41)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_709,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_301.length == 1 && this.var_101 == this.var_2000)
         {
            return this.var_101 + this.var_583 + this.var_709 % 4;
         }
         if(this.var_301.length == 2)
         {
            for each(_loc1_ in this.var_301)
            {
               ...
               {
                  return this.var_101 + this.var_583 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_709 % 11;
                  return this.var_101 + "_" + this.var_2000 + this.var_583 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2909 || param2 != this.var_2907 || param1 != this.var_2908)
         {
            this.var_2909 = param3;
            this.var_2907 = param2;
            this.var_2908 = param1;
            this.var_2114 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_307.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1401 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1401)
            {
               this.var_48.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_307.definition.geometryType,this.var_101);
         this.var_48.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_709);
         ...
         {
            if(this.var_601.paletteIsGrayscale)
            {
               ...
               this.var_48 = _loc13_;
               this.var_48.paletteMap(this.var_48,this.var_48.rect,new Point(0,0),this.var_601.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_307.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_307.definition.geometryType,this.var_101);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_709);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
            ...
            case AvatarAction.const_422:
               switch(_loc3_)
               {
                  case AvatarAction.const_893:
                     if(this.var_101 == 0)
                     {
                        this.setDirection(AvatarSetType.const_41,4);
                     }
                     else
                     {
                        this.setDirection(AvatarSetType.const_41,2);
                     }
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_353.length)
         {
            _loc3_ = this.var_353[_loc4_];
         ...
         this.var_353.push(new ActiveActionData(param1,param2,this.var_709));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_307 = this.var_1018;
         this.var_307.definition = this.var_1018.definition;
         this.resetBodyPartCache(this.var_1018);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_301)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_583 = "";
         this.var_301 = this._structure.sortActions(this.var_353);
         if(this.var_301 == null)
         {
            this.var_757 = new Array(0,0,0);
            if(this.var_1351 != "")
            {
               _loc1_ = true;
               this.var_1351 = "";
         ...
         {
            this.var_757 = this._structure.getCanvasOffsets(this.var_301,this._scale,this.var_101);
            for each(_loc4_ in this.var_301)
            {
               this.var_583 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_367)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1635 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1351 != this.var_583)
            {
               _loc1_ = true;
               this.var_1351 = this.var_583;
            }
         }
         this.var_1555 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_301)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1019 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_229 = this.var_229.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1955 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_601 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_359 || _loc1_.actionType == AvatarAction.const_267 || _loc1_.actionType == AvatarAction.const_457)
               {
                  this.var_1019 = true;
               }
            }
