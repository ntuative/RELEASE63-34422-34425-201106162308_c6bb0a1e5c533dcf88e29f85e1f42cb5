package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2906:uint;
      
      private var var_2904:uint;
      ...
      private var var_1349:Map;
      
      private var var_2905:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2113 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2906 = parseInt(_loc2_,16);
         this.var_2904 = parseInt(_loc3_,16);
         ...
         this.var_904 = new ColorTransform(this.var_1940,this.var_1939,this.var_1942,this._alphaMultiplier);
         this.var_1349 = this.generatePaletteMapForGrayscale(this.var_2904,this.var_2906);
      }
      ...
      {
         return this.var_1349.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1349.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1349.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1349.getValue("alphas") as Array;
      }
