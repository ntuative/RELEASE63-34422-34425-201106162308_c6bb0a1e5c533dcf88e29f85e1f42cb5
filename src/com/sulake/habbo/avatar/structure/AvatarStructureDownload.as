package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1357:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2842:IStructureData;
      ...
      public function AvatarStructureDownload(param1:IAssetLibrary, param2:String, param3:IStructureData)
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_42,this.onDataFailed);
      }
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            ...
            {
               Core.error("Could not load avatar structure, got empty data from URL " + loaderStruct.assetLoader.url + " data length = " + data.length + ".",false,Core.const_225);
            }
            this.var_2068 = new XML(data);
         }
         catch(e:Error)
         {
         ...
         this.var_2842.appendXML(this.var_2068);
         dispatchEvent(new Event(AvatarStructureDownload.const_1357));
      }
      ...
      private function onDataFailed(param1:Event) : void
      {
         ...
         Core.error("Could not load avatar structure. Failed to get data from URL " + _loc3_,false,Core.const_225);
      }
   }
}
