package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyModel extends CategoryBaseModel implements IAvatarEditorCategoryModel, IAvatarImageListener
   {
      ...
      {
         super.init();
         initCategory(FigureData.const_92);
         _isInitialized = true;
         if(!_view)
         {
      ...
      {
         var _loc4_:CategoryData = var_115[param1];
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.selectColorIndex(param2,param3);
         var_27.figureData.savePartSetColourId(param1,_loc4_.getSelectedColorIds(),true);
         this.updateSelectionsFromFigure(FigureData.const_92);
      }
      ...
      override protected function updateSelectionsFromFigure(param1:String) : void
      {
         ...
         var _loc2_:int = var_27.figureData.getPartSetId(FigureData.const_92);
         var _loc3_:Array = var_27.figureData.getColourIds(FigureData.const_92);
         var _loc4_:CategoryData = var_115[param1];
         if(_loc4_ == null)
         {
            return;
         ...
         {
            _loc6_ = var_27.figureData.getFigureStringWithFace(_loc5_.id);
            _loc7_ = var_27.manager.avatarRenderManager.createAvatarImage(_loc6_,AvatarScaleType.const_59,null,this);
            _loc5_.iconImage = _loc7_.getCroppedImage(AvatarSetType.const_51);
            _loc7_.dispose();
         }
      }
