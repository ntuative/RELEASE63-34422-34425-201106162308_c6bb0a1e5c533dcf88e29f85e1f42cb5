package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_269:AvatarImageCache;
      ...
      private var var_601:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1556);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_307.definition.geometryType);
         if(this.var_48 == null || _loc4_ != null && (this.var_48.width != _loc4_.width || this.var_48.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_307.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_709);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc16_ = this.var_1556 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_117)
               {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_709);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_709);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_709);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_583 = this.var_583 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_422:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1867:
                  case AvatarAction.const_1746:
                  case AvatarAction.const_1922:
                  case AvatarAction.const_1287:
                  case AvatarAction.const_1384:
                  case AvatarAction.const_1934:
                  case AvatarAction.const_1831:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_353.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1018);
         this.getCache().resetBodyPartCache(this.var_1018);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1557 = this._structure.sortActions(this.var_353);
         ...
         {
            this.var_757 = this._structure.getCanvasOffsets(this.var_1557,this._scale,this.var_101);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1557)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_457)
               {
                  this.var_1019 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_359)
               {
                  this.var_1019 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1212 = _loc4_.id;
                     this.var_1808 = _loc4_.breed;
                     break;
                  }
               }
            }
