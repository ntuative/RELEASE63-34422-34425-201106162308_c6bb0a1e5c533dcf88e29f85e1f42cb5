package com.sulake.habbo.avatar.actions
{
   ...
   public class AvatarActionManager
   {
      ...
      public function getDefaultAction() : ActionDefinition
      {
         ...
         for each(_loc1_ in this.var_353)
         {
            if(_loc1_.isDefault)
            {
               this.var_1018 = _loc1_;
               return _loc1_;
            }
         }
         return null;
      ...
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         ...
         while(_loc7_ < param1.length)
         {
            ...
            _loc6_ = this.var_353[_loc5_.actionType] as ActionDefinition;
      ...
      public function sortActions(param1:Array) : Array
      {
         ...
         {
            _loc4_ = this.var_353[_loc3_.actionType];
            if(_loc4_ != null)
            {
      ...
      private function filterActions(param1:Array) : Array
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            _loc5_ = this.var_353[_loc4_.actionType] as ActionDefinition;
            if(_loc5_ != null)
            {
