package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2052:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1541:IAvatarImage;
      ...
      private var var_487:AvatarImageBodyPartContainer;
      
      private var var_1473:String;
      
      private var var_124:AvatarImagePartContainer;
      
      private var var_2453:Point;
      ...
      private var var_2455:ByteArray;
      
      private var var_2454:ImageData;
      
      private var var_1084:PaletteMap;
      ...
      {
         if(this.var_774 == param1)
         {
            return;
         }
         if(this.var_774 == GeometryType.const_1302 && param1 == GeometryType.const_1176 || this.var_774 == GeometryType.const_1176 && param1 == GeometryType.const_1302)
         {
            this.var_774 = param1;
            this.var_100 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_367.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_802)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_567)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1541.getFigure(),_loc5_,this.var_774,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_487 = _loc10_.getImageContainer(_loc4_);
         if(this.var_487 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_487 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_367);
            if(this.var_487 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_487,_loc4_);
         }
         this.var_487.offset = _loc8_;
         return this.var_487;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_100)
         {
            this.var_100 = this._structure.getCanvas(this._scale,this.var_774);
            if(!this.var_100)
            {
               return null;
            }
            this.var_2453 = new Point(0,this.var_100.height - int(this.var_100.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1729[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_970 || _loc10_ == AvatarAction.const_457;
         var _loc12_:int = param2.length - 1;
         _loc8_ = _loc12_;
         while(_loc8_ >= 0)
         {
            this.var_124 = param2[_loc8_] as AvatarImagePartContainer;
            if(!(param1 == 7 && (this.var_124.partType == "fc" || this.var_124.partType == "ey")))
            {
               this.var_1473 = this.var_124.bodyPartId;
               this.var_194 = this.var_124.partType;
               this.var_1797 = this.var_124.partId;
               this._frame = this.var_124.getFrameIndex(param3);
               _loc5_ = param1;
               _loc7_ = false;
               if(_loc6_)
               {
                  if(_loc9_ == "wav" && (this.var_194 == "lh" || this.var_194 == "ls" || this.var_194 == "lc" || this.var_194 == "lhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "drk" && (this.var_194 == "rh" || this.var_194 == "rs" || this.var_194 == "rc" || this.var_194 == "rhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "crr" && this.var_194 == "rhs")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_194 == "ri")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_194 == "cp")
                  {
                     _loc7_ = true;
                  }
                  else
                  {
                     ...
                     if(this.var_124.flippedPartType != this.var_194)
                     {
                        this.var_194 = this.var_124.flippedPartType;
                     }
                  }
               }
               this.var_1472 = this._scale + "_" + this.var_124.action.assetPartDefinition + "_" + this.var_194 + "_" + this.var_1797 + "_" + _loc5_ + "_" + this._frame;
               this.var_439 = this._assets.getAssetByName(this.var_1472) as BitmapDataAsset;
               if(this.var_439 == null)
               {
                  this.var_1472 = this._scale + "_std_" + this.var_194 + "_" + this.var_1797 + "_" + _loc5_ + "_0";
                  this.var_439 = this._assets.getAssetByName(this.var_1472) as BitmapDataAsset;
               }
               if(!(!this.var_439 || !this.var_439.content))
               {
                  if(this.var_124.paletteMapId > -1)
                  {
                     this.var_1084 = this._structure.renderManager.paletteManager.getPalette(this.var_124.paletteMapId);
                     if(this.var_1084 != null)
                     {
                        this.var_970 = this.var_439.content as BitmapData;
                        this.var_193 = new BitmapData(this.var_970.width,this.var_970.height);
                        this.var_2455 = this.var_1084.colorize(this.var_970.getPixels(this.var_970.rect));
                        this.var_193.setPixels(this.var_193.rect,this.var_2455);
                     }
                     else
                     {
                        this.var_193 = (this.var_439.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1473 == AvatarBodyPartType.const_244 || this.var_1473 == AvatarBodyPartType.const_1973 || this.var_1473 == AvatarBodyPartType.const_1712) && this.var_124.color != null)
                  {
                     _loc16_ = 0.7;
                     _loc17_ = this.var_124.color.colorTransform;
                  ...
                  else if(this.var_124.isColorable && this.var_124.color != null)
                  {
                     this.var_193.colorTransform(this.var_193.rect,this.var_124.color.colorTransform);
                  }
                  if(this.var_124.isBlendable)
                  {
                     this.var_193.colorTransform(this.var_193.rect,this.var_124.blendTransform);
                  }
                  this.var_971 = this.var_439.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_59)
                     {
                  ...
                  this.var_2454 = new ImageData(this.var_193,this.var_971,_loc7_);
                  this.var_969.push(this.var_2454);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_969,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2453.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_59)
            {
         ...
         _loc8_ = this.var_969.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_969.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
