package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseView
   {
      ...
      protected var var_41:Dictionary;
      
      protected var var_166:String = "";
      
      protected var var_50:String = "";
      
      protected var var_77:IAvatarEditorCategoryModel;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_41)
         {
            for each(_loc1_ in this.var_41)
            {
               _loc1_.dispose();
               _loc1_ = null;
            }
      ...
      public function showPalettes(param1:String, param2:int) : void
      {
         ...
         var _loc3_:AvatarEditorGridView = this.var_41[param1] as AvatarEditorGridView;
         if(!_loc3_)
         {
            return;
         }
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_2185);
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = this.var_41[this.var_166];
         if(_loc2_ == null)
         {
            return;
         }
