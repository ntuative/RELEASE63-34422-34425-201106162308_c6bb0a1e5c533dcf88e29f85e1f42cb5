package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      protected var var_115:Map;
      
      protected var var_27:HabboAvatarEditor;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:CategoryData = this.var_115[param1];
         if(_loc2_ == null)
         {
            _loc3_ = this.var_27.generateDataContent(this,param1);
            if(_loc3_)
            {
               this.var_115[param1] = _loc3_;
      ...
      {
         if(!this.var_115 || !this.var_27 || !this.var_27.figureData)
         {
            return;
         }
         var _loc2_:CategoryData = this.var_115[param1];
         ...
         var _loc3_:int = this.var_27.figureData.getPartSetId(param1);
         var _loc4_:Array = this.var_27.figureData.getColourIds(param1);
         if(!_loc4_)
         {
            _loc4_ = new Array();
         }
      ...
      public function hasClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         for each(_loc3_ in this.var_115)
         {
            if(_loc3_)
            {
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         var _loc2_:Array = this.var_115.getKeys();
         ...
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               if(_loc8_ && this.var_27 && this.var_27.figureData && _loc6_)
               {
                  this.var_27.figureData.savePartData(_loc5_,_loc8_.id,_loc6_.getSelectedColorIds(),true);
               }
               _loc3_ = true;
            }
            _loc4_++;
      ...
      {
         var _loc3_:CategoryData = this.var_115[param1];
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(this.var_27 && this.var_27.figureData)
         {
            this.var_27.figureData.savePartData(param1,_loc4_.id,_loc3_.getSelectedColorIds(),true);
         }
      }
      
      public function selectColor(param1:String, param2:int, param3:int) : void
      {
         var _loc4_:CategoryData = this.var_115[param1];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(this.var_27 && this.var_27.figureData)
         {
            this.var_27.figureData.savePartSetColourId(param1,_loc4_.getSelectedColorIds(),true);
         }
      }
