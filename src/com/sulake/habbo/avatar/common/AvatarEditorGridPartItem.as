package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_861:IFigurePartSet;
      ...
      private const const_2333:int = 13421772;
      
      private const const_2332:int = 16777215;
      
      private const const_383:Array = [2,6,0,4,3,1];
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_729 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_2073 = Math.max(this.var_2073,_loc6_.colorLayerIndex);
            }
         }
         this.var_479 = this.var_77.controller.manager.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_729 != null && !this.var_2072)
            {
               _loc3_ = this.var_729;
            }
            else
         ...
         if(_loc2_)
         {
            if(this.var_861)
            {
               switch(this.var_861.clubLevel)
               {
                  case HabboClubLevelEnum.const_56:
                     _loc2_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_38:
                     _loc2_.style = HabboIconType.const_796;
                     break;
                  case HabboClubLevelEnum.const_47:
                     _loc2_.style = HabboIconType.const_978;
               }
            }
            else
            {
         ...
         if(this.var_1423 == null)
         {
            return;
         }
         if(this.isSelected)
         {
            this.var_1423.color = this.const_2333;
         }
         else
         {
            this.var_1423.color = this.const_2332;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_383[_loc6_] + "_" + FigureData.const_140;
               _loc4_ = this.var_479.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
               while(!_loc7_ && _loc6_ < this.const_383.length)
               {
                  _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_383[_loc6_] + "_" + FigureData.const_140;
                  _loc4_ = this.var_479.getAssetByName(_loc3_) as BitmapDataAsset;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_698 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_2074)
               {
                  ...
                  this.var_2074 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_698.width,this.var_698.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_698.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_698.y;
               if(this.var_2072 && _loc2_.colorLayerIndex > 0)
               {
