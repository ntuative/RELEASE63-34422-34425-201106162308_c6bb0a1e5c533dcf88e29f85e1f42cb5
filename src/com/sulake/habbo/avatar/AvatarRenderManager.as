package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2322:String = "hd-99999-99999";
      ...
      private var var_247:AvatarAssetDownloadManager;
      
      private var var_1909:AvatarFigureContainer;
      
      private var var_2609:Boolean = false;
      
      private var var_2610:Boolean = false;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_719 = RenderMode.const_1851;
         this.var_323 = new Map();
         this.var_117 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_121,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_117.add(AvatarType.const_121,_loc4_);
         ...
         this.var_117.add(AvatarType.const_57,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_117.getValues())
            {
               _loc1_.dispose();
            }
         ...
         if(this.var_247)
         {
            this.var_247.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_324.init();
         this.var_818.init();
         _loc2_ = this.var_117.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_117.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_117.getValue(AvatarType.const_121) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1357,this.onFigureDataDownloadDone);
               if(this.var_247 == null)
               {
                  ...
                  this.var_247 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_247.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1001)
         {
            if(this.var_2609 && this.var_2610 && this.var_2608)
            {
               this.var_1001 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_247.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_247.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_117.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_247.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1909)
         {
            this.var_1909 = new AvatarFigureContainer(this.const_2322);
         }
         this.var_247.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1909,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1981)
         {
            _loc6_ = !this.var_324.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_324.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_117.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_117.getValue(AvatarType.const_57);
      ...
      {
         var _loc2_:AvatarStructure = this.var_117.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_117.getValue(AvatarType.const_121) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_121:
               _loc3_ = this.var_117.getValue(AvatarType.const_121) as AvatarStructure;
               break;
            case AvatarType.const_57:
               _loc3_ = this.var_117.getValue(AvatarType.const_57) as AvatarStructure;
               break;
            default:
