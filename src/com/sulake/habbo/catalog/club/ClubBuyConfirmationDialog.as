package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      private var var_103:ClubBuyOfferData;
      ...
      public function showConfirmation() : void
      {
         ...
         _loc6_ += !!this.var_103.vip ? "vip" : "hc";
         _loc6_ += !!this.var_103.upgrade ? ".period" : "";
         ...
         var _loc11_:String = !!this.var_103.vip ? "vip" : "hc";
         var _loc12_:String = _loc2_.getLocalization("catalog.club." + _loc11_).value;
         var _loc13_:int = this.var_103.periods == 0 ? 1 : int(this.var_103.periods);
         _loc2_.registerParameter("catalog.club.buy.confirm.price","price",String(this.var_103.price));
         ...
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","day",String(this.var_103.day));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","month",String(this.var_103.month));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","year",String(this.var_103.year));
         _loc2_.registerParameter("catalog.club.buy.confirm.before","days",String(_loc10_));
         _loc2_.registerParameter("catalog.club.buy.confirm.after","days",String(this.var_103.daysLeftAfterPurchase));
         if(this.var_103.upgrade)
         {
      ...
      {
         if(!param1 || !param2 || !this.var_27 || !this.var_103)
         {
            return;
         }
         ...
         {
            case "select_button":
               this.var_27.confirmSelection(this.var_103,this.var_1499);
               break;
