package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_706:uint = 1;
      ...
      private var var_1208:IRoomSession;
      ...
      private var var_1021:IAvatarRenderManager;
      ...
      private var var_224:CatalogViewer;
      
      private var var_332:ICatalogNavigator;
      
      private var var_119:Purse;
      
      private var var_105:RecyclerLogic;
      
      private var var_156:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_200:PurchaseConfirmationDialog;
      
      private var var_223:ChargeConfirmationDialog;
      ...
      private var var_2788:GiftWrappingConfiguration;
      
      private var var_1303:ClubGiftController;
      
      private var var_469:ClubBuyController;
      
      private var var_849:Map;
      
      private var var_1302:Boolean = false;
      
      private var var_847:IPurchasableOffer;
      
      private var var_1586:IDragAndDropDoneReceiver;
      
      private var var_65:PlacedObjectPurchaseData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1021)
         {
            this.var_1021.release(new IIDAvatarRenderManager());
            this.var_1021 = null;
         }
         if(this.var_179)
         {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_75,this.onRoomSessionEvent);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_82,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1843);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_394.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_119.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_119.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_200 == null || this.var_200.disposed)
            {
            ...
            this.var_200.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_469.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2787 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_394.loadProductData(this);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1021 = param2 as IAvatarRenderManager;
      }
      
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._roomEngine = param2 as IRoomEngine;
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_158,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_179 != null && this.var_179.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_677 == null)
            {
      ...
      {
         return this.var_179.getKey("toolbar.new_additions.notification.enabled","false") == "true";
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_332.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_394.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_394.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_65)
         {
            _loc3_ = this.var_394.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_849.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_119.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_119.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
         if(!this.var_119.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_119.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_119.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_119.clubPeriods));
         }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.mainWindowVisible())
         {
            ...
            if(this.var_105 != null && this.getCurrentLayoutCode() == "recycler")
            {
               this.var_105.activate();
            }
         }
         else
         {
         ...
         this.setupInventoryForRecycler(this.var_105.active && this.mainWindowVisible());
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_224.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_332 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_224 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_224.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_706) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2060;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_297,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_75:
               this.var_2020 = param1.session.isPrivateRoom;
               this.var_1208 = param1.session;
               if(this.var_105 != null)
               {
                  this.var_105.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_82:
               ...
               if(this.var_105 != null)
               {
                  this.var_105.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_105 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_156 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1303 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_469 == null)
         {
            this.var_469 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_224 != null)
         {
            this.var_224.catalogWindowClosed();
         }
         if(this.var_105 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_105.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1587 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_332.buildCatalogIndex(_loc2_);
         if(this.var_848 && this.var_848 != "")
         {
            this.var_332.openPage(this.var_848);
            this.var_848 = "";
            this.var_1054 = -1;
         }
         else if(this.var_1054 > -1)
         {
            this.var_332.openPageById(this.var_1054,this.var_2021);
            this.var_1054 = -1;
            this.var_2021 = -1;
            this.var_848 = "";
         }
         else if(this.var_1587 && this.var_2787)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_332.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1764));
         }
         else
         {
            this.var_332.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_224.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_224 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_224.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_119.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2785 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1208);
         }
         this.var_2785 = false;
         if(this.var_223 != null && !this.var_223.disposed)
         {
            this.var_223.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_74,this.var_119.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_119.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2786 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1277);
         }
         this.var_2786 = false;
         if(this.var_223 != null && !this.var_223.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_110,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_605)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_112,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_119.activityPoints = _loc2_.points;
         this.updatePurse();
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_110,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_112,_loc2_.points["null"]));
         }
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_119.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_119.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_119.isVIP = _loc2_.isVIP;
         this.var_119.pastClubDays = _loc2_.pastClubDays;
         this.var_119.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1303.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_105 == null)
         {
            return;
         }
         this.var_105.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_105.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_105.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_156 != null)
         {
            this.var_156.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_156 != null)
         {
            this.var_156.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_156 != null)
         {
            this.var_156.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2788 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_156.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_223 == null || this.var_223.disposed)
         {
            this.var_223 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_223.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_849.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_849.add(_loc2_.productCode,_loc3_.slice());
            this.var_224.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1208 || !this.var_1208.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_206);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_233);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_201);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1302 && param1.type == RoomEngineObjectEvent.const_158)
         {
            this.resetPlacedOfferData(true);
            if(this.var_847 == null || this.var_847.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_847.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_847);
            _loc5_ = this.var_1586;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_346,0.5);
            }
         }
      }
      ...
      public function syncPlacedOfferWithPurchase(param1:IPurchasableOffer) : void
      {
         if(this.var_65)
         {
            if(this.var_65.offerId != param1.offerId)
            {
               this.resetPlacedOfferData();
            }
         }
      ...
      public function resetPlacedOfferData(param1:Boolean = false) : void
      {
         ...
         if(this.var_65 != null)
         {
            if(this.var_65.category == RoomObjectCategoryEnum.const_27)
            {
               this._roomEngine.disposeObjectFurniture(this.var_65.roomId,this.var_65.roomCategory,this.var_65.objectId);
            }
            else if(this.var_65.category == RoomObjectCategoryEnum.const_26)
            {
               switch(this.var_65.furniData.name)
               {
                  case "floor":
                  case "wallpaper":
                  case "landscape":
                     ...
                     break;
                  default:
                     this._roomEngine.disposeObjectWallItem(this.var_65.roomId,this.var_65.roomCategory,this.var_65.objectId);
               }
            }
            else
            {
               this._roomEngine.deleteRoomObject(this.var_65.objectId,this.var_65.category);
            }
            this.var_65.dispose();
            this.var_65 = null;
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this.var_65 != null && this.var_65.productClassId == param1.classId)
         {
            if(this.var_65.roomCategory == this._roomEngine.activeRoomCategory && this.var_65.roomId == this._roomEngine.activeRoomId)
            {
               _loc2_ = param1.stripId;
               _loc3_ = this.var_65.category;
               _loc4_ = this.var_65.wallLocation;
               _loc5_ = this.var_65.x;
               _loc6_ = this.var_65.y;
               _loc7_ = this.var_65.direction;
               switch(param1.category)
               {
                  case FurniCategory.const_338:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_233);
                     if(this.var_65.extraParameter != _loc8_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_354:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_206);
                     if(this.var_65.extraParameter != _loc9_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_320:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_201);
                     if(this.var_65.extraParameter != _loc10_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_179.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_706);
            if(_loc1_ != null)
            {
