package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1107:int = 0;
      
      private static const const_472:int = 1;
      ...
      {
         return this.var_657 != const_1107;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1929 != RecyclerStatusMessageEvent.const_1267;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_657 == const_472;
      }
      ...
      {
         this.var_657 = const_1108;
         this.var_132 = new Array(const_226);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_226)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_657 = const_1107;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1929)
         {
            case RecyclerStatusMessageEvent.const_1959:
               this.var_657 = const_472;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1267:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1935:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1324:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1819:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_132.length > 0)
         {
            oldObjectData = this.var_132[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_226)
            {
               oldObjectData = this.var_132[newSlotId];
         ...
         this.var_132[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_132[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_132[param1].id))
         {
            return;
         }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_132.length)
         {
            _loc3_ = this.var_132[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_132.length < const_226)
         {
            return false;
         }
         var _loc1_:int = 0;
