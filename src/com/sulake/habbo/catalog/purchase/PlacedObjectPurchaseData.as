package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_2022:IProductData;
      ...
      {
         this.var_1236 = param1.offerId;
         this.var_2017 = param1.productContainer.firstProduct.productClassId;
         this.var_2022 = param1.productContainer.firstProduct.productData;
         this.var_648 = param1.productContainer.firstProduct.furnitureData;
         this.var_1498 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_233,this._category,this.var_2016,this._x,this.var_187,this._direction,this.var_1236,this.var_2017].toString();
      }
