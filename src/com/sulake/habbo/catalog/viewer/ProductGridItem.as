package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1038:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_230:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1038).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1038).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_88,MouseCursorType.const_746);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_746);
         }
      }
