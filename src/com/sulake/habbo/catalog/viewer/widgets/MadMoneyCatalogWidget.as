package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MadMoneyCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1317:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1317.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.eventProc);
            this.var_1317 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1317 = _window.findChildByName("ctlg_madmoney_button") as IButtonWindow;
         if(this.var_1317 != null)
         {
         }
         return true;
