package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubBuyCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         if(this.var_27 != null)
         {
            this.var_27.unRegisterVisualization(this);
         }
         this.var_27 = null;
         this.reset();
         super.dispose();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_27 = (page.viewer.catalog as HabboCatalog).getClubBuyController();
         this.var_27.registerVisualization(this);
         this.var_27.requestOffers();
         return true;
      }
