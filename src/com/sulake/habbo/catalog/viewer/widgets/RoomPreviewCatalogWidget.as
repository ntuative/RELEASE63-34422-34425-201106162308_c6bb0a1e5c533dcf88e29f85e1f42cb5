package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RoomPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IDragAndDropDoneReceiver
   {
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.CWE_UPDATE_ROOM_PREVIEW,this.method_10);
         super.dispose();
      }
      ...
      override public function init() : Boolean
      {
         ...
         events.addEventListener(WidgetEvent.CWE_UPDATE_ROOM_PREVIEW,this.method_10);
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_575 != null && this.var_575 == param2)
         {
            if(this.var_103)
            {
               (page.viewer.catalog as HabboCatalog).requestSelectedItemToMover(this,this.var_103);
               this.var_575 = null;
            }
         }
      ...
      private function method_10(param1:CatalogWidgetUpdateRoomPreviewEvent) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         ...
         {
            this.var_1870 = _loc3_.id;
            this.var_1869 = _loc4_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_376 != null && this._imageStoreWindow != null)
         {
            this.setRoomImage(this.var_376,this._imageStoreWindow);
         }
      }
   }
}
