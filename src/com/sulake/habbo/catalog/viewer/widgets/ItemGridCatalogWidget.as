package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_510:IItemGridWindow;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_841,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_247,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_767,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_270,this.deActivateScrollbar);
         }
         this.var_34 = param2;
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_510 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_824 >= 0 && this.var_824 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_824];
                  this.loadGraphics(_loc4_);
                  _loc4_.productContainer.grid = this;
               }
               ++this.var_824;
               if(this.var_824 >= _loc2_)
               {
                  this.resetTimer();
                  break;
               }
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1915) as IWindowContainer;
         this.var_510.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_546)
         {
            ++this.var_1933;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1933);
         }
      }
