package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1666:int = 16763904;
      
      private static const const_1665:int = 13421772;
      
      private static const const_1664:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_96 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_300.getValue(_loc5_) == null)
            {
               this.var_300.add(_loc5_,new Map());
            }
            _loc7_ = this.var_300.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_300.getWithIndex(this.var_338);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_874);
            if(_loc3_ == null)
            {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1666);
         _loc2_.push(const_1665);
         _loc2_.push(const_1664);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_300.getWithIndex(this.var_338);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_874);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_338;
         if(this.var_338 >= this.var_300.length)
         {
            this.var_338 = 0;
         }
         var _loc2_:Map = this.var_300.getWithIndex(this.var_338);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_338 < 0)
         {
            this.var_338 = this.var_300.length - 1;
         }
         var _loc2_:Map = this.var_300.getWithIndex(this.var_338);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_96 != null)
         {
            ...
            _loc3_ = new Point((this.var_96.width - param1.width) / 2,(this.var_96.height - param1.height) / 2);
            this.var_96.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
