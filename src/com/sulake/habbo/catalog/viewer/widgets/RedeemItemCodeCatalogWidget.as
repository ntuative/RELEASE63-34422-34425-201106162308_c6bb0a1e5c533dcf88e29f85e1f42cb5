package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_993:IButtonWindow;
      
      private var var_994:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_993.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_993 = null;
         }
         if(this.var_994 != null)
         {
            this.var_994.removeEventListener(WindowKeyboardEvent.const_187,this.windowKeyEventProcessor);
            this.var_994 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_993 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_993 != null)
         {
            this.var_993.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_994 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_994 != null)
         {
            this.var_994.addEventListener(WindowKeyboardEvent.const_187,this.windowKeyEventProcessor);
         }
         return true;
      }
