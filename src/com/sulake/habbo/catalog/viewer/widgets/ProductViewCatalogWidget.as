package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_525:IDisplayObjectWrapper;
      
      private var var_1779:Point;
      
      private var var_526:IItemGridWindow;
      
      private var var_1456:IScrollbarWindow;
      
      protected var var_1915:XML;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_192.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_192 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_959 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1188 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_96 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_192 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_192 != null)
         {
            this.var_192.visible = false;
            this.var_525 = this.var_192.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_525 != null && _loc3_ != null)
            {
               this.var_192.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_525.width,this.var_525.height);
               if(_loc4_ != null)
               {
                  this.var_525.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1779 = new Point(this.var_96.x,this.var_96.y);
         this.var_526 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1456 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_526 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1915 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_959.text = _loc4_;
         this.var_1188.text = _loc5_;
         this.var_959.height = this.var_959.textHeight + 5;
         this.var_1188.y = this.var_959.y + this.var_959.height;
         this.var_1188.height = Math.max(130,this.var_1188.textHeight + 5);
         if(ProductImageConfiguration.hasProductImage(_loc2_.localizationId))
         {
            this.setPreviewFromAsset(ProductImageConfiguration.const_32[_loc2_.localizationId]);
            if(this.var_192 != null)
            {
               this.var_192.visible = false;
            }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_546:
                  ...
                  if(this.var_526 != null)
                  {
                     this.var_526.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_526,this.var_1456,this.var_1915);
                     this.var_526.scrollV = 0;
                  }
                  if(this.var_192 != null)
                  {
                     this.var_192.visible = false;
               ...
               case Offer.const_451:
                  ...
                  if(this.var_192 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_76 || _loc9_.productType == ProductTypeEnum.const_65 || _loc9_.productType == ProductTypeEnum.const_186)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_76:
                        if(_loc8_ != null && this.var_525 != null)
                        {
                     ...
                     case ProductTypeEnum.const_186:
                        ...
                        else
                        {
                           ...
                           _loc6_ = new BitmapData(this.var_96.width,this.var_96.height,false,_loc15_);
                           _loc16_ = null;
                           _loc17_ = page.viewer.catalog as HabboCatalog;
                           if(_loc17_.avatarRenderManager != null)
                           {
                              _loc19_ = _loc17_.sessionDataManager.figure;
                              _loc18_ = _loc17_.avatarRenderManager.createAvatarImage(_loc19_,AvatarScaleType.const_59);
                              if(_loc18_ != null)
                              {
                                 _loc18_.setDirection(AvatarSetType.const_51,3);
                                 _loc18_.initActionAppends();
                                 _loc18_.appendAction(AvatarAction.const_330,AvatarAction.const_547);
                                 _loc18_.appendAction(AvatarAction.const_367,_loc9_.productClassId);
                                 _loc18_.endActionAppends();
                                 _loc18_.updateAnimationByFrames(1);
                                 _loc18_.updateAnimationByFrames(1);
                                 _loc16_ = _loc18_.getImage(AvatarSetType.const_41,true);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_96);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2428)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2428 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_96 != null && true)
         {
            ...
            if(this.var_96.bitmap == null)
            {
               this.var_96.bitmap = new BitmapData(this.var_96.width,this.var_96.height,true,16777215);
            }
            this.var_96.bitmap.fillRect(this.var_96.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_96.width - param1.width) / 2,(this.var_96.height - param1.height) / 2);
            this.var_96.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_96.invalidate();
            this.var_96.x = this.var_1779.x;
            this.var_96.y = this.var_1779.y;
            if(param3 != null)
            {
               this.var_96.x += param3.x;
               this.var_96.y += param3.y;
            }
         }
         if(param2)
         {
