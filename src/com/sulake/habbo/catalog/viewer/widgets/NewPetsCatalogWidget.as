package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1704:int = 18;
      ...
      private var var_210:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_114,this.onTextWindowEvent);
         ...
         this.var_589 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_589 < 8)
         {
            return false;
         }
         this.var_2245 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_210 != null && this.var_210.length > 0)
         {
            this.var_419 = this.var_210[0];
         }
         else
         {
            this.var_419 = -1;
         }
         this._offers.add(this.var_589,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_210 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1704 && _loc2_ < this.var_210.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_589,this.var_210[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_210 != null && this.var_210.length > 0)
         {
            if(param1 < 0 || param1 > this.var_210.length)
            {
               param1 = 0;
            }
            this.var_419 = this.var_210[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_589,this.var_419),this.getRaceLocalizationKey(this.var_589,this.var_419));
            }
         }
         return this.getRaceLocalizationKey(this.var_589,this.var_419);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_419 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_589;
         var _loc3_:int = this.var_419;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_419 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
