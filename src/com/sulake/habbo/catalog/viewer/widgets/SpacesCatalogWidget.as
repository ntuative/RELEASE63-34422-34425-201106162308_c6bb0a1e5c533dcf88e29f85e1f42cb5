package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1470:String = "default";
      ...
      private var var_1469:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_965 = this.parseElements(_loc2_.floors.pattern);
         this.var_1204 = this.parseElements(_loc2_.walls.pattern);
         this.var_1201 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_965)
                  {
                     _loc11_ = this.var_965[_loc10_];
                     if(this.var_631.indexOf(_loc10_) == -1)
                     {
                        this.var_631.push(_loc10_);
               ...
               case "wallpaper":
                  ...
                  {
                     this.var_773.push(_loc8_);
                     this.var_1202.push(_loc3_);
                  }
                  else
                  {
                  ...
                  break;
               case "landscape":
                  if(this.var_1201[_loc8_] != null)
                  {
                     this.var_772.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1470,this.var_1469,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1202[this.var_435];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1470);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1469);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_631[this.var_437];
         var _loc3_:Array = this.var_965[_loc2_];
         if(_loc3_ != null && this.var_434 >= 0)
         {
            _loc11_ = _loc3_[this.var_434];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1203[this.var_437];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_773[this.var_435];
         var _loc6_:Array = this.var_1204[_loc5_];
         if(_loc6_ != null && this.var_438 >= 0)
         {
            _loc13_ = _loc6_[this.var_438];
            if(_loc13_ != null)
            {
               this.var_1470 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1202[this.var_435];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_772[this.var_436];
         var _loc9_:Array = this.var_1201[_loc8_];
         if(_loc9_ != null && this.var_433 >= 0)
         {
            _loc15_ = _loc9_[this.var_433];
            if(_loc15_ != null)
            {
               this.var_1469 = _loc15_;
            }
         }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_109:
               ...
               if(this.var_437 < 0)
               {
                  this.var_437 = this.var_631.length - 1;
               }
               if(this.var_437 >= this.var_631.length)
               {
                  this.var_437 = 0;
               }
               this.var_434 = 0;
               this.var_967 = 0;
               _loc5_ = this.var_631[this.var_437];
               _loc6_ = this.var_965[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_967 = _loc6_.length;
               }
            ...
            case const_239:
               ...
               if(this.var_435 < 0)
               {
                  this.var_435 = this.var_773.length - 1;
               }
               if(this.var_435 == this.var_773.length)
               {
                  this.var_435 = 0;
               }
               this.var_438 = 0;
               this.var_966 = 0;
               _loc7_ = this.var_773[this.var_435];
               _loc8_ = this.var_1204[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_966 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_436 < 0)
               {
                  this.var_436 = this.var_772.length - 1;
               }
               if(this.var_436 >= this.var_772.length)
               {
                  this.var_436 = 0;
               }
               this.var_433 = 0;
               this.var_964 = 0;
               _loc9_ = this.var_772[this.var_436];
               _loc10_ = this.var_1201[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_964 = _loc10_.length;
               }
