package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2018:String = "ctlg_";
       
      
      protected var var_2208:XML;
      ...
      private var var_516:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1168:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_516 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1167);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1167);
      }
      ...
      {
         var _loc2_:String = const_2018 + param1;
         ...
         this.var_2208 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2208) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1815:
               if(this.var_1168 == null)
               {
                  this.var_1168 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_39.push(this.var_1168);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1825:
               ...
               break;
            case CatalogWidgetEnum.const_1759:
            ...
            case CatalogWidgetEnum.const_1711:
               ...
               break;
            case CatalogWidgetEnum.const_1861:
               this.var_39.push(new PurseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1735:
            ...
            case CatalogWidgetEnum.const_1914:
               ...
               break;
            case CatalogWidgetEnum.const_1894:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_516.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_516 != null)
         {
            return this.var_516.dispatchEvent(param1);
         }
         return false;
      }
