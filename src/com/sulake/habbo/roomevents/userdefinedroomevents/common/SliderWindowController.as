package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1340:Number = 1.0;
      
      private var var_702:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1340,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1097);
         }
      ...
      {
         return int(this.var_2046 * (Number(param1 - this._minValue) / (this.var_1340 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_2046 * (this.var_1340 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1098)
         {
            if(param1.type == WindowMouseEvent.const_58 || param1.type == WindowMouseEvent.const_248)
            {
               this.var_1098 = false;
            }
         }
         if(!this.var_1098 || param1.type != WindowEvent.const_410)
         {
            return;
         }
         if(this.var_702 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_702) * this.var_702;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_702 != 0)
            {
               _loc3_ = this.var_1097 + this.var_702;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_852 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_852.width,this.var_852.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_852,this.var_852.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_853 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_853.width,this.var_853.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_853,this.var_853.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_2046 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_852 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_853 = BitmapData(_loc2_.content);
      }
   }
}
