package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_350:int = 3;
      
      private static var var_1596:int = 2;
      ...
      private var var_2033:TriggerConfs;
      
      private var var_2032:ActionTypes;
      
      private var var_2034:ConditionTypes;
      
      private var var_292:Dictionary;
      
      private var var_38:Triggerable;
      
      private var var_851:RoomObjectHightLighter;
      
      private var var_203:UserDefinedRoomEventsHelp;
      
      private var var_1308:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2033 = new TriggerConfs();
         this.var_2032 = new ActionTypes();
         this.var_2034 = new ConditionTypes();
         this.var_292 = new Dictionary();
         super();
         this.var_92 = param1;
         this.var_851 = new RoomObjectHightLighter(param1);
         this.var_203 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_292[param1])
         {
            delete this.var_292[param1];
            this.var_851.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_38.furniLimit)
         {
            this.var_292[param1] = param2;
            this.var_851.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_57 = IWindowContainer(this.find(this._window,"configure_container"));
         Util.setProcDirectly(this.find(this.var_57,"save_button"),this.onSave);
         Util.setProcDirectly(this.find(this.var_57,"cancel_save_button"),this.onWindowClose);
         Util.setProcDirectly(this.find(this.var_57,"helplink"),this.onHelp);
         Util.setProcDirectly(this.find(this.var_57,"apply_snapshot_txt"),this.onApplySnapshot);
         Util.setProcDirectly(this.find(this.var_57,"dec_stuff_sel_txt"),this.onDecStuffSelectionType);
         Util.setProcDirectly(this.find(this.var_57,"inc_stuff_sel_txt"),this.onIncStuffSelectionType);
         this.find(this.var_57,"dec_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_57,"inc_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_57,"helplink").mouseThreshold = 0;
         this.find(this.var_57,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1308 = new SliderWindowController(this.var_92,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_92.assets,0,20,1);
         this.var_1308.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1308.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_851.hideAll(this.var_292);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_38.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_350)
            {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(this.var_57.findChildByName("select_furni_container"));
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1308.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_203.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1596) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1596 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_350)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2033);
         this.refreshConfigureElement(this.var_2032);
         this.refreshConfigureElement(this.var_2034);
      ...
      private function refreshConfigureElement(param1:ElementTypeHolder) : void
      {
         ...
         {
            this.find(this.var_57,param1.getKey() + "_icon_bitmap").visible = false;
            return;
         }
         ...
         this.find(this.var_57,"warning_container").visible = false;
         this.refreshConflictingTriggers();
         this.refreshConflictingActions();
         this.refreshActionInputs();
         Util.moveAllChildrenToColumn(this.var_57,3,5);
         this.var_57.height = Util.getLowestPoint(this.var_57) + 1;
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_57,"header_container"));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_57,"action_inputs_container"));
         if(this.var_38 as ActionDefinition == null)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_57,"warning_container"));
         ...
         _loc3_.height = Util.getLowestPoint(_loc3_) + 4;
         this.find(this.var_57,"warning_container").visible = true;
      }
      
      private function refreshCustomInputs() : void
      {
         var _loc2_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_57.findChildByName("custom_inputs_container"));
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         var _loc2_:Element = this.resolveType();
         var _loc3_:IWindowContainer = IWindowContainer(this.var_57.findChildByName("custom_inputs_container"));
         ...
         if(_loc5_ == null)
         {
            ...
            _loc2_.method_1(_loc5_,this.var_92);
         }
         return _loc5_;
      }
      ...
      {
         return ICheckBoxWindow(this.var_57.findChildByName("furni_type_matches_checkbox"));
      }
      
      private function getDecStuffSelTxt() : IWindow
      {
         return this.var_57.findChildByName("dec_stuff_sel_txt");
      }
      
      private function getIncStuffSelTxt() : IWindow
      {
         return this.var_57.findChildByName("inc_stuff_sel_txt");
      }
      
      private function getFurniTypeMatchesText() : IWindow
      {
         return this.var_57.findChildByName("furni_type_matches_txt");
      }
   }
}
