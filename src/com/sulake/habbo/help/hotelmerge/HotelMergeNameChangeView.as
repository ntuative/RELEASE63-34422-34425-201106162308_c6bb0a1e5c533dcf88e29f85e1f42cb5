package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_900)
         {
            this.var_900 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_900)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_899)
         {
            this.var_899 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_899)
            {
               return;
            }
