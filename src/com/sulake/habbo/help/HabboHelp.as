package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1042:IHabboConfigurationManager;
      
      private var var_394:ISessionDataManager;
      
      private var var_1294:FaqIndex;
      
      private var _incomingMessages:IncomingMessages;
      
      private var var_74:HelpUI;
      
      private var var_118:TutorialUI;
      
      private var var_846:HotelMergeUI;
      
      private var var_1577:CallForHelpData;
      
      private var var_2745:UserRegistry;
      
      private var var_2598:String = "";
      
      private var var_1043:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1577 = new CallForHelpData();
         this.var_2745 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1294 = new FaqIndex();
      ...
      public function hasChangedName() : Boolean
      {
         if(this.var_118)
         {
            return this.var_118.hasChangedName;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1042)
         {
            this.var_1042.release(new IIDHabboConfigurationManager());
            this.var_1042 = null;
         }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_1042.getKey(param1,param2,param3);
      }
      ...
      {
         this.var_1577.reportedUserId = param1;
         this.var_1577.reportedUserName = param2;
         this.var_74.showUI(HabboHelpViewEnum.const_408);
      }
      ...
      {
         var _loc1_:* = false;
         if(this.var_118 == null && this._assetLibrary != null && this._windowManager != null)
         {
            _loc1_ = this.getConfigurationKey("avatar.widget.enabled","0") == "0";
            this.var_118 = new TutorialUI(this,_loc1_);
         }
      ...
      public function updateTutorial(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         this.var_118.update(param1,param2,param3);
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_118)
         {
            this.var_118.showView(TutorialUI.const_331);
         }
      }
      ...
      {
         this.var_950 = IHabboLocalizationManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),this.onConfigurationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_1042 = IHabboConfigurationManager(param2);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_75:
               ...
               if(this.var_118 != null)
               {
                  this.var_118.setRoomSessionStatus(true);
               }
               break;
            case RoomSessionEvent.const_82:
               ...
               if(this.var_118 != null)
               {
                  this.var_118.setRoomSessionStatus(false);
               }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_1043)
         {
            this.var_1043 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_1043.showWelcomeScreen(param1);
      }
