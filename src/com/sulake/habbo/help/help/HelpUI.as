package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2134:String = "HHVE_HELP_FRONTPAGE";
      ...
      private var var_416:IWindowContainer;
      ...
      {
         this.var_417 = this.var_2134;
         this.var_588 = new Array();
         this.var_715 = new Array();
         super();
         this.var_23 = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106162301));
         this.var_138 = new Map();
         this.var_138.add(HabboHelpViewEnum.const_1911,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_211,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_611,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_323,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_258,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_408,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_998,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_302,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_138.add(HabboHelpViewEnum.const_1358,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_138.add(HabboHelpViewEnum.const_1295,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_138.add(HabboHelpViewEnum.const_901,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_138.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_138.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_588.length == 0 || param1 != this.var_417)
            {
               this.var_588.push(this.var_417);
            }
         }
         this.var_417 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_417);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_302:
               this.showUI(HabboHelpViewEnum.const_302);
               break;
            case CallForHelpResultEnum.const_1351:
               this.showUI(HabboHelpViewEnum.const_1295);
               break;
            case CallForHelpResultEnum.const_1323:
               this.showUI(HabboHelpViewEnum.const_1358);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_138.getValue(HabboHelpViewEnum.const_211) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_496));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_138.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_138.getValue(this.var_417);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2637 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2638;
         this._window.width = _loc1_.width + this.var_2637;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_588.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_417 == HabboHelpViewEnum.const_211)
         {
            return;
         }
         if(this.var_715.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_715.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_715.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_416.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_715[1],this.var_715[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_715[0],this.var_715[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_417 == HabboHelpViewEnum.const_211 || this.var_588.length == 0)
         {
            return;
         }
         if(this.var_416 == null)
         {
            ...
            this.var_416 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_416.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_416.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_416 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_416 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_416 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
