package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1658:uint = 13232628;
      
      private static var var_2144:uint = 11129827;
      ...
      private var var_899:IWindowContainer;
      
      private var var_52:IWindowContainer;
      
      private var var_1659:Boolean = false;
      
      private var var_1370:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_331;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_592 = param1;
         if(this.var_2146 == this.var_592)
         {
      ...
      private function showView(param1:IWindowContainer) : void
      {
         ...
         if(this._window)
         {
            this._window.content.width = this.var_52.width;
            this._window.content.height = this.var_52.height;
         }
      }
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_2145 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_900)
         {
            this.var_900 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_900)
            {
               return;
            }
            this._window.content.addChild(this.var_900);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_899)
         {
            this.var_899 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_899)
            {
               return;
            }
            this._window.content.addChild(this.var_899);
         }
         this._window.caption = this.var_27.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_899.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_592;
         }
         this.showView(this.var_899);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_27.localization.registerParameter("help.tutorial.name.available","name",this.var_592);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_909:
               break;
            case ChangeUserNameResultMessageEvent.var_905:
            ...
            case ChangeUserNameResultMessageEvent.var_906:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1122:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1121 || param1 == ChangeUserNameResultMessageEvent.var_1122)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1370 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1370.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1658;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_592 = this.var_27.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_592 != _loc5_)
               {
                  this.var_2146 = _loc5_;
            ...
            case "confirm_name_button":
               this.var_27.changeName(this.var_592);
               break;
            ...
            case "header_button_close":
               this.var_27.showView(TutorialUI.const_98);
         }
      }
