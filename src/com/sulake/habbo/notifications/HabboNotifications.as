package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1648:String = "pixelbalance";
      
      private static const const_1649:String = "badges";
      
      private static const const_1650:String = "selectbadge";
      
      private static const const_1646:String = "inventory";
      
      private static const const_1651:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1652:String = "friendlist";
      
      private static const const_1647:String = "pet_inventory";
      
      private static const const_1653:String = "go_to_room";
      ...
      private var var_407:HabboNotificationViewManager;
      
      private var var_255:HabboAlertDialogManager;
      
      private var var_869:ParkBusDialogManager;
      
      private var var_2868:Boolean;
      
      private var var_1087:ClubGiftNotification;
      
      private var var_1086:ClubEndingNotification;
      
      private var var_1085:ClubPromoNotification;
      
      private var var_3044:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1772 = false;
         this.var_3044 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1088);
         }
         var _loc6_:Map = this.var_1088["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1088["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1335.push(_loc8_);
         return this.var_1335.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1335.splice(0,1);
      ...
      public function setQuestTrackerHeight(param1:int) : void
      {
         if(this.var_407)
         {
            this.var_407.topMarginIncrease = param1;
         }
      }
      ...
      {
         this.var_407 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1088["styles"],this.var_1088["view"]);
         ...
         registerUpdateReceiver(this.var_407,1);
         registerUpdateReceiver(this,2);
         this.var_394.events.addEventListener(BadgeImageReadyEvent.const_210,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_394.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1233,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1233,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1877,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_849,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_1021.createAvatarImage(param2,AvatarScaleType.const_59);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               if(_loc6_.productType == CatalogPageMessageProductData.const_76)
               {
                  _loc7_ = this.var_394.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_65)
               {
                  _loc7_ = this.var_394.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_394.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1727,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_65:
               ...
               else
               {
                  switch(_loc7_)
                  {
                     case FurniCategory.const_354:
                        _loc4_ = (this.var_13 as Component).assets.getAssetByName("icon_wallpaper_png") as BitmapDataAsset;
                        if(_loc4_ != null)
                        {
                     ...
                     case FurniCategory.const_320:
                        _loc4_ = (this.var_13 as Component).assets.getAssetByName("icon_landscape_png") as BitmapDataAsset;
                        if(_loc4_ != null)
                        {
                           _loc6_ = (_loc4_.content as BitmapData).clone();
                        }
                     ...
                     case FurniCategory.const_338:
                        _loc4_ = (this.var_13 as Component).assets.getAssetByName("icon_floor_png") as BitmapDataAsset;
                        if(_loc4_ != null)
                        {
                           _loc6_ = (_loc4_.content as BitmapData).clone();
                        }
               ...
               break;
            case CatalogPageMessageProductData.const_186:
               _loc4_ = (this.var_13 as Component).assets.getAssetByName("fx_icon_" + param2 + "_png") as BitmapDataAsset;
               if(_loc4_ != null)
               {
                  _loc6_ = (_loc4_.content as BitmapData).clone();
               }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1324)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1854,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1896)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_1086 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1085 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_407.isSpaceAvailable() && this.var_1335.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_407.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1649:
               if(this.var_13 != null)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_287);
               }
               break;
            case const_1650:
               break;
            case const_1646:
               if(this.var_13 != null && this.var_13.hasRoomSession)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_77);
               }
               break;
            case const_1647:
               if(this.var_13 != null && this.var_13.hasRoomSession)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_137);
               }
               break;
            case const_1651:
               break;
      ...
      {
         if(param1 != null && this.var_407 != null)
         {
            this.var_407.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_354;
            }
            if(param2 == 3002)
            {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_320;
            }
            return 1;
         }
         return 1;
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_869 == null)
         {
            this.var_869 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_869 != null)
         {
            this.var_869.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1229,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1229,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1021.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_59);
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_41,3);
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2868)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_849,null);
            this.var_2868 = true;
      ...
      {
         if(param2.type == WindowEvent.const_181 || param2.type == WindowEvent.const_570)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1087 && this.var_1087.visible)
         {
            return;
         }
         this.var_1087 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_849,_loc6_);
      }
   }
}
