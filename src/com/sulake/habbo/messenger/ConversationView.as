package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1532:int = 10;
      
      private static const const_1086:int = 100;
      
      private static const const_1531:int = 20;
       
      
      private var var_153:HabboMessenger;
      
      private var var_2552:IScrollbarWindow;
      
      private var var_1860:IContainerButtonWindow;
      
      private var var_67:IItemListWindow;
      
      private var var_542:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_153 = param1;
         this.var_1860 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_67 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2552 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_153.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1086 + const_1531)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_153.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1532;
         param1.invalidate();
      }
      ...
      {
         var _loc1_:Conversation = this.var_153.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
         if(this.var_542 == null || _loc1_.id != this.var_542.id)
         {
            this.var_542 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_542.followingAllowed)
         {
            this.var_1860.enable();
         }
         else
         {
            this.var_1860.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_67.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_542.messages.length - const_1086);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_542.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_542.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_153.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_788 || param3.type == Message.const_939 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_542.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_153.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_153.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_153.send(new FollowFriendMessageComposer(this.var_542.id));
         this.var_153.send(new EventLogMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_153.conversations.closeConversation();
         this.var_153.messengerView.refresh();
      }
      
      private function getChatBgColor(param1:int) : uint
      {
         if(param1 == Message.const_788)
         {
            return 4294967295;
         }
         if(param1 == Message.const_939)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1154)
         {
            return 4294927974;
         }
         ...
         if(param1 == Message.const_867)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1170)
         {
            return 4288269465;
         }
         return 4291611852;
