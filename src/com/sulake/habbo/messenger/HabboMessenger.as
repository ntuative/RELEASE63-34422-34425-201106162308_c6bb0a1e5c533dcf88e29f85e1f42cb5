package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_474:Conversations;
      
      private var var_202:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_179 && this._localization && this._friendList && this.var_759 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_474 = new Conversations(new ConversationsDeps(this));
         this.var_202 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_474.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_474.setSelected(_loc2_);
            this.var_202.openMessenger();
            this.var_202.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_474 ? this.var_474.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_474.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_474.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         return this.var_202 && this.var_202.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_202)
         {
            if(this.var_202.isMessengerOpen())
            {
               this.var_202.close();
            }
            else
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_179.getKey("url.prefix",_loc2_);
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_939,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1170,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_474.addMessageAndUpdateView(param1);
         if(!this.var_202.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1355);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1154,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_474.addMessageAndUpdateView(_loc3_);
      }
