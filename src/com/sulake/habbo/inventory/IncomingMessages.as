package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_30:IHabboCommunicationManager;
      
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         this.var_13 = param1;
         this.var_30 = this.var_13.communication;
         this.var_30.addHabboConnectionMessageEvent(new FurniListEvent(this.onFurniList));
         this.var_30.addHabboConnectionMessageEvent(new FurniListInsertEvent(this.onFurniListInsert));
         this.var_30.addHabboConnectionMessageEvent(new FurniListRemoveEvent(this.onFurniListRemove));
         this.var_30.addHabboConnectionMessageEvent(new FurniListUpdateEvent(this.onFurniListUpdate));
         this.var_30.addHabboConnectionMessageEvent(new PostItPlacedEvent(this.onPostItPlaced));
         this.var_30.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(this.onAvatarEffects));
         this.var_30.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(this.onAvatarEffectActivated));
         this.var_30.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(this.onAvatarEffectAdded));
         this.var_30.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(this.onAvatarEffectExpired));
         this.var_30.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(this.onClubStatus));
         this.var_30.addHabboConnectionMessageEvent(new BadgesEvent(this.onBadges));
         this.var_30.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(this.onUserBadges));
         this.var_30.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(this.onAchievementReceived));
         this.var_30.addHabboConnectionMessageEvent(new BadgePointLimitsEvent(this.onBadgePointLimits));
         this.var_30.addHabboConnectionMessageEvent(new AchievementsScoreEvent(this.onAchievementsScore));
         this.var_30.addHabboConnectionMessageEvent(new TradingAcceptEvent(this.onTradingAccepted,TradingAcceptParser));
         this.var_30.addHabboConnectionMessageEvent(new TradingConfirmationEvent(this.onTradingConfirmation,TradingConfirmationParser));
         this.var_30.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(this.onTradingAlreadyOpen,TradingAlreadyOpenParser));
         this.var_30.addHabboConnectionMessageEvent(new TradingCloseEvent(this.onTradingClose,TradingCloseParser));
         this.var_30.addHabboConnectionMessageEvent(new TradingCompletedEvent(this.onTradingCompleted,TradingCompletedParser));
         this.var_30.addHabboConnectionMessageEvent(new TradingItemListEvent(this.onTradingItemList,TradingItemListParser));
         this.var_30.addHabboConnectionMessageEvent(new TradingNotOpenEvent(this.onTradingNotOpen,TradingNotOpenParser));
         this.var_30.addHabboConnectionMessageEvent(new TradingOpenEvent(this.onTradingOpen,TradingOpenParser));
         this.var_30.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(this.onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         this.var_30.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(this.onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         this.var_30.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(this.onRoomClosed));
         this.var_30.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(this.onRoomClosed));
         this.var_30.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(this.onRoomClosed));
         this.var_30.addHabboConnectionMessageEvent(new PetInventoryEvent(this.onPets));
         this.var_30.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(this.onPetAdded));
         this.var_30.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(this.onPetRemoved));
         this.var_30.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(this.onPetInventoryUpdated));
         this.var_30.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(this.onMarketplaceConfiguration));
         this.var_30.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(this.onMarketplaceCanMakeOfferResult));
         this.var_30.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(this.onMarketplaceMakeOfferResult));
         this.var_30.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(this.onMarketplaceItemStats));
         this.var_30.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(this.onNotEnoughCredits));
         this.var_30.addHabboConnectionMessageEvent(new UserRightsMessageEvent(this.onUserRights));
         this.var_30.addHabboConnectionMessageEvent(new UnseenItemsEvent(this.onUnseenItems));
      }
      ...
      private function getConnection() : IConnection
      {
         ...
         return this.var_30.getHabboMainConnection(null);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:FurniModel = this.var_13.furniModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_77,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:EffectsModel = this.var_13.effectsModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_162);
         _loc2_.refreshViews();
         this.var_13.notifyChangedEffects();
      }
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_13.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember,_loc2_.isVIP);
            this.var_13.events.dispatchEvent(new HabboInventoryHabboClubEvent());
         }
      }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:BadgesModel = this.var_13.badgesModel;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         _loc3_.method_18();
         _loc3_.updateView();
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_287);
      }
      ...
      public function onBadgePointLimits(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_13.localization.setBadgePointLimit(_loc3_.badgeId,_loc3_.limit);
         }
      }
      ...
      public function onUserBadges(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.userId != this.var_13.sessionData.userId)
         {
            return;
         }
         var _loc3_:BadgesModel = this.var_13.badgesModel;
      ...
      public function onAchievementReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:BadgesModel = this.var_13.badgesModel;
         if(_loc4_ != null)
         {
      ...
      public function onAchievementsScore(param1:IMessageEvent) : void
      {
         ...
         this.var_13.localization.registerParameter("achievements_score_description","score",_loc3_.score.toString());
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:ISessionDataManager = this.var_13.sessionData;
         var _loc3_:IRoomSession = this.var_13.roomSession;
         if(!_loc2_)
         {
         ...
         this.var_13.toggleInventorySubPage(InventorySubCategory.const_321);
         ...
         var _loc13_:TradingModel = this.var_13.tradingModel;
         if(_loc13_ != null)
         {
      ...
      {
         var _loc2_:TradingModel = this.var_13.tradingModel;
         if(_loc2_ != null)
         {
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         var _loc11_:FurniModel = this.var_13.furniModel;
         if(_loc11_ == null)
         {
            return;
         }
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_229)
            {
            ...
            if(_loc9_.itemType == "S")
            {
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModelCategory.const_36,_loc9_.category,_loc9_.stuffData);
            ...
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModelCategory.const_44,_loc9_.category,_loc9_.stuffData);
                  _loc3_.add(_loc8_,_loc6_);
               }
         ...
         var _loc12_:TradingModel = this.var_13.tradingModel;
         if(_loc12_ != null)
         {
            _loc12_.updateItemGroupMaps(_loc2_.method_7,_loc3_,_loc2_.secondUserID,_loc4_);
         }
      }
      ...
      {
         this.var_13.closeView();
      }
      
      private function onPets(param1:PetInventoryEvent) : void
      {
         var _loc4_:* = null;
         if(param1 == null || this.var_13 == null)
         {
            return;
         }
         var _loc2_:PetsModel = this.var_13.petsModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_137);
         this.var_13.petsModel.setListInitialized();
      }
      ...
      private function onPetAdded(param1:PetAddedToInventoryEvent) : void
      {
         ...
         this.var_13.furniModel.automaticSwitchToPetCategory();
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var _loc2_:MarketplaceModel = this.var_13.marketplaceModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_439);
         var _loc4_:FurniModel = this.var_13.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_13.isInventoryCategoryInit(InventoryCategory.const_439))
         {
            _loc2_ = this.var_13.marketplaceModel;
            if(_loc2_ == null)
            {
               return;
            }
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_13.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_419));
         this.var_13.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_401));
         this.var_13.petsModel.addUnseenPets(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_57));
         this.var_13.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1353));
         this.var_13.updateUnseenItemCounts();
      }
   }
}
