package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_137 && this.var_27.isVisible)
         {
            this._view.updateCategoryButtons();
            this.var_27.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      
      public function switchToFurnitureCategory(param1:String, param2:Boolean = false) : void
      {
         var _loc3_:FurniModel = this.var_27.furniModel;
         if(_loc3_ != null)
         {
            _loc3_.switchCategory(param1);
            this.var_27.toggleInventoryPage(InventoryCategory.const_77,param2);
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(this.var_27.roomSession.isRoomOwner)
         {
            this.var_1998 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_29,RoomObjectTypeEnum.const_207,_loc3_.figureString);
            this.var_27.closeView();
            return;
         }
         if(!this.var_27.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1998 && param1.type == RoomEngineObjectEvent.const_158)
         {
      ...
      {
         return this.var_27.roomSession;
      }
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_566.indexOf(_loc2_) == -1)
            {
               this.var_566.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_566 && this.var_566.length > 0)
         {
      ...
      {
         return this.var_566.length;
      }
      
      public function isUnseen(param1:int) : Boolean
      {
         return this.var_566.indexOf(param1) > -1;
      }
   }
}
