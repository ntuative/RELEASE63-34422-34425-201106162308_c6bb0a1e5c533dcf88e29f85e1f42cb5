package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1129:int = 1;
      
      private const const_1127:int = 2;
      
      private const const_1131:int = 3;
      ...
      private var var_77:PetsModel;
      
      private var _disposed:Boolean = false;
      
      private var var_230:IItemGridWindow;
      ...
      private var var_234:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_230 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_234);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_562.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_230.removeGridItem(_loc2_.window);
         if(this.var_234 == _loc2_)
         {
            this.var_234 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_562 == null || this.var_562.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_562.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_562.getValue(param1.id) != null)
         {
            return;
         }
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_77.isUnseen(param1.id));
         if(_loc2_ != null)
         {
            this.var_230.addGridItem(_loc2_.window);
            this.var_562.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_230.method_2();
         for each(_loc1_ in this.var_562)
         {
            _loc1_.dispose();
         }
         this.var_562.reset();
         _loc2_ = this.var_77.pets;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_234.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_77.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_48)
         {
            ...
            {
               case "tab_floor":
                  this.var_77.switchToFurnitureCategory(FurniModelCategory.const_36);
                  break;
               case "tab_wall":
                  this.var_77.switchToFurnitureCategory(FurniModelCategory.const_44);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_234 != null)
         {
            this.var_234.setSelected(false);
         }
         this.var_234 = param1;
         if(this.var_234 != null)
         {
            this.var_234.setSelected(true);
         }
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Map = this.var_77.pets;
         if(!this.var_77.isListInitialized())
         {
            _loc2_ = this.const_1129;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1127;
         }
         else
         {
            _loc2_ = this.const_1131;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1129:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1127:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1131:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_77.roomSession != null)
         {
            _loc8_ = this.var_77.roomSession.arePetsAllowed;
            _loc9_ = this.var_77.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc8_ = this._avatarRenderer.createPetImage(param1,param2,_loc7_,AvatarScaleType.const_59,this);
            if(_loc8_ != null)
            {
               _loc8_.setDirection(AvatarSetType.const_41,param4);
               if(param5)
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_41);
               }
               else
               {
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_77.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_419) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_77.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_401) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_77.getUnseenItemCount() > 0;
      }
   }
}
