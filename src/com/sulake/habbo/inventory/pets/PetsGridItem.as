package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1425.setSelectedGridItem(this);
               this.var_1424 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1424 = false;
                  this.var_1425.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1423)
         {
            return;
         }
         this.var_1423.color = !!this.var_1646 ? uint(const_1418) : uint(const_1417);
         this.var_2276.visible = param1;
      }
