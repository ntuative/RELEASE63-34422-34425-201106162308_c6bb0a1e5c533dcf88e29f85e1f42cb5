package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2310:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_75,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_82,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_552,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_63.getValue(InventoryCategory.const_77));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_63.getValue(InventorySubCategory.const_321));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_63.getValue(InventoryCategory.const_162));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_63.getValue(InventoryCategory.const_287));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_63.getValue(InventorySubCategory.const_1220));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_63.getValue(InventoryCategory.const_137));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_63.getValue(InventoryCategory.const_439) as MarketplaceModel;
      }
      ...
      {
         return this.var_119.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_119.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_119.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_119.clubHasEverBeenMember;
      }
      ...
      public function get clubLevel() : int
      {
         ...
         return HabboClubLevelEnum.const_38;
      }
      
      public function get hasRoomSession() : Boolean
      {
         return this.var_1208 != null;
      }
      ...
      {
         this.var_119.clubPeriods = param1;
         this.var_119.clubDays = param2;
         this.var_119.clubHasEverBeenMember = param3;
         this.var_119.isVIP = param4;
      ...
      {
         this.var_394 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_75,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionEvent.const_82,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_552,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_82:
               this.var_1208 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_552:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_394 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_63.add(InventoryCategory.const_439,_loc1_);
         ...
         this.var_63.add(InventoryCategory.const_77,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_394);
         this.var_63.add(InventoryCategory.const_287,_loc3_);
         ...
         this.var_63.add(InventoryCategory.const_162,_loc4_);
         ...
         this.var_63.add(InventorySubCategory.const_321,_loc5_);
         ...
         this.var_63.add(InventorySubCategory.const_1220,_loc6_);
         ...
         this.var_63.add(InventoryCategory.const_137,_loc7_);
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_321:
               this._view.toggleCategoryView(InventoryCategory.const_77,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_972.indexOf(param1) == -1)
            {
               this.var_972.push(param1);
            }
         }
         else
         {
            _loc3_ = this.var_972.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_972.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_972.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2310);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_278));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2458)
         {
            this.var_2458 = _loc1_;
