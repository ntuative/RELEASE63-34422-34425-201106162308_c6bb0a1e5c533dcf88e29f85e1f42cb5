package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_27 != null && this.var_27.furniModel != null && this.var_248 != null)
         {
            this.var_27.furniModel.removeLockFrom(this.var_248.id);
            this.var_248 = null;
         }
      }
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2496 = _loc2_;
         this.var_2498 = this.var_248.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1918,this.var_1917);
         }
      }
      ...
      {
         if(param1 != this.var_2496 || param2 != this.var_2498)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2497);
      }
