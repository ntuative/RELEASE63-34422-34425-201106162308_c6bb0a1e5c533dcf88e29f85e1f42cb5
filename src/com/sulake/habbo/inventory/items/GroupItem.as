package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1417:int = 13421772;
      
      private static const const_1418:int = 10275685;
      ...
      protected var var_911:int = 0;
      
      protected var var_729:BitmapData;
      
      protected var var_2841:int;
      
      protected var var_1670:Boolean;
      
      protected var var_2211:Boolean;
      
      protected var var_2998:BitmapData;
      
      private var var_1442:Boolean;
      
      private const const_2046:Number = 1;
      
      private const const_2045:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1423 = this._window.findChildByTag("BG_COLOR");
         this.var_2276 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_2998 = param6;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2209 == FurniModelCategory.const_36)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1533));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2210);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_850)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2045;
               _loc1_.blend = this.const_2045;
            }
            else
            {
               this._window.blend = this.const_2046;
               _loc1_.blend = this.const_2046;
            }
         }
         this.var_1423.color = !!this.var_1442 ? uint(const_1418) : uint(const_1417);
         this.var_2276.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2211 && this.method_14() > 0)
            {
               _loc5_.bitmap = this.var_2998;
               _loc5_.visible = true;
            }
            else
            {
