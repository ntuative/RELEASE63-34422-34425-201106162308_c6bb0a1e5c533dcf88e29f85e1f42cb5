package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1580:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_675 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_675.width;
         this.var_104 = this.var_675.height;
         this.var_1297 = param5;
         this.var_1048 = param6;
         this.var_251 = Math.floor(this.var_1297 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1297,this.var_1048);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_674 = this.resolveRowCountFromList();
         if(this.var_674 == 0)
         {
            this.var_29 = new BitmapData(this.var_1297,this.var_1048);
            return;
         }
         this.var_29 = new BitmapData(Math.max(this.var_251 * this._thumbWidth,this.var_1297),Math.max(this.var_674 * this.var_104,this.var_1048),true,16777215);
         this.var_29.fillRect(this.var_29.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_674)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_251)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc6_ = this.method_6(_loc5_.iconImage,_loc5_.isSelected);
                     this.var_29.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_104),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_251 && this.var_29.height < _loc3_.y * this.var_104)
         {
            _loc2_ = new BitmapData(this.var_29.width,this.var_29.height + this.var_104);
         }
         else
         {
            _loc2_ = new BitmapData(this.var_29.width,this.var_29.height);
         }
         var _loc5_:BitmapData = this.method_6(param1.iconImage,param1.isSelected);
         _loc2_.copyPixels(_loc5_,_loc5_.rect,new Point(0,0),null,null,true);
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_251 - 1),this.var_104);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_251 - 1),0,this._thumbWidth,this.var_29.height);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(0,this.var_104),null,null,true);
         _loc4_ = new Rectangle(0,this.var_104,this._thumbWidth * (this.var_251 - 1),this.var_29.height - this.var_104);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,this.var_104),null,null,true);
         this.var_29 = _loc2_;
      }
      ...
      public function replaceItemImage(param1:int, param2:IThumbListDrawableItem) : void
      {
         ...
         var _loc4_:Point = new Point(_loc3_.x * this._thumbWidth,_loc3_.y * this.var_104);
         var _loc5_:BitmapData = this.method_6(param2.iconImage,param2.isSelected);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1580.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_251));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_251 + _loc2_.x);
      }
      
      private function resolveGridLocationFromImage(param1:Point) : Point
      {
         var _loc2_:int = Math.floor(param1.y / this.var_104);
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_251);
         var _loc3_:int = param1 % this.var_251;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_251)
         {
            return;
         }
         if(param1.y >= this.var_674)
         {
            return;
         }
         var _loc4_:int = this.var_251 - param1.x - 1;
         _loc2_ = new Rectangle((param1.x + 1) * this._thumbWidth,param1.y * this.var_104,_loc4_ * this._thumbWidth,this.var_104);
         _loc3_ = new Point(param1.x * this._thumbWidth,param1.y * this.var_104);
         ...
         if(param1.y < this.var_674 - 1)
         {
            _loc7_ = this.var_29.width - this._thumbWidth;
            _loc8_ = this.var_29.height - (param1.y + 1) * this.var_104;
            _loc9_ = new BitmapData(_loc7_,_loc8_);
            _loc2_ = new Rectangle(this._thumbWidth,(param1.y + 1) * this.var_104,_loc9_.width,_loc9_.height);
            ...
            this.var_29.fillRect(new Rectangle(0,this.var_29.height - this.var_104,this.var_29.width,this.var_104),4294967295);
            _loc3_ = new Point(this.var_29.width - this._thumbWidth,_loc2_.y - this.var_104);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == this.var_251 - 1)
            {
               _loc11_ = new BitmapData(this.var_29.width,this.var_29.height - this.var_104);
               _loc2_ = new Rectangle(0,0,this.var_29.width,this.var_29.height - this.var_104);
               _loc11_.copyPixels(this.var_29,_loc2_,new Point(0,0),null,null,true);
               this.var_29 = _loc11_;
               --this.var_674;
            }
         }
         if(this.var_29.height < this.var_1048)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_1048);
      ...
      private function method_6(param1:BitmapData = null, param2:Boolean = false) : BitmapData
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_675.width,this.var_675.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_675.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_675,this.var_675.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
