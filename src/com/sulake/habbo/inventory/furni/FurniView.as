package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_2067:int = 0;
      
      private static const const_1129:int = 1;
      
      private static const const_1127:int = 2;
      
      private static const const_1131:int = 3;
      
      private static const const_1128:int = 42;
      
      private static const const_1130:int = 120;
      
      private static const const_1117:int = 4;
      ...
      private var var_805:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_399.add(FurniModelCategory.const_36,new FurniGridView(this.var_77,FurniModelCategory.const_36,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_399.add(FurniModelCategory.const_44,new FurniGridView(this.var_77,FurniModelCategory.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         this.switchCategory(FurniModelCategory.const_36);
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1117;
            _loc3_.y = _loc4_.y + const_1117;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         var _loc1_:Boolean = this.var_77.isTradingOpen;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         if(this.var_77.isMainViewActive())
         {
            this.var_77.resetUnseenItems();
         }
         switch(param1)
         {
            case FurniModelCategory.const_44:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_wall"));
               this.var_476 = FurniModelCategory.const_44;
               break;
            case FurniModelCategory.const_36:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               this.var_476 = FurniModelCategory.const_36;
               break;
            case FurniModelCategory.const_283:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_476 = FurniModelCategory.const_283;
               break;
            default:
               throw new Error("Unknown item category: \"" + param1 + "\"");
         }
         this.var_77.furniCategorySwitch();
         this.showCategoryGrid(this.var_476);
         this.setViewToState();
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_399.getValue(this.var_476);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_77.getCategoryContent(this.var_476);
         if(!this.var_77.isListInited())
         {
            _loc2_ = const_1129;
         }
         ...
         if(this.var_2698 == _loc2_)
         {
            return;
         }
         this.var_2698 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_36,FurniModelCategory.const_44];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_399.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_399.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_399.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_399.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_77.getUnseenItemCount(UnseenItemCategoryEnum.const_419) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_77.getUnseenItemCount(UnseenItemCategoryEnum.const_401) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_77.petsModel.getUnseenItemCount() > 0;
      }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = this.var_77.getSelectedItemIndex();
         _loc4_ = this.var_77.getGroupItemInIndex(_loc3_,this.var_476);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_206);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_233);
            ...
            if(_loc5_.category == FurniCategory.const_354)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_338)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_320)
            {
         ...
         var _loc12_:Boolean = this.var_77.isTradingOpen;
         _loc11_ = this._view.findChildByName("placeinroom_btn") as IButtonWindow;
         if(_loc11_)
         {
            if(_loc1_ && this.var_77.isPrivateRoom)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc11_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && this.var_77.canUserOfferToTrade())
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_805 && this.var_805.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1130)
         {
            _loc3_ = const_1130;
         }
         else if(_loc3_ < const_1128)
         {
            _loc3_ = const_1128;
         }
         else
      ...
      {
         var _loc3_:GroupItem = this.var_77.getGroupItemInIndex(this.var_77.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  this.var_77.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  this.var_77.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  this.var_77.requestSelectedFurniSelling();
                  break;
               case "open_catalog_btn":
                  this.var_77.requestCatalogOpen();
                  break;
               default:
                  this.var_77.cancelFurniInMover();
            }
         }
         else if(param1.type == WindowEvent.const_48)
         {
            switch(param2.name)
            {
               case "tab_floor":
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_283);
            }
         }
      }
