package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1869:uint = 9;
      
      public static const const_228:uint = 0;
      
      public static const const_208:uint = 1;
      
      public static const const_421:uint = 2;
      
      public static const const_333:uint = 3;
      
      public static const const_534:uint = 4;
      
      public static const const_300:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1005 = new Map();
         this.var_1259 = false;
         this.var_1776 = param6;
         this.var_802 = true;
         this.state = const_208;
         this.var_60.setup(param1,param3,param4,param6);
         this.var_60.updateItemList(this.var_816);
         this.var_60.updateItemList(this.var_1530);
      ...
      public function close() : void
      {
         if(this.var_802)
         {
            if(this._state != const_228 && this._state != const_300)
            {
      ...
      {
         this.var_60.setMinimized(param1 != InventoryCategory.const_77);
         this.var_13.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_817 + " OTHER: " + this.var_1259);
         ...
         {
            case const_228:
               if(param1 == const_208 || param1 == const_300)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         if(param1 == this.var_816)
         {
            this.var_281 = param2;
            this.var_1005 = param4;
         }
         else
         {
            this.var_281 = param4;
      ...
      {
         if(this._state == const_421)
         {
            this.state = const_333;
         }
      }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_60.alertPopup(TradingView.const_1263);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_816)
            {
               this.var_817 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1259 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_60.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_816)
            {
               this.var_60.alertPopup(TradingView.const_1284);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_281.length < const_1869)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_229)
            {
