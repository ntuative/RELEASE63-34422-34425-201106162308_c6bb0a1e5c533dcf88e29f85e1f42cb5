package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1148:uint = 4284532064;
      
      private static const const_1149:uint = 2577770;
      
      public static const const_1257:int = 0;
      
      public static const const_1284:int = 1;
      
      public static const const_1263:int = 2;
       
      
      private var var_20:TradingModel;
      ...
      private var var_722:ItemPopupCtrl;
      ...
      private var var_1115:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_722 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
         this._soundManager.events.addEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_232)
            {
               this.var_232.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_232.stop();
               this.var_232 = null;
            }
            ...
            if(this._soundManager)
            {
               ...
               {
                  this._soundManager.events.removeEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
               }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(this.var_2143 == null)
         {
            this.var_2143 = this.createMinimizedWindow();
         }
         if(!this.var_2951)
         {
            return this.var_80;
      ...
      public function updateItemList(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         var _loc9_:* = param1 == this.var_20.otherUserId;
         var _loc10_:Map = !!_loc9_ ? this.var_20.otherUserItems : this.var_20.ownUserItems;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_80)
         {
            ...
            if(_loc2_)
            {
               _loc2_.text = this.var_20.otherUserName;
            }
            _loc1_ = this.var_80.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1148) : uint(const_1149);
            }
            ...
            if(_loc3_)
            {
               ...
               _loc3_.bitmap.copyPixels(this._assetLibrary.getAssetByName(!!this.var_20.ownUserAccepts ? "trading_locked_icon_png" : "trading_unlocked_icon_png").content as BitmapData,_loc3_.bitmap.rect,new Point());
               _loc3_.invalidate();
            }
            _loc1_ = this.var_80.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1148) : uint(const_1149);
            }
            ...
            if(_loc3_)
            {
               ...
               _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
               _loc3_.bitmap.copyPixels(this._assetLibrary.getAssetByName(!!this.var_20.otherUserAccepts ? "trading_locked_icon_png" : "trading_unlocked_icon_png").content as BitmapData,_loc3_.bitmap.rect,new Point());
               _loc3_.invalidate();
            }
         }
      }
      ...
      public function updateActionState() : void
      {
         ...
         if(this.var_80)
         {
            ...
            switch(this.var_20.state)
            {
               case TradingModel.const_228:
                  if(this.var_20.otherUserItems.length > 0 || this.var_20.ownUserItems.length > 0)
                  {
                     _loc1_.enable();
                  }
                  else
               ...
               case TradingModel.TRADING_STATE_CANCELLED:
                  break;
               default:
                  throw new Error("Unknown trading progress state: \"" + this.var_20.state + "\"");
            }
         }
      }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_232 = new Timer(1000,3);
            this.var_232.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_232.reset();
         this.var_232.repeatCount = 3;
         this.var_232.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_232.currentCount));
         if(this.var_232.currentCount == 3)
         {
            this.var_20.confirmCountdownReady();
            this.var_232.reset();
         }
      }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         _loc5_ = this.var_20.ownUserItems;
         _loc6_ = false;
         _loc3_ = 0;
         ...
         if(_loc6_)
         {
            this.updateItemList(this.var_20.ownUserId);
         }
         _loc5_ = this.var_20.otherUserItems;
         _loc6_ = false;
         _loc3_ = 0;
         while(_loc3_ < _loc5_.length)
         {
         ...
         if(_loc6_)
         {
            this.updateItemList(this.var_20.otherUserId);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_20 == null || this.var_20.ownUserItems == null)
         {
            return;
         }
         if(param1 < this.var_20.ownUserItems.length)
         {
            _loc2_ = this.var_20.ownUserItems.getWithIndex(param1) as GroupItem;
            this.setSelection(_loc2_);
            if(_loc2_)
            {
               this.var_20.getFurniInventoryModel().displayItemInfo(_loc2_);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_20 == null || this.var_20.otherUserItems == null)
         {
            return;
         }
         if(param1 < this.var_20.otherUserItems.length)
         {
            _loc2_ = this.var_20.otherUserItems.getWithIndex(param1) as GroupItem;
            this.setSelection(_loc2_);
            if(_loc2_)
            {
               this.var_20.getFurniInventoryModel().displayItemInfo(_loc2_);
      ...
      public function removeSelection() : void
      {
         if(this.var_1115)
         {
            this.var_1115.isSelected = false;
            this.var_1115 = null;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_continue":
                  this.var_20.requestFurniViewOpen();
                  break;
               case "button_cancel":
                  this.var_20.requestCancelTrading();
            }
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  ...
                  {
                     case TradingModel.const_208:
                        if(this.var_20.otherUserItems.length == 0 && !this.var_20.ownUserAccepts)
                        {
                           this.alertPopup(const_1257);
                        }
                        if(this.var_20.ownUserAccepts)
                        {
                           this.var_20.requestUnacceptTrading();
                        }
                        else
                        {
                           this.var_20.requestAcceptTrading();
                        }
                        break;
                     case TradingModel.const_333:
                        param2.disable();
                        this.var_20.requestConfirmAcceptTrading();
                  }
                  break;
               case "button_cancel":
                  switch(this.var_20.state)
                  {
                     case TradingModel.const_208:
                        ...
                        break;
                     case TradingModel.const_333:
                        this.var_20.requestConfirmDeclineTrading();
                  }
            }
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         {
            this.var_20.requestRemoveItemFromTrading(param2.id);
         }
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param3)
            {
               _loc4_ = this.var_20.ownUserItems.getWithIndex(param2.id);
            }
            else
            {
               _loc4_ = this.var_20.otherUserItems.getWithIndex(param2.id);
            }
            if(_loc4_ == null)
            {
               return;
            ...
            _loc6_ = this.var_20.getItemImage(_loc5_);
            ...
            if(_loc5_.category == FurniCategory.const_229)
            {
               _loc7_ = "${poster_" + _loc5_.stuffData + "_name}";
            }
            if(_loc5_.category == FurniCategory.const_1797)
            {
            ...
            if(_loc5_.category == FurniCategory.const_1271)
            {
               _loc7_ = this.getTraxSongFurniName(_loc4_,_loc7_,true,param2.id,param3);
            }
            this.var_722.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_564);
            this.var_722.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_722.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         {
            if(this.var_208.length > 0)
            {
               this.var_208.pop();
               this.var_208.pop();
               this.var_208.pop();
            }
            this.var_208.push(param4);
            this.var_208.push(param1);
            this.var_208.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_208.length > 0)
         {
            _loc2_ = this.var_208.pop();
            _loc3_ = this.var_208.pop();
            _loc4_ = uint(this.var_208.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  _loc6_ = this.getTraxSongFurniName(_loc3_,"",false);
                  _loc7_ = this.var_20.getItemImage(_loc5_);
                  _loc8_ = !!_loc2_ ? this.getOwnUsersItemGrid().getGridItemAt(_loc4_) : this.getOtherUsersItemGrid().getGridItemAt(_loc4_);
                  this.var_722.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_564);
               }
            }
            else
            {
               this.var_208.push(_loc4_);
               this.var_208.push(_loc3_);
               this.var_208.push(_loc2_);
            }
         }
      }
   }
