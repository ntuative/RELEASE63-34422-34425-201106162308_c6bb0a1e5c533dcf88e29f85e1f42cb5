package com.sulake.habbo.communication.messages.outgoing.handshake
{
   ...
   class RSAKey
   {
      ...
      public var var_2179:BigInteger;
      
      public var var_2173:BigInteger;
      
      protected var var_3053:Boolean;
      
      protected var var_3001:Boolean;
      ...
      function RSAKey(param1:BigInteger, param2:int, param3:BigInteger = null, param4:BigInteger = null, param5:BigInteger = null, param6:BigInteger = null, param7:BigInteger = null, param8:BigInteger = null)
      {
         ...
         this.var_3001 = this.n != null && this.e != 0;
         this.var_3053 = this.var_3001 && this.d != null;
      }
      
      static function parsePublicKey(param1:String, param2:String) : RSAKey
      {
      ...
      function encrypt(param1:ByteArray, param2:ByteArray, param3:uint, param4:Function = null) : void
      {
         this._encrypt(this.doPublic,param1,param2,param3,param4,2);
      }
      
      function decrypt(param1:ByteArray, param2:ByteArray, param3:uint, param4:Function = null) : void
      {
      ...
      private function doPrivate2(param1:BigInteger) : BigInteger
      {
         ...
         var _loc3_:BigInteger = param1.mod(this.q).modPow(this.var_2179,this.q);
         while(_loc2_.compareTo(_loc3_) < 0)
         {
            _loc2_ = _loc2_.add(this.p);
         }
         return _loc2_.subtract(_loc3_).multiply(this.var_2173).mod(this.p).multiply(this.q).add(_loc3_);
      }
