package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1065:IDesktopWindow;
      ...
      private var var_804:IAssetLibrary;
      
      private var var_1249:uint = 0;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_804 = param2;
         this._events = param3;
         this.var_1065 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_804.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_804.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         if(param1.type == AssetLoaderEvent.const_42)
         {
            ...
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_79));
            }
         }
         else if(param1.type == AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_500));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this.var_1250 != null)
            {
               this.var_1250(_loc4_);
               this.var_1250 = null;
            }
         }
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_804.loadAssetFromFile("hotel_view_banner_" + this.var_1249,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_982));
            }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1065.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1065.removeChild(this._window);
         }
      }
   }
}
