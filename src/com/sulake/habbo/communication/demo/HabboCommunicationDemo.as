package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_527:IKeyExchange;
      
      private var var_960:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2430:PseudoRandom;
      ...
      private var var_240:HabboHotelView;
      
      private var var_1457:String = "";
      
      private const const_2049:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_623 = param1;
            this.var_62.initConnection(HabboConnectionType.const_262);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_82,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_62 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_62.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_62.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_62.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_62.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_62.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_62.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_62.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_62.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_62.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_62.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_62.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_62.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_62.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_62 && this.var_149 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_149.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_240 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_149.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_149.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_240.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_149.getKey("use.sso.ticket") == "1";
         this.var_623 = this.var_149.getKey("sso.ticket",null);
         this.var_1780 = this.var_149.getKey("flash.client.url","");
         this.var_2431 = this.var_149.getKey("external.variables.txt","");
         if(this.var_240 == null)
         {
            this.var_240 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_62.mode = HabboConnectionType.const_95;
            if(this.var_623)
            {
               this.var_62.initConnection(HabboConnectionType.const_262);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_603,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1921);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_62.mode = HabboConnectionType.const_95;
            if(this.var_149.keyExists("local.environment"))
            {
               this.var_62.mode = HabboConnectionType.const_1177;
            }
         }
         this.var_62.initConnection(HabboConnectionType.const_262);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_62.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_839);
            _loc3_ = new InitCryptoMessageComposer(this.var_62.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2430 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_62.mode)
         {
            case HabboConnectionType.const_95:
               _loc6_ = "";
               _loc6_ = this.var_149.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_149.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1457 = _loc4_;
               this.var_240.loadBannerImage(_loc7_ + "?token=" + this.var_1457,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1177:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1982:
               this.var_960 = this.generateRandomHexString(30);
               this.var_527 = new DiffieHellman(new BigInteger(this.var_149.getKey("connection.development.prime"),16),new BigInteger(this.var_149.getKey("connection.development.generator"),16));
               this.var_527.init(this.var_960);
               _loc8_ = this.var_527.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_62.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_527.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_527.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2430);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1458 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_242);
         connection.send(new VersionCheckMessageComposer(401,this.var_1780,this.var_2431));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2049,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_623 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_623);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_230);
         }
      ...
      {
         var _loc4_:IConnection = this.var_62.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_275);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1458)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_224);
         }
         if(param1.type == Event.CLOSE && !this.var_2429)
         {
            _loc2_ = this.var_149.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2429 = true;
         var _loc2_:String = this.var_149.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_149.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      {
         if(!this.var_16.sessionStarting)
         {
            this.showHotelView();
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1457);
         ...
         var _loc9_:IConnection = this.var_62.getHabboMainConnection(null);
         ...
         this.var_527 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_527.init(_loc14_);
            _loc15_ = this.var_527.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_960 = _loc14_;
            }
