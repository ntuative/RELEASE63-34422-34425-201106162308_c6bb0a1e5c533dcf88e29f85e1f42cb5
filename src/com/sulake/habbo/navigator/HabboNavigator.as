package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_314:MainViewCtrl;
      
      private var var_624:RoomInfoViewCtrl;
      
      private var var_1190:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_447:Tabs;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_314 = new MainViewCtrl(this);
         this.var_624 = new RoomInfoViewCtrl(this);
         this.var_1190 = new RoomCreateViewCtrl(this);
         this.var_2432 = new RoomThumbnailRenderer(this);
         this.var_935 = new GuestRoomPasswordInput(this);
         this.var_331 = new GuestRoomDoorbell(this);
         this.var_447 = new Tabs(this);
         this.var_1191 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_369,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_314.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_179.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_314.startSearch(Tabs.const_217,Tabs.const_392,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_314.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_314.startSearch(Tabs.const_261,Tabs.const_264);
         this.var_447.getTab(Tabs.const_261).tabPageDecorator.tabSelected();
      }
