package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_573:RoomPopupCtrl;
      
      private var var_600:IScrollbarWindow;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_573 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_600 = IScrollbarWindow(this.var_201.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_600.scrollV = 0;
         }
         this.var_201.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getVisibleEntryCount() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_67.numListItems)
         {
            if(this.var_67.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_191,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_43,true);
         _loc2_.setParamFlag(HabboWindowParam.const_1846,true);
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_67.getListItemAt(param2));
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_218,null,0);
         this._navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_138,null,0);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_573.visible && this.var_2857)
         {
            return;
         }
         ...
         this.var_573.room = _loc4_;
         this.var_573.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1621.tags[0];
            this.var_1621.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2856 - _loc2_.stageX);
         this.var_2856 = _loc2_.stageX;
         this.var_2857 = _loc3_ > 2;
      }
   }
}
