package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_2263:int = 3;
      ...
      private static const const_1542:int = 4;
      ...
      private var var_998:PopularTagsListCtrl;
      
      private var var_999:GuestRoomListCtrl;
      
      private var var_1254:OfficialRoomListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_998 = new PopularTagsListCtrl(this._navigator);
         this.var_999 = new GuestRoomListCtrl(this._navigator);
         this.var_1254 = new OfficialRoomListCtrl(this._navigator);
      ...
      public function onNavigatorToolBarIconClick() : Boolean
      {
         ...
         {
            this.var_811 = new WindowToggle(this.var_17,this.var_17.desktop,this.reloadData,this.close);
         }
      ...
      private function prepare() : void
      {
         ...
         this.var_279 = ITabContextWindow(this.var_17.findChildByName("tab_context"));
         ...
         this.var_280 = IWindowContainer(this.var_17.findChildByName("custom_footer"));
         this.var_1525 = this.var_17.findChildByName("loading_text");
         ...
         this.var_812 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         ...
         {
            _loc3_ = this.var_279.getTabItemByID(_loc2_.id);
            if(_loc3_ != null)
            {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1936,true);
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_201,["custom_content","list_content"],this.var_246.y,8);
         this.var_216.height = this.var_216.height + _loc1_ - this.var_216.y - this.var_280.height + this.var_2587;
         Util.moveChildrenToColumn(this.var_201,["list_content","custom_footer"],this.var_216.y,0);
         this.var_2587 = this.var_280.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_279.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1901 = true;
            this.var_279.selector.setSelected(_loc1_.button);
         }
      }
      ...
      {
         this.refreshList(param1,param2,this.var_999,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_998,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1254,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_647 == const_1093)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_216.blend - _loc2_));
            this.var_216.blend = _loc3_;
            this.var_246.blend = !!this.var_1255 ? Number(_loc3_) : Number(1);
            this.var_280.blend = !!this.var_1255 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_647 = const_692;
            }
         }
         else if(this.var_647 == const_692)
         {
            if(this.var_1526 % 10 == 1)
            {
               this.var_1525.visible = !this.var_1525.visible;
            }
            ++this.var_1526;
            if(!this._navigator.data.isLoading())
            {
               this.var_647 = const_1094;
            }
         }
         else if(this.var_647 == const_1094)
         {
            this.refresh();
            this.var_647 = const_1542;
         }
         else
         {
            this.var_1525.visible = false;
            _loc3_ = Math.min(1,Math.max(0,this.var_216.blend + _loc2_));
            this.var_216.blend = _loc3_;
            this.var_246.blend = !!this.var_1255 ? Number(_loc3_) : Number(1);
            this.var_280.blend = !!this.var_1255 ? Number(_loc3_) : Number(1);
      ...
      {
         this.refreshScrollbar(this.var_998);
         this.refreshScrollbar(this.var_999);
      }
