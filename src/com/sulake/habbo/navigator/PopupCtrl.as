package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_463 = new Timer(500,1);
         this.var_380 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1126 = param4;
         this.var_2658 = param2;
         this._popupIndentLeft = param3;
         this.var_463.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_463)
         {
            this.var_463.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_463.reset();
            this.var_463 = null;
         }
         if(this.var_380)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_61 == null)
         {
            this.var_61 = IWindowContainer(this._navigator.getXmlWindow(this.var_1126));
            this.var_61.visible = false;
            this.var_61.setParamFlag(HabboWindowParam.const_43,true);
         ...
         this.var_61.x = _loc2_.x + this.var_2658 + param1.width;
