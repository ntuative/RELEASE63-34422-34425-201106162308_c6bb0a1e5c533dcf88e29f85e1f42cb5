package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_746:TextFieldManager;
      
      private var var_1149:TextFieldManager;
      ...
      private var var_1154:TextFieldManager;
      
      private var var_1146:ICheckBoxWindow;
      
      private var var_1147:ICheckBoxWindow;
      
      private var var_1152:ICheckBoxWindow;
      
      private var var_748:ICheckBoxWindow;
      ...
      {
         this.var_358 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_358));
         if(this.var_1153 != null)
         {
            this.var_1153.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_358)
         {
            return;
         }
         this.var_56 = param1;
      ...
      {
         if(param1 != this.var_358 || this.var_1151 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1151 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1774)
         {
            this.var_746.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1907)
         {
            this.var_746.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1902)
         {
            this.var_1149.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1713)
         {
            this.setTagError(this.var_932,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_934,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1925)
         {
            this.setTagError(this.var_932,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_934,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1806)
         {
            this.var_935.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_746.displayError("Update failed: error " + param2);
         }
      }
      ...
      {
         this.var_746.clearErrors();
         this.var_1149.clearErrors();
         this.var_932.clearErrors();
         this.var_934.clearErrors();
         this.var_935.clearErrors();
         this.var_1154.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_337,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_528,this.onDoorModePasswordUnselect);
         ...
         this.var_746 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1149 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_932 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_934 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_935 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1154 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1146 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1147 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1152 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_748 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1708 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_933 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_931 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2268 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1150 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1148 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1709 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         ...
         this.var_1153 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1420 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1420.mouseThreshold = 0;
         this.var_1420.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1153.visible = false;
         if(!this.var_1419)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1709.visible = this.var_1419;
         this.populateForm();
         if(this.var_747)
         {
            ...
            this.var_1148.height = Util.getLowestPoint(this.var_1148) + 4;
         }
         else
         {
            this.var_1150.visible = true;
            this.var_1418.visible = true;
            this.var_2268.visible = this.var_1419;
            this.var_1150.height = Util.getLowestPoint(this.var_1150) + 4;
         }
         this.var_1420.text = !!this.var_747 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1150.name,this.var_1148.name,this.var_1418.name,this.var_1709.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_746.setText(_loc1_.name);
         this.var_1149.setText(_loc1_.description);
         this.var_935.setText("");
         this.var_1154.setText("");
         ...
         this.setTag(this.var_932,_loc1_.tags[0]);
         this.setTag(this.var_934,_loc1_.tags[1]);
         if(this.var_1146)
         {
            if(_loc1_.allowPets)
            {
               this.var_1146.select();
            }
            else
            {
               this.var_1146.unselect();
            }
         }
         if(this.var_1147)
         {
            ...
            {
               this.var_1147.select();
            }
            else
            {
               this.var_1147.unselect();
            }
         }
         if(this.var_1152)
         {
            ...
            {
               this.var_1152.select();
            }
            else
            {
               this.var_1152.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_748);
            this.disableWindow(this.var_933);
            this.disableWindow(this.var_931);
            this.disableWindow(this.var_1708);
         }
         else
         {
            this.enableWindow(this.var_748);
            this.enableWindow(this.var_933);
            this.enableWindow(this.var_931);
            this.enableWindow(this.var_1708);
         }
         if(this.var_748)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_748.unselect();
            }
         }
         if(this.var_933)
         {
            this.var_933.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_931)
         {
            this.var_931.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_746.getText();
         _loc2_.description = this.var_1149.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_589;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_138)
         {
            _loc8_ = this.var_935.getText();
            _loc9_ = this.var_1154.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_935.clearErrors();
               this.var_1154.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1146.isSelected;
         _loc2_.allowFoodConsume = this.var_1147.isSelected;
         _loc2_.allowWalkThrough = this.var_1152.isSelected;
         _loc2_.hideWalls = this.var_748.isSelected;
         _loc2_.wallThickness = this.var_933.selection - 2;
         _loc2_.floorThickness = this.var_931.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_932,_loc2_.tags);
         this.addTag(this.var_934,_loc2_.tags);
         this.clearErrors();
         this.var_1151 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_358);
         if(this.var_56 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_56.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_358]);
         _loc2_.show();
      }
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = null;
         if(this.var_237 == null || this.var_237.disposed)
         {
            return;
         }
         Util.hideChildren(this.var_237);
         var _loc1_:IWindow = this.var_237.findChildByName("ruler");
         if(_loc1_ != null)
         {
            _loc1_.visible = true;
         }
         var _loc2_:IWindow = this.var_237.findChildByName("flat_ctrls_caption_txt");
         if(_loc2_ != null)
         {
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_56.controllerCount);
            _loc2_.visible = true;
         }
         var _loc3_:IWindowContainer = IWindowContainer(this.var_237.findChildByName("flat_controller_list"));
         if(_loc3_ != null)
         {
            ...
            _loc5_ = this.var_237.findChildByName("flat_ctrls_info_txt");
            _loc6_ = this.var_237.findChildByName("flat_ctrls_limit_txt");
            _loc7_ = IWindowContainer(this.var_237.findChildByName("flat_controllers_footer"));
            if(this.var_56 != null && this.var_56.controllers.length > 0)
            {
               ...
               Util.moveChildrenToColumn(this.var_237,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc2_.y,5);
            }
            else
            {
         ...
         var _loc4_:IButtonWindow = IButtonWindow(this.var_237.findChildByName("remove_flat_ctrl"));
         if(_loc4_ != null)
         {
            if(_loc8_)
            {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_71,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_358));
      }
