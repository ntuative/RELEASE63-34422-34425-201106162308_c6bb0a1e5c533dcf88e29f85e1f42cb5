package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_952:Array = [];
      
      private static var var_1758:int = 200;
      ...
      {
         this.var_761 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
         ...
         this.var_67 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1890;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_952.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_761.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_952.length < var_1758)
         {
            ...
            param1.width = this.var_761.width;
            param1.height = this.var_761.height;
            var_952.push(param1);
         }
         else
         {
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_67.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_67.scrollableRegion.height > this.var_67.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_67.width += 17;
            }
         }
         else if(_loc4_)
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1447)
         {
