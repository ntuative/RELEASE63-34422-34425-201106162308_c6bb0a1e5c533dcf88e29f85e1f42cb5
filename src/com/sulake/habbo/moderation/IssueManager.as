package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1172:String = "issue_bundle_open";
      
      public static const const_910:String = "issue_bundle_my";
      
      public static const const_1247:String = "issue_bundle_picked";
      
      public static const const_1809:int = 15000;
       
      
      private var var_75:ModerationManager;
      
      private var var_693:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_693 = new IssueBrowser(this,this.var_75.windowManager,this.var_75.assets);
         this.var_1319 = [];
         this.var_1318 = [];
         this.var_1072 = new Map();
         this.var_2839 = parseInt(this.var_75.configuration.getKey("chf.score.updatefactor","60"));
         this.var_2062 = new Timer(const_1809,0);
         this.var_2062.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_2062.start();
      }
      ...
      {
         var _loc4_:IssueBundle = this.var_120.getValue(param1) as IssueBundle;
         if(_loc4_ == null)
         {
            return;
         }
         this.sendPick(_loc4_.getIssueIds(),param2,param3);
         this.var_1319 = this.var_1319.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = this.var_120.getValues();
         for each(_loc5_ in _loc3_)
         {
            if(_loc5_.state == IssueMessageData.const_196 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function releaseAll() : void
      {
         ...
         var _loc2_:* = [];
         for each(_loc3_ in this.var_120)
         {
            if(_loc3_.state == IssueMessageData.const_388 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      public function releaseBundle(param1:int) : void
      {
         ...
         var _loc2_:IssueBundle = this.var_120.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1318 = this.var_1318.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_693 == null || !this.var_693.isOpen())
         {
            this.var_75.soundManager.playSound(HabboSoundTypesEnum.const_1363);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_1073.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_120.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     this.var_120.remove(_loc3_.id);
                     this.removeHandler(_loc3_.id);
                  }
                  this.var_1073.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1770)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_120)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_1073.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2840++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_1073.add(param1.issueId,_loc2_);
            this.var_120.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(this.var_1319.indexOf(param1.issueId) != -1)
         {
            this.handleBundle(_loc3_.id);
            _loc5_ = this.var_75.sessionDataManager.userId;
            if(_loc5_ != param1.pickerUserId)
            {
               if(param1.state == IssueMessageData.const_388)
               {
                  this.unhandleBundle(_loc3_.id);
               }
            }
         }
         if(param1.state == IssueMessageData.const_196)
         {
            _loc6_ = this.getBundles(const_910);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1318.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2839);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_1072.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_1072.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_1073.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_120.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_120)
         {
            ...
            {
               case const_1172:
                  if(_loc4_.state == IssueMessageData.const_196)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
               case const_910:
                  if(_loc4_.state == IssueMessageData.const_388 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_1072.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_1072.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      {
         var _loc3_:IssueBundle = this.var_120.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = this.var_120.getValues();
         var _loc4_:int = this.var_75.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_388 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            _loc8_ = null;
            for each(_loc9_ in this.var_120)
            {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_1072.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
