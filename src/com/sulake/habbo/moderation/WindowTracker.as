package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1772:int = 2;
      
      public static const const_1245:int = 3;
      
      public static const const_728:int = 4;
      
      public static const const_1327:int = 5;
      
      public static const const_1890:int = 6;
      
      public static const const_1836:int = 7;
      ...
      private var var_1749:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1749 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1749[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1749[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
