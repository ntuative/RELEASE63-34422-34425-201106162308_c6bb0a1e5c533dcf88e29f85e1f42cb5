package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_862:IssueMessageData = null;
      
      private var var_863:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2356 = param2.pickerUserId;
         this.var_2852 = param2.pickerUserName;
         this.var_1611 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1327 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1328;
         }
         if(this.var_862 == null || param1.timeStamp < this.var_862.timeStamp)
         {
            this.var_862 = param1;
         }
         if(this.var_863 == null || param1.priority > this.var_863.timeStamp)
         {
            this.var_863 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_863;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_862;
         if(_loc2_ == null)
         {
