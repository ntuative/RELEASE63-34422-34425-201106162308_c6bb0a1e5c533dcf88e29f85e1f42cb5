package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1080:Array = [];
      
      private static var var_2077:int = 1000;
      
      private static var var_1081:Array = [];
      
      private static var var_2079:int = 200;
      ...
      private var var_2078:IMessageComposer;
      ...
      {
         this.var_865 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_864 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         this.var_520 = new Timer(1000,1);
         ...
         this.var_36.connection.send(this.var_2078);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1080.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_864.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1080.length < var_2077)
         {
            ...
            param1.width = this.var_864.width;
            param1.height = this.var_864.height;
            var_1080.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1081.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2080[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1619.getValue(param2.chatterName))
            {
               this.var_1619.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1619.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1618)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1620)
         {
