package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1325:IRoomWidgetFactory;
      ...
      private var var_1575:IHabboAvatarEditor = null;
      ...
      private var var_1076:IHabboModeration;
      ...
      private var var_1326:IHabboUserDefinedRoomEvents;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1076.release(new IIDHabboModeration());
            this.var_1076 = null;
         }
         ...
         if(this.var_1326)
         {
            this.var_1326.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1326 = null;
         }
         this.var_1575 = null;
         ...
         if(this.var_336)
         {
            while(this.var_336.length > 0)
            {
               _loc1_ = this.var_336.getKey(0) as String;
               _loc2_ = this.var_336.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1575 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_335.events.addEventListener(InterstitialEvent.const_502,this.interstitialCompleteEventHandler);
            this.var_335.events.addEventListener(InterstitialEvent.const_627,this.adEventHandler);
            this.var_335.events.addEventListener(AdEvent.const_572,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1076 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1076);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            ...
            this.var_16.events.addEventListener(RoomSessionEvent.const_75,this.roomSessionStateEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_558,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserBadgesEvent.const_141,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_129,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_167,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_60,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPresentEvent.const_364,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_533,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_669,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_667,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_653,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_274,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_295,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_983,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1326,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1315,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_296,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_305,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_772,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1016,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_231,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_915,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_924,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionQueueEvent.const_556,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_172,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_79,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_170,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_522,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionUserDataUpdateEvent.const_135,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDanceEvent.const_155,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_75:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_821);
               break;
            case RoomSessionEvent.const_82:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_844);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_295:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_983:
            ...
            case RoomSessionErrorMessageEvent.const_289:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_305:
            ...
            case RoomSessionErrorMessageEvent.const_772:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_1016:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_915:
               errorMessage = "${room.error.pets.no_free_tiles}";
               break;
            case RoomSessionErrorMessageEvent.const_924:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this.var_2847,this.var_2846);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1326 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_797,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_182,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_347,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_540,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_498,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_620,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_959,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_507,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_293,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_797)
         {
            if(this.var_16 != null)
            {
               this.var_16.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_498 || param1.type == RoomEngineEvent.const_540)
         {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_182:
               ...
               if(this._roomEngine != null)
               {
                  ...
                  if(this._roomEngine.method_3(this._roomEngine.getWorldType(param1.roomId,param1.roomCategory)))
                  {
                     _loc5_ = true;
                  }
               }
               _loc3_.disposeWidget(RoomWidgetEnum.const_596);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_869);
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_429);
               }
               if(!_loc5_)
               {
                  _loc3_.createWidget(RoomWidgetEnum.const_543);
               }
               _loc3_.createWidget(RoomWidgetEnum.const_350);
               if(this.var_2070 != RoomDesktop.const_722)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_350,this.var_2070);
               }
               if(this.var_335 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_347:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         {
            this.var_1616 = true;
            this.var_2847 = param1.roomId;
            this.var_2846 = param1.roomCategory;
         }
         else
         {
            this.var_1616 = false;
         }
         this.var_336.add(_loc2_,_loc3_);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_336.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_350);
            if(_loc3_ != RoomDesktop.const_722)
            {
               this.var_2070 = _loc3_;
            }
            _loc2_.dispose();
            this.var_1616 = false;
         }
      ...
      {
         return this.var_336.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_336.length)
         {
            _loc3_ = this.var_336.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
