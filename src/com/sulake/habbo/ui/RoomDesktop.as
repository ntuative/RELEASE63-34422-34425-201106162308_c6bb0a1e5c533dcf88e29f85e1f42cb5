package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      public static const const_722:int = -1;
      
      private static const const_1706:int = 1000;
      ...
      private var var_1325:IRoomWidgetFactory = null;
      
      private var var_394:ISessionDataManager = null;
      
      private var var_16:IRoomSessionManager = null;
      
      private var var_1021:IAvatarRenderManager = null;
      ...
      private var var_2149:Boolean = true;
      
      private var var_902:Array;
      
      private var var_259:IToolTipWindow;
      
      private var var_2967:uint = 16777215;
      ...
      private var var_2150:Rectangle;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_39 = new Map();
         this.var_903 = new Map();
         this.var_901 = new Map();
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_215,this.processEvent);
         }
      }
      ...
      public function set navigator(param1:IHabboNavigator) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_370,this.onNavigatorEvent);
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_626,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_1015,this.onRoomContentLoaded);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_342.length)
            {
               _loc3_ = this.var_342[_loc1_];
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_215,this.processEvent);
         }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_626,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_1015,this.onRoomContentLoaded);
         }
         ...
         {
            this._navigator.events.removeEventListener(HabboNavigatorEvent.const_370,this.onNavigatorEvent);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_34 != null)
         {
            this.var_902 = this._roomEngine.loadRoomResources(this.var_34.roomResources);
            if(this.var_902.length > 0)
            {
               this.var_2149 = false;
               this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_118));
            }
         }
      }
      ...
      {
         if(this.var_335 != null && this.var_34.state == RoomSessionEvent.SESSION_CREATED)
         {
            this.var_2151 = !this.var_335.showInterstitial();
         }
      ...
      {
         if(this.var_902 == null || this.var_902.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_902.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_902.splice(_loc2_,1);
         }
         if(this.var_902.length == 0)
         {
            this.var_2149 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_903.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_903.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_901.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_901.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         }
         _loc2_ = this.var_1325.createWidget(param1,_loc4_);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_903.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_901.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1189) == 1)
               {
                  _loc2_ = true;
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_732:
               ...
               if(this.var_1076 != null && _loc3_ == RoomObjectCategoryEnum.const_29)
               {
                  _loc7_ = this.var_34.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_130)
                  {
                     this.var_1076.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_620:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_154,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.const_178:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_403,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_959:
               if(!this.var_34.isRoomController && !this.var_394.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_160:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1187,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_498:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_440,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc5_:int = 0;
         if(this.var_342.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_962);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_1009);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_818);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_774);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_149,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2967);
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_149:
               _loc3_ = "null";
               break;
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            this._roomEngine.handleRoomCanvasMouseEvent(this.var_342[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_259 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_259.width / 2,15);
            this.var_259.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_2150 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_34.roomId,this.var_34.roomCategory,this.var_342[0],_loc2_.width,_loc2_.height);
         if(this.var_520 == null)
         {
            this.var_520 = new Timer(const_1706,1);
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_2150));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_2152) / 1000);
            if(this._habboTracking != null)
            {
               if(param1)
               {
                  this._habboTracking.trackGoogle("zoomEnded","RoomWidgetGetUserLocationMessage",_loc3_);
               }
               else
               {
      ...
      {
         var _loc2_:* = null;
         if(param1.type == HabboNavigatorEvent.const_370)
         {
            if(this.var_34 != null)
            {
               _loc2_ = this._roomEngine.getRoomCanvasGeometry(this.var_34.roomId,this.var_34.roomCategory,this.getFirstCanvasId());
      ...
      public function update() : void
      {
         ...
         var _loc1_:int = this.var_420.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_420.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      {
         if(this.var_16 != null && this.var_34 != null && this.var_2151 && this.var_2149)
         {
            this.var_16.startSession(this.var_34);
            this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_365));
            return true;
         }
         return false;
      }
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_417);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_545:
               ...
               this.var_259 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_405,WindowStyle.const_102,WindowParam.const_104) as IToolTipWindow;
               this.var_259.setParamFlag(WindowParam.const_31,false);
      ...
      public function removeUpdateListener(param1:IRoomWidgetHandler) : void
      {
         ...
         var _loc2_:int = this.var_420.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_420.splice(_loc2_,1);
         }
      }
   }
}
