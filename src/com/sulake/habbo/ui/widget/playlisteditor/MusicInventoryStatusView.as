package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_835:String = "MISV_BUY_MORE";
      
      public static const const_996:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_52:String;
      
      private var var_1890:ITextWindow;
      
      private var var_1889:ITextWindow;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_488.getValues())
         {
            _loc1_.destroy();
         }
         this.var_488 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_488[param1] as IWindowContainer,0);
         this.var_52 = param1;
      }
      
      public function set songName(param1:String) : void
      {
         if(this.var_1890 == null)
         {
            return;
         }
         this.var_1890.text = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1889.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_996,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_835,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_488.add(const_996,_loc1_);
            this.var_1890 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1889 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_484));
         ...
         if(_loc1_ != null)
         {
            this.var_488.add(const_835,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_644));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_488[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
