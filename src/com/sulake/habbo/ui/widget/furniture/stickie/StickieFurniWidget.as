package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1493:int = 14;
      
      private static const const_1495:int = 500;
      
      private static const const_1494:Number = 100;
      
      private static const const_1496:Number = 100;
       
      
      private var _window:IWindowContainer;
      
      protected var var_233:int = -1;
      
      protected var var_1391:String;
      
      protected var _text:String;
      
      protected var var_352:String;
      
      protected var var_27:Boolean;
      
      protected var var_2212:String = "stickieui_container";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_952,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_952,this.onObjectUpdate);
      }
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1391 = param1.objectType;
         this._text = param1.text;
         this.var_352 = param1.colorHex;
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2212,"",HabboWindowType.const_71,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1494,const_1496,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null)
         {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_352);
            }
         ...
         this.setColorButtons(this.var_27 && this.var_1391 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_518,this.var_233,this._text,this.var_352);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_518,this.var_233,this._text,this.var_352);
      ...
      protected function sendDelete() : void
      {
         ...
         if(messageListener != null && this.var_27)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_903,this.var_233);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1495;
         if(_loc2_.numLines < const_1493)
         {
            return;
         }
