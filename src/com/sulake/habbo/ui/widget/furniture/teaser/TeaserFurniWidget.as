package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2074:int = 0;
      
      private const const_2070:int = 1;
      
      private const const_2075:int = 2;
      
      private const const_2069:int = 3;
      
      private const const_2071:int = 4;
      
      private const const_2340:int = 0;
      
      private const const_2338:int = 1;
      
      private const const_2341:int = 2;
      
      private const const_2339:int = 3;
      
      private const const_2336:int = 4;
      
      private const const_2343:int = 5;
      
      private const const_2073:String = "deco_img";
      
      private const const_2072:String = "dialog_bg";
      
      private const const_2337:String = "%campaign%_dialog_bg.png";
      
      private const const_385:String = "%campaign%_gift_package.png";
      
      private const const_2344:String = "%campaign%_gift_content.png";
      
      private const const_2342:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1647 = this.var_149.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1647 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1650.length)
         {
            _loc2_ = this.var_1650.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_149 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_577,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_783,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_792,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_577,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_577:
               _loc2_ = this.const_2074;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_792:
               ...
               if(_loc5_)
               {
                  if(_loc4_ && _loc4_ != "")
                  {
                     _loc2_ = this.const_2069;
                     var_70.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc4_);
                  }
                  else
                  {
               ...
               {
                  _loc2_ = this.const_2071;
               }
               this._shareId = null;
               this.var_1648 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_783:
               _loc2_ = this.const_2070;
               this.var_233 = param1.objectId;
               this._shareId = param1.data;
               this.var_422 = param1.status;
               this.var_1648 = param1.itemCategory;
               var_70.registerParameter("notifications.viral_furni.fb.title","realname",param1.ownRealName);
               var_70.registerParameter("notifications.viral_furni.fb.desc","realname",param1.ownRealName);
               var_70.registerParameter("widget.furni.teaser.gift.unlocked.desc","username",param1.firstClickUserName);
               break;
            default:
               Logger.log("Error, invalid viral widget update message: " + param1.type);
         }
         if(this._window && (this.var_1649 != _loc2_ || _loc3_ != this.var_206))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_206 = _loc3_;
         this.var_1649 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1649)
            {
               case this.const_2074:
                  ...
                  break;
               case this.const_2070:
                  if(this.var_422 == this.const_2340)
                  {
                  ...
                  else if(this.var_422 == this.const_2338)
                  {
                     ...
                     _loc2_ = this.const_2344;
                  }
                  else if(this.var_422 == this.const_2341)
                  {
                     ...
                     _loc3_ = var_70.getKey("widget.furni.teaser.gift.no_fb.title");
                     _loc4_ = var_70.getKey("widget.furni.teaser.gift.no_fb.desc");
                     _loc2_ = this.const_385;
                  }
                  else if(this.var_422 == this.const_2339)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_206,"client.show.not_enough_fb_friends");
                     _loc3_ = var_70.getKey("widget.furni.teaser.gift.no_spam.title");
                     _loc4_ = var_70.getKey("widget.furni.teaser.gift.no_spam.desc");
                     _loc2_ = this.const_385;
                  }
                  else if(this.var_422 == this.const_2336)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_206,"client.show.not_enough_fb_friends");
                     _loc3_ = var_70.getKey("widget.furni.teaser.gift.no_min_fb_friends.title");
                     _loc4_ = var_70.getKey("widget.furni.teaser.gift.no_min_fb_friends.desc");
                     _loc2_ = this.const_385;
                  }
                  else if(this.var_422 == this.const_2343)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_206,"client.show.campaign_closed");
                     _loc3_ = var_70.getKey("widget.furni.teaser.gift.campaign_closed.title","widget.furni.teaser.gift.campaign_closed.title");
                     _loc4_ = var_70.getKey("widget.furni.teaser.gift.campaign_closed.desc","widget.furni.teaser.gift.campaign_closed.desc");
                     _loc2_ = this.const_385;
                  }
                  break;
               case this.const_2075:
                  _loc1_ = assets.getAssetByName("notification_gift_received") as XmlAsset;
                  _loc2_ = this.const_2342;
                  break;
               case this.const_2069:
                  _loc1_ = assets.getAssetByName("notification_gift_unlocked_notify") as XmlAsset;
                  _loc2_ = this.const_385;
                  break;
               case this.const_2071:
                  _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  _loc3_ = var_70.getKey("widget.furni.teaser.gift.campaign_closed.title","widget.furni.teaser.gift.campaign_closed.title");
                  _loc4_ = var_70.getKey("widget.furni.teaser.gift.campaign_closed.desc","widget.furni.teaser.gift.campaign_closed.desc");
            }
            ...
            _loc5_ = this.const_2337.replace("%campaign%",this.var_206);
            this.setDecoImage(_loc5_,this.const_2072);
            _loc2_ = _loc2_.replace("%campaign%",this.var_206);
            this.setDecoImage(_loc2_,this.const_2073);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_971);
      ...
      {
         var _loc2_:String = var_70.getKey("notifications.viral_furni.fb.title");
         var _loc3_:String = var_70.getKey("notifications.viral_furni.fb.desc");
         this.sendConversionPoint("viral_" + this.var_206,"client.start_post",this._shareId);
         var _loc4_:String = this.var_149.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1648 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1648 == 1 ? "null" : InventoryCategory.const_137);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_973,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1650.push(new ImageDownloader(this,_assets,this.var_206,this.var_1647,param1,param2));
            return;
         }
         var _loc5_:BitmapData = (_loc4_.content as BitmapData).clone();
         switch(param2)
         {
            case this.const_2072:
            case this.const_2073:
