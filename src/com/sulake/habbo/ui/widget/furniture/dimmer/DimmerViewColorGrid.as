package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_569:IItemGridWindow;
      
      private var _view:DimmerView;
      
      private var var_2036:XML;
      
      private var var_680:BitmapData;
      
      private var var_1311:BitmapData;
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_569.numGridItems)
         {
            return;
         }
         this.select(this.var_569.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_569 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         this.var_569.destroyGridItems();
         this.var_234 = null;
         for each(_loc2_ in this.colors)
         {
            _loc3_ = param1.buildFromXML(this.var_2036) as IWindowContainer;
            ...
            _loc3_.width = this.var_680.width;
            _loc3_.height = this.var_680.height;
            this.var_569.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_680.width,this.var_680.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_680,this.var_680.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1311.width,this.var_1311.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_1061.width,this.var_1061.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_1061,this.var_1061.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_569.getGridItemIndex(param1.target as IWindow);
