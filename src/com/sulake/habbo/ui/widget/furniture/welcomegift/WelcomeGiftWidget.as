package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_680:String = "welcome_gift_email_unverified";
      
      private const const_1048:String = "welcome_gift_email_verified";
      
      private const const_1471:String = "welcome_gift_email_change";
      
      private const const_2309:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1186)
         {
            this.setViewState(this.const_1048);
         }
         else
         {
            this.setViewState(this.const_680);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_680:
               ...
               this._view.findChildByName("edit_text").visible = this.var_956;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_956);
               break;
            case this.const_1048:
            ...
            case this.const_1471:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_956);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1452;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1471);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_908,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1186 ? this.const_1048 : this.const_680);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1451 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1451));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_499,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_895,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_499,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_895,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_499:
               this.var_1452 = param1.email;
               this.var_1186 = param1.isVerified;
               this.var_956 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1452 = this.var_1451;
            this.setViewState(this.const_680);
         }
         else
         {
            if(param1.result == this.const_2309)
            {
               this.var_956 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1451);
