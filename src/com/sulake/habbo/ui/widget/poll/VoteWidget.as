package com.sulake.habbo.ui.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1515:int = 30000;
      ...
      public function VoteWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1515 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_168.reset();
            this.var_168.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_168 = null;
         }
         this._config = null;
         super.dispose();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_157,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_145,this.showVoteResult);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_157,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_145,this.showVoteResult);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(this.var_67.scrollableRegion.height - this.var_67.height,0);
         ...
         {
            this.var_168 = new Timer(1000);
            this.var_168.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
      ...
      private function createWindow() : Boolean
      {
         ...
         this.var_67 = this._window.findChildByName("choices") as IItemListWindow;
         if(this.var_67 == null)
         {
            return false;
         }
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_67.numListItems)
         {
            _loc2_ = this.var_67.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
            if(_loc4_ != this.var_1877)
            {
               _loc2_.blend = 0.5;
            }
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1515 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_1878;
         if(_loc2_ > this.var_1515)
         {
            this.vote();
            return;
         }
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(this.var_67.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_67.numListItems)
         {
            _loc4_ = this.var_67.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
