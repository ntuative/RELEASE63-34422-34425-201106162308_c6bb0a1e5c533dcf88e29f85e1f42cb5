package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_47 = _window.getListItemByName("info_border") as IBorderWindow;
         _buttons = _window.getListItemByName("button_list") as IItemListWindow;
         if(var_47 != null)
         {
            var_55 = var_47.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_47.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var_261 = var_47.findChildByTag("catalog");
         if(var_261 != null)
         {
            var_261.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
         var _loc7_:IBitmapWrapperWindow = var_47.findChildByName("icon_disc") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = var_47.findChildByName("icon_composer") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
      ...
      {
         var _loc2_:IWindowContainer = var_55.getListItemByName("trackname_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_55.getListItemByName("creatorname_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_415)
         {
            this.var_1733 = param1.songId;
         }
         if(param1.songId == this.var_1733)
         {
            this._songName = param1.songName;
            this.var_2617 = param1.songAuthor;
            this.updateNowPlaying(this.var_1733 >= 0);
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:ITextWindow = var_55.getListItemByName("now_playing_text") as ITextWindow;
         if(_loc2_ != null)
         {
            if(param1)
            {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2617;
         }
         else
         {
