package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2304:int = 5;
      
      private const const_2303:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_167:Function;
      
      private var _offsetX:int;
      
      private var var_1165:int;
      
      private var var_1166:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1165 = 0;
         this.var_1166 = param2.rectangle.clone();
         this.var_1166.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1166.width)
         {
            return false;
         }
         if(this.var_1165 + param1.height > this.var_1166.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1166.width)
         {
            this._offsetX = 0;
            this.var_1165 += param1.height + this.const_2303;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1165);
         this._offsetX += param1.width + this.const_2304;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1624 != null && this.var_1624.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_167);
