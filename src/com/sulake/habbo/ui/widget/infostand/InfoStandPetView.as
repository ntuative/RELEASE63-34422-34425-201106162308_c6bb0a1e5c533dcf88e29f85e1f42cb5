package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1430:int = 152;
      
      private static const const_1426:int = 16;
      
      private static const const_676:int = 4;
      
      private static const const_1439:uint = 14342874;
      
      private static const const_1429:uint = 3815994;
      
      private static const const_1434:uint = 2085362;
      
      private static const const_1427:uint = 39616;
      
      private static const const_1438:uint = 10513106;
      
      private static const const_1437:uint = 8734654;
      
      private static const const_1428:uint = 9094430;
      
      private static const const_1432:uint = 6200576;
      
      private static const const_1433:String = "happiness";
      
      private static const const_1436:String = "experience";
      
      private static const const_1435:String = "energy";
      
      private static const const_1431:int = 250;
      
      private static const const_1037:int = 25;
      ...
      private var var_107:IWindowContainer;
      
      private var var_55:IItemListWindow;
      
      private var var_212:PetCommandTool;
      ...
      private function updateWindow() : void
      {
         ...
         this.var_107.width = this.var_107.width;
         this.var_107.visible = this.var_107.width > 0;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1433,param1.nutrition,param1.nutritionMax,const_1427,const_1434);
         this.updateStateElement(const_1436,param1.experience,param1.experienceMax,const_1437,const_1438);
         this.updateStateElement(const_1435,param1.energy,param1.energyMax,const_1432,const_1428);
         ...
         this.updateWindow();
         this.var_570 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_212 && this.var_212.isVisible() && param1.isOwnPet)
         {
            this.var_212.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_212.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1430,const_1426,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1439);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1429);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_676,_loc7_.width - 2,_loc7_.height - 2 - const_676);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_676);
      ...
      private function openTrainView() : void
      {
         if(this.var_212 == null)
         {
            this.var_212 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_570) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_212.showWindow(true);
            this.var_212.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc4_:* = [];
         this.var_107.groupChildrenWithTag("CMD_BUTTON",_loc4_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_212 && this.var_212.getPetId() == this.var_570)
               {
                  this.var_212.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_432,this._widget.petData.ownerId);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:int = const_1431;
         this.var_107.width = _loc1_;
         var _loc2_:* = [];
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1037 + const_1036;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1036;
            }
         }
         this.var_107.height = _loc4_ + const_1037;
         this.updateWindow();
      }
   }
}
