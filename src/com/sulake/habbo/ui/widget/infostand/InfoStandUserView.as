package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_107:IWindowContainer;
      
      private var var_47:IBorderWindow;
      
      private var var_939:TagListRenderer;
      
      private var var_151:IBorderWindow;
      
      private var var_2506:int;
      
      private var var_2507:Boolean = true;
      
      private const const_1064:int = 5;
      
      private const const_2314:int = 3;
      
      private const const_1505:int = 11184810;
      
      private const const_1506:int = 16777215;
      
      private const const_2311:int = 2000;
      
      private const const_2312:int = 50;
      
      private const const_2313:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_939 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2507 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      {
         if(this.var_55 == null || this.var_47 == null || this.var_107 == null)
         {
            return;
         }
         this.var_55.height = this.var_55.scrollableRegion.height;
         this.var_47.height = this.var_55.height + 20;
         this._window.width = Math.max(this.var_47.width,this.var_107.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_47.width < this.var_107.width)
         {
         ...
         {
            this.var_107.x = this._window.width - this.var_107.width;
            this.var_47.x = 0;
         }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_107 = this._window.getListItemByName("button_list") as IWindowContainer;
         var _loc3_:* = [];
         this.var_107.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
         ...
         if(this.var_47 != null)
         {
            this.var_55 = this.var_47.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc5_:IBitmapWrapperWindow = this.var_47.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_47.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc7_ = this.var_47.findChildByName("badge_" + _loc8_);
            if(_loc7_ != null)
            {
         ...
         _loc7_ = this.var_47.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_151.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_151.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_151.x = _loc5_.left - this.var_151.width;
         this.var_151.y = _loc5_.top + (_loc5_.height - this.var_151.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_151.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_151.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_151.x = _loc7_.left - this.var_151.width;
         this.var_151.y = _loc7_.top + (_loc7_.height - this.var_151.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_151 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_151 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1064;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1505;
            }
            else
            {
               _loc5_.textColor = this.const_1506;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1064,this.const_2312);
         _loc5_.height = Math.max(_loc5_.height,this.const_2313);
         _loc3_.height = _loc5_.height + this.const_2314;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_356,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_356,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_939.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_107.getChildByName(param1) as IRegionWindow;
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_107.getChildByName(param1);
         if(_loc3_ != null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_812:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_929:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2506 > this.const_2311 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               _loc3_.textColor = this.const_1506;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1505;
         }
      }
      ...
      {
         var _loc5_:* = null;
         this.var_107.width = 250;
         var _loc2_:* = [];
         this.var_107.groupChildrenWithTag("CMD_BUTTON_REGION",_loc2_,true);
         var _loc3_:int = 250;
         var _loc4_:int = 0;
