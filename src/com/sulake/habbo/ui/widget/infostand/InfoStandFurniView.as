package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected var var_47:IBorderWindow;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_261 = this.var_47.findChildByTag("catalog");
         if(this.var_261 != null)
         {
            this.var_261.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      {
         if(this.var_55 == null || this.var_47 == null || this._buttons == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_47.width,this._buttons.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_47.width < this._buttons.width)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1175 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_487 && param1.isRoomOwner)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc6_.addEventListener(WindowKeyboardEvent.const_187,this.adElementKeyEventProc);
                  }
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1270.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function getVisibleAdFurnitureExtraParams() : String
      {
         ...
         {
            _loc2_ = [];
            this.var_47.groupChildrenWithTag("branding_element",_loc2_,true);
            if(_loc2_.length > 0)
            {
      ...
      private function showAdFurnitureDetails(param1:Boolean) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this._widget == null || this.var_47 == null)
         {
            return;
         }
         var _loc2_:IWindow = this.var_47.findChildByName("furni_details_spacer");
         if(_loc2_ != null)
         {
            _loc2_.visible = param1;
         }
         var _loc3_:* = [];
         this.var_47.groupChildrenWithTag("branding_element",_loc3_,true);
         if(_loc3_.length > 0)
         {
            for each(_loc8_ in _loc3_)
            {
               this.var_47.removeChild(_loc8_);
               _loc8_.dispose();
            }
         }
         var _loc4_:Boolean = false;
         var _loc5_:IWindow = this.var_47.findChildByName("furni_details_text") as ITextWindow;
         if(_loc5_ != null)
         {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_55.addListItem(this.var_261);
            }
            this.var_261.visible = param1;
         }
         else
         {
            this.var_55.removeListItem(this.var_261);
         }
      }
   }
}
