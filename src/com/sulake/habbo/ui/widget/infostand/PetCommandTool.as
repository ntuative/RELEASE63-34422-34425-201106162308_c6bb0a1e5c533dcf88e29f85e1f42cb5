package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_475:IFrameWindow;
      
      private var var_1314:Map;
      ...
      private const const_2329:int = 1100;
      
      public function PetCommandTool(param1:InfostandWidget)
      {
         super();
         this._widget = param1;
         this.var_1314 = new Map();
         this.var_398 = new Timer(this.const_2329);
         this.var_398.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1314.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_570);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1314.getValue(this.var_570) as CommandConfiguration;
      ...
      {
         this.var_1314.remove(param1);
         this.var_1314.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_734,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_42.setParamFlag(WindowParam.const_104,true);
         this.var_42.context.getDesktopWindow().addEventListener(WindowEvent.const_39,this.onWindowDesktopResized);
         this.var_42.procedure = this.onCommandWindowProcedure;
         this.var_42.position = const_1521;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_475 == null)
         {
            ...
            this.var_475 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_475 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_475.x = 200;
            this.var_475.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_243,this.var_570));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_610,this.var_570,this.var_2048 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_610,this.var_570,this.var_2048 + " " + _loc5_);
