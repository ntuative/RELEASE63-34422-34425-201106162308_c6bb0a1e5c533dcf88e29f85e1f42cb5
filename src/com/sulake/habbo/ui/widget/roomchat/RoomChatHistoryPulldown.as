package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_485:int = 2;
      ...
      private static const const_1033:int = 150;
      
      private static const const_1032:int = 250;
      ...
      private var var_2305:BitmapData;
      
      private var var_1731:BitmapData;
      
      private var var_2306:BitmapData;
      
      private var var_1730:BitmapData;
      
      private var var_1729:BitmapData;
      
      private var var_2307:BitmapData;
      
      private var var_2308:BitmapData;
      
      private var var_2309:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_43 = param3;
         this.var_2305 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1731 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2306 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1730 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1729 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2307 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2308 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_82 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_369,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param3.width,param3.height - const_94),null,0,0) as IBitmapWrapperWindow;
         this.var_43.addChild(this.var_82);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_71,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_43.height - const_94,param3.width,const_94),null,0) as IWindowContainer;
         this.var_43.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_362,HabboWindowStyle.const_46,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_94),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_485:
               this.var_82.blend += param1 / const_1032;
               this._window.blend += param1 / const_1032;
               if(this._window.blend >= 1)
               {
                  this.state = const_450;
               }
               break;
            case const_1031:
               this.var_82.blend -= param1 / const_1033;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_43.width - this.var_2309;
         }
         if(this.var_82 != null)
         {
            this.var_82.rectangle = this.var_43.rectangle;
            this.var_82.height -= const_94;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2304 == this._window.width)
         {
            return;
         }
         this.var_2304 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2306;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1730;
            barX.disposesBitmap = false;
            this.var_2309 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2305,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1731,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1731,destGripRBitmap);
         ...
         this.var_82.bitmap = this.var_2308;
