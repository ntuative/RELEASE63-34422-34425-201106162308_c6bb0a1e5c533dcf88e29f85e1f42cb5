package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3037:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3037 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_407:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_70,this.var_149,this.var_2780++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_357:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_70,this.var_149,this);
               break;
            case RoomWidgetEnum.const_629:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_70,this.var_149,this._catalog);
               break;
            case RoomWidgetEnum.const_571:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_70,events,this.var_149);
               break;
            ...
            case RoomWidgetEnum.const_501:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_70,this.var_149,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_544:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_70,this.var_149);
               break;
            case RoomWidgetEnum.const_596:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_70,this.var_149);
               break;
            case RoomWidgetEnum.const_127:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_70,this.var_149);
               break;
            ...
            case RoomWidgetEnum.const_429:
               _loc3_ = new PurseWidget(param2,this._windowManager,this.var_149,assets,this.var_70);
               break;
            case RoomWidgetEnum.const_128:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_149,this.var_70,this);
               break;
            ...
            case RoomWidgetEnum.const_608:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_70,this.var_149,this._catalog);
               break;
