package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private static const const_1497:int = 5000;
      ...
      private var var_315:Timer = null;
      ...
      {
         return getTimer() - this.var_2483 > const_1497;
      }
      
      public function setLastPasteTime() : void
      {
         this.var_2483 = getTimer();
      }
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_872,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_154,this.onRoomObjectDeselected);
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_733,this.onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_159,this.onUserInfo);
         param1.addEventListener(RoomWidgetFloodControlEvent.const_927,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_154,this.onRoomObjectDeselected);
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_733,this.onChatInputUpdate);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_159,this.onUserInfo);
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_927,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1195:
               _loc2_ = localizations.getKey("widgets.chatinput.mode.whisper",":tell");
               this._visualization.displaySpecialChatMessage(_loc2_,param1.userName);
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1860:
         }
      }
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this._visualization.updateBlockText(this.var_315.repeatCount - this.var_315.currentCount);
         }
      }
      ...
      public function onFloodControl(param1:RoomWidgetFloodControlEvent) : void
      {
         ...
         {
            this.var_315 = new Timer(1000,param1.seconds);
            this.var_315.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_315.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_315.start();
         if(this._visualization != null)
         {
