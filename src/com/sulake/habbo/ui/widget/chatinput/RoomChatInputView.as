package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1615:int = 250;
      
      private static const const_1617:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1616:String = "${widgets.chatinput.say}";
      ...
      private var var_28:ITextFieldWindow;
      
      private var var_2055:IWindow;
      
      private var _button:IWindow;
      
      private var var_2056:IWindow;
      
      private var var_1608:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1315 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2829 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2828 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_404 = new Timer(1000,1);
         this.var_404.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_478 = new Timer(10000,1);
         this.var_478.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_404.reset();
            this.var_404.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_404 = null;
         }
         if(this.var_478 != null)
         {
            this.var_478.reset();
            this.var_478.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_478 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_28 = this._window.findChildByName("chat_input") as ITextFieldWindow;
         this.var_2055 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2056 = this._window.findChildByName("send_button_text");
         this.var_1608 = this._window.findChildByName("block_text");
         this.var_2056.caption = const_1616;
         this.var_28.setParamFlag(HabboWindowParam.const_43,true);
         this.var_28.addEventListener(WindowMouseEvent.const_45,this.windowMouseEventProcessor);
         this.var_28.addEventListener(WindowKeyboardEvent.const_187,this.windowKeyEventProcessor);
         this.var_28.addEventListener(WindowKeyboardEvent.const_356,this.keyUpHandler);
         this.var_28.addEventListener(WindowEvent.const_114,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSend);
         this.var_1606 = true;
         this.var_687 = "";
         this._window.addEventListener(WindowEvent.const_658,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_514,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2055.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1615 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1617);
      }
      ...
      {
         if(this._window == null || this.var_28 == null)
         {
            return;
         }
         this.var_28.enable();
         this.var_28.selectable = true;
         this.var_28.text = "";
         this.setInputFieldFocus();
         this.var_28.text += param1 + " ";
         if(param2.length > 0)
         {
            this.var_28.text += param2 + " ";
         }
         this.var_28.setSelection(this.var_28.text.length,this.var_28.text.length);
         this.var_687 = this.var_28.text;
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_28 != null)
            {
               _loc7_ = this.var_28.text;
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1315 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_28.text = "";
                  this.var_687 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_687.length + 1)
            {
      ...
      {
         if(this.var_28 == null || this.var_28.text == "")
         {
            return;
         }
         var _loc1_:String = this.var_28.text;
         var _loc2_:String = this._widget.selectedUserName;
         if(_loc1_ == this.var_1315)
         {
            if(_loc2_.length > 0)
            {
               this.var_28.text += " " + this._widget.selectedUserName;
               this.var_28.setSelection(this.var_28.text.length,this.var_28.text.length);
               this.var_687 = this.var_28.text;
            }
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_688);
      ...
      private function setInputFieldFocus() : void
      {
         ...
         {
            this.var_28.text = "";
            this.var_28.textColor = 0;
            this.var_28.italic = false;
            this.var_1606 = false;
            this.var_687 = "";
         }
         this.var_28.focus();
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_126);
         var _loc3_:String = this.var_28.text;
         ...
         if(this._widget != null)
         {
            if(this.var_404.running)
            {
               this.var_404.reset();
            }
            if(this.var_478.running)
            {
               this.var_478.reset();
            }
