package com.sulake.habbo.ui.widget.purse.indicator
{
   ...
   public class ShellsIndicator implements ICurrencyIndicator
   {
      ...
      private const const_2307:uint = 4.281841314E9;
      
      private const const_2308:uint = 4.280522629E9;
      ...
      public function ShellsIndicator(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:* = null;
         super();
         var _loc3_:XmlAsset = param2.getAssetByName("purse_indicator_shells") as XmlAsset;
         if(_loc3_)
         {
            ...
            if(this._view.groupChildrenWithTag("ICON",_loc4_,true) == 1)
            {
               ...
               _loc6_ = param2.getAssetByName("shell_icon").content as BitmapData;
               if(_loc5_)
               {
      ...
      public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPurseUpdateEvent.const_112,this.onShellBalance);
      }
      ...
      public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPurseUpdateEvent.const_112,this.onShellBalance);
      }
      
      private function onShellBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_2790 = param1.balance;
         var _loc2_:String = this.var_2790.toString();
         if(_loc2_.length < 2)
         {
            _loc2_ = "  " + _loc2_;
         }
      ...
      {
         this.var_2385.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1193));
      }
