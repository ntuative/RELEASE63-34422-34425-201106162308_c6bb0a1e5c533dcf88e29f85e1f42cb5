package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1037:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_1014 = param1.volume;
         if(this.var_1037 != null)
         {
            this.var_1037.setValue(this.var_1014);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1035 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1036 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1037 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_980));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1014 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1036);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1033);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1034);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1035);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_823);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_826);
         }
