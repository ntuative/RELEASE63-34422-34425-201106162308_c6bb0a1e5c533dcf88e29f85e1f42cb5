package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_1492:String = "room_widget";
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         this.var_3026 = param1.copy();
         this.var_97 = param2.buildFromXML(param1,0) as IWindowContainer;
         if(this.var_97 == null)
         {
            throw new Error("Failed to build layout from XML.");
         }
         this.var_97.width = this.var_97.desktop.width;
         this.var_97.height = this.var_97.desktop.height;
         var _loc4_:IWindowContainer = this.var_97.desktop as IWindowContainer;
         _loc4_.addChildAt(this.var_97,0);
         this.var_97.findChildByTag("room_widget_infostand").y = this.var_97.findChildByTag("room_widget_infostand").y - BOTTOM_MARGIN;
         var _loc6_:int = 0;
         while(_loc6_ < this.var_97.numChildren)
         {
            _loc5_ = this.var_97.getChildAt(_loc6_);
            _loc7_ = false || false;
            if(_loc5_.testParamFlag(_loc7_))
            {
               _loc5_.addEventListener(WindowEvent.const_147,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         if(param1 == RoomWidgetEnum.const_357)
         {
            return this.var_97.getChildByName("background_widgets") as IWindowContainer;
         }
         var _loc3_:Array = param2.tags;
         var _loc5_:int = 0;
         while(_loc5_ < _loc3_.length)
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1492) == 0)
            {
         ...
         return this.var_97.getChildByTag(_loc4_) as IWindowContainer;
      }
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_97.getChildByTag(const_684) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_97.findChildByTag(const_684) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
         ...
         _loc2_.offset(this.var_97.x,this.var_97.y);
         return _loc2_;
      }
