package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_397;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_883);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_799);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_771);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_883:
               ...
               if(_loc4_)
               {
                  _loc5_ = this._container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_29,this._container.getFirstCanvasId());
                  _loc6_ = this._container.roomEngine.getRoomObjectScreenLocation(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_29,this._container.getFirstCanvasId());
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_799:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_771:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_148);
         _loc1_.push(FriendRequestEvent.const_60);
         _loc1_.push(FriendRequestEvent.const_215);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_148:
               ...
               break;
            case FriendRequestEvent.const_60:
            case FriendRequestEvent.const_215:
