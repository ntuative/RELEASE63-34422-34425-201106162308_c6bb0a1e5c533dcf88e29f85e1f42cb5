package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_645:Map = null;
      
      private var var_1895:Map = null;
      
      private var var_1253:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1252:Number = 0.0;
      
      private var var_806:Point = null;
      
      private var var_543:Vector3d;
      
      public function ChatWidgetHandler()
      {
         this.var_1253 = [];
         this.var_543 = new Vector3d();
         super();
      ...
      {
         return RoomWidgetEnum.const_407;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_449 != null)
         {
            ...
            {
               _loc2_ = this.var_449.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_321 != null)
         {
            ...
            {
               _loc2_ = this.var_321.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1253)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_872,RoomWidgetChatSelectAvatarMessage.const_725];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_872:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_38) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1339))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_416);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_38) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1339))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_497);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
                     ...
                     switch(_loc3_.chatType)
                     {
                        ...
                        case RoomWidgetChatMessage.const_123:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_161:
                           this._container.roomSession.sendWhisperMessage(_loc3_.recipientName,_loc3_.text);
                     }
                  }
               }
               break;
            case RoomWidgetChatSelectAvatarMessage.const_725:
      ...
      {
         return [RoomSessionChatEvent.const_202];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_202:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_321.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_449.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_645.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_207:
                                       ...
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_117,null,this);
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_645.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_207)
                                    {
                                       this.var_321.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_449.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1252 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1252);
            }
            if(this.var_806 == null)
            {
               ...
               this.var_543.y = 0;
               this.var_543.z = 0;
               this.var_806 = _loc4_.getScreenPoint(this.var_543);
               this.var_1252 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_543.x = 0;
            this.var_543.y = 0;
            this.var_543.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_543);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_806.x || _loc8_.y != this.var_806.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_806,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_321)
         {
            _loc2_ = this.var_321.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1253.push(_loc2_);
            }
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_449)
         {
            _loc2_ = this.var_449.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1253.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_117,this);
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_645.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1895.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1895.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_321)
            {
               this.var_321.add(_loc3_,param2);
            }
         }
      }
   }
