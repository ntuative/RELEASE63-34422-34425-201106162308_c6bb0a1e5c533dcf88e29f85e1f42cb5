package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private static const const_466:int = 50;
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_223);
         }
         this.var_1136 = true;
         this.container = null;
         this.var_13 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_336,this.onFigureUpdate);
            }
            if(this.var_13 && !this.var_13.disposed && this.var_13.events)
            {
               this.var_13.events.removeEventListener(HabboInventoryEffectsEvent.const_278,this.onAvatarEffectsChanged);
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_724,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_985,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_336,this.onFigureUpdate);
         }
         this.var_13 = this._container.inventory;
         if(this.var_13 != null)
         {
            this.var_13.events.addEventListener(HabboInventoryEffectsEvent.const_278,this.onAvatarEffectsChanged);
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_724,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_985,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1466)
            {
               _loc4_ = this._container.sessionDataManager.gender;
               _loc5_ = this._container.avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_59,_loc4_,this);
               if(_loc5_ != null)
               {
               ...
               this.var_1790 = _loc1_;
               this.var_1789 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1790;
               _loc2_ = this.var_1789;
            }
         }
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_466)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_466,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_466 - const_1055)
                  {
                     _loc8_.offset(0,_loc2_.height - const_466 + const_1055);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_846);
         _loc1_.push(RoomWidgetDanceMessage.const_997);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_977);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1342);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1272);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1325);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_864);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_412);
         _loc1_.push(RoomWidgetStopEffectMessage.const_781);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1958);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1359);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_517);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1859);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1372);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_828);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_856);
         _loc1_.push(RoomWidgetMeMenuMessage.const_946);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_980);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1777);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_823);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_826);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1203);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_391);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_856:
               ...
               break;
            case RoomWidgetWaveMessage.const_846:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_997:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_977:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1342:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1272:
               if(this.var_13 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_412:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1174)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_188,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_864:
               ...
               if(this.var_13 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1736:
                        this._catalog.openCatalogPage(CatalogPageName.const_1169,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1248:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_287);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1879:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_77);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1726:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1325:
            case RoomWidgetStopEffectMessage.const_781:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1359:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_828:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_946:
            ...
            case RoomWidgetAvatarEditorMessage.const_517:
               ...
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_223,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_223);
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_980:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_433,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_823:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_433,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_826:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_433,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1203:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_666));
               }
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_131:
               ...
               break;
            case HabboHelpTutorialEvent.const_985:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_651));
         }
      }
