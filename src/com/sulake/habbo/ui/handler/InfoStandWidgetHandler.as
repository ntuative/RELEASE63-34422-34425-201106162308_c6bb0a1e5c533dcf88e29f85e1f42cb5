package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_239.events.addEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
            this.var_239.events.addEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_210,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_185,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_210,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_185,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_667.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_667.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_239 != null)
         {
            this.var_239.events.removeEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
            this.var_239.events.removeEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
            this.var_239 = null;
         }
         this.var_1136 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_583);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_863);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_432);
         _loc1_.push(RoomWidgetUserActionMessage.const_483);
         _loc1_.push(RoomWidgetUserActionMessage.const_600);
         _loc1_.push(RoomWidgetUserActionMessage.const_648);
         _loc1_.push(RoomWidgetUserActionMessage.const_607);
         _loc1_.push(RoomWidgetUserActionMessage.const_888);
         _loc1_.push(RoomWidgetFurniActionMessage.const_279);
         _loc1_.push(RoomWidgetFurniActionMessage.const_972);
         _loc1_.push(RoomWidgetFurniActionMessage.const_926);
         _loc1_.push(RoomWidgetFurniActionMessage.const_838);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1243);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_923);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_904);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_784);
         _loc1_.push(RoomWidgetUserActionMessage.const_526);
         _loc1_.push(RoomWidgetUserActionMessage.const_582);
         _loc1_.push(RoomWidgetUserActionMessage.const_486);
         _loc1_.push(RoomWidgetUserActionMessage.const_1785);
         _loc1_.push(RoomWidgetPetCommandMessage.const_610);
         _loc1_.push(RoomWidgetPetCommandMessage.const_734);
         _loc1_.push(RoomWidgetUserActionMessage.const_511);
         _loc1_.push(RoomWidgetUserActionMessage.const_243);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_911);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_526)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_243 || param1.type == RoomWidgetUserActionMessage.const_511 || param1.type == RoomWidgetUserActionMessage.const_486)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_583:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_863:
            ...
            case RoomWidgetUserActionMessage.const_642:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1195,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_668:
               ...
               break;
            case RoomWidgetUserActionMessage.const_432:
            ...
            case RoomWidgetUserActionMessage.const_600:
               ...
               break;
            case RoomWidgetUserActionMessage.const_648:
               this._container.roomSession.removeRights(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_607:
            ...
            case RoomWidgetFurniActionMessage.const_1243:
               ...
               break;
            case RoomWidgetUserActionMessage.const_243:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_923:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_904:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_784:
               ...
               break;
            case RoomWidgetUserActionMessage.const_526:
               this._container.roomSession.kickBot(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_582:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_285);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_335);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_435) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_435);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_874) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1175;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_285);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1183);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1343);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_487)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_413) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_413.length);
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_207)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_130)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_661)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_348);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_159)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_740);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_812;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_929;
                  }
               ...
               _loc19_ = _loc12_.sex;
               _loc20_ = this._container.avatarRenderManager.createAvatarImage(_loc18_,AvatarScaleType.const_59,_loc19_);
               if(_loc20_ != null)
               {
                  _loc20_.setDirection(AvatarSetType.const_41,4);
                  _loc14_.image = _loc20_.getImage(AvatarSetType.const_41,true);
                  _loc20_.dispose();
               }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_141];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_141:
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         {
            _loc5_ = this._container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_59,param1.gender);
            if(_loc5_ != null)
            {
               _loc5_.setDirection(AvatarSetType.const_41,4);
               _loc4_ = _loc5_.getImage(AvatarSetType.const_41,true);
               _loc5_.dispose();
            }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_667.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_667.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = this._container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_29);
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_740);
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc4_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_59,null);
            if(_loc4_ != null)
            {
               _loc2_ = _loc4_.getCroppedImage(AvatarSetType.const_41);
               _loc4_.dispose();
            }
         }
         else
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_239 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_415,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_239 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_423,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
