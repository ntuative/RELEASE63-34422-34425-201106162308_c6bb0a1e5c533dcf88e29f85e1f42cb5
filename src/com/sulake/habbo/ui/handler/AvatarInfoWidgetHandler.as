   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container)
         {
            ...
            this._container.sessionDataManager.events.removeEventListener(UserNameUpdateEvent.const_885,this.onUserNameUpdate);
         }
         this._container = param1;
         if(this._container)
         {
            this._container.toolbar.events.addEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
            this._container.sessionDataManager.events.addEventListener(UserNameUpdateEvent.const_885,this.onUserNameUpdate);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_768);
         _loc1_.push(RoomWidgetUserActionMessage.const_609);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionUserDataUpdateEvent.const_135);
         _loc1_.push(RoomSessionDanceEvent.const_155);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_768:
               this.dispatchOwnAvatarInfo();
               break;
            case RoomWidgetUserActionMessage.const_609:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserDataUpdateEvent.const_135:
               this._container.events.dispatchEvent(new RoomWidgetUserDataUpdateEvent());
               break;
            case RoomSessionDanceEvent.const_155:
