package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_732,param1,param2,param3,param4));
         }
      }
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:IRoomGeometry) : void
      {
         ...
         if(_loc5_ != RoomObjectCategoryEnum.const_85)
         {
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_68:
               ...
               break;
            case RoomObjectStateChangeEvent.const_1014:
            ...
            case RoomObjectDimmerStateUpdateEvent.const_67:
               ...
               break;
            case RoomObjectMoveEvent.const_453:
               this.handleSelectedObjectMove(param1,param2,param3);
               break;
            case RoomObjectMoveEvent.const_829:
            ...
            case RoomObjectWidgetRequestEvent.const_173:
            case RoomObjectWidgetRequestEvent.const_163:
            case RoomObjectWidgetRequestEvent.const_143:
            case RoomObjectWidgetRequestEvent.const_152:
            case RoomObjectWidgetRequestEvent.const_168:
            ...
            case RoomObjectWidgetRequestEvent.const_165:
               this.handleObjectWidgetRequestEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_660:
            case RoomObjectFurnitureActionEvent.const_633:
            case RoomObjectFurnitureActionEvent.const_641:
            case RoomObjectFurnitureActionEvent.const_643:
            case RoomObjectFurnitureActionEvent.const_645:
            case RoomObjectFurnitureActionEvent.const_527:
            case RoomObjectFurnitureActionEvent.const_536:
               this.handleObjectActionEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_549:
            case RoomObjectFurnitureActionEvent.const_639:
            case RoomObjectFurnitureActionEvent.const_590:
            case RoomObjectFurnitureActionEvent.const_659:
               this.handleObjectSoundMachineEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_579:
            case RoomObjectFurnitureActionEvent.const_595:
            case RoomObjectFurnitureActionEvent.const_578:
            case RoomObjectFurnitureActionEvent.const_573:
               this.handleObjectJukeboxEvent(param1,param2,param3);
               break;
            case RoomObjectRoomAdEvent.const_222:
            case RoomObjectRoomAdEvent.const_657:
            case RoomObjectRoomAdEvent.const_325:
            case RoomObjectRoomAdEvent.const_355:
            case RoomObjectRoomAdEvent.const_490:
               this.handleObjectRoomAdEvent(param1,param2,param3);
               break;
            case RoomObjectRoomActionEvent.const_580:
            case RoomObjectRoomActionEvent.const_1751:
            case RoomObjectRoomActionEvent.const_591:
               this.handleRoomActionEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_340:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         switch(_loc4_)
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc8_ == RoomObjectCategoryEnum.const_85)
               {
                  if(_loc5_ != null)
                  {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  _loc13_ = false;
                  _loc14_ = false;
                  if(_loc8_ == RoomObjectCategoryEnum.const_29)
                  {
                     if(!this._roomEngine.getIsPlayingGame(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory))
                     {
                        _loc13_ = true;
                  ...
                  if(_loc10_ != null)
                  {
                     if(_loc13_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_85,MouseEvent.CLICK,_loc10_);
                     }
                     if(_loc14_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_151,MouseEvent.CLICK,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_85)
         {
            _loc15_ = this.getMouseEventId(RoomObjectCategoryEnum.const_151,MouseEvent.CLICK);
            _loc16_ = this.getMouseEventId(RoomObjectCategoryEnum.const_29,MouseEvent.CLICK);
            if(_loc15_ != _loc10_ && _loc16_ != _loc10_)
            {
               _loc17_ = this._roomEngine.events;
               if(_loc17_ != null)
               {
                  _loc17_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_620,param2,param3,-1,RoomObjectCategoryEnum.const_151));
               }
      ...
      private function handleRoomObjectMouseMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(this._roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_634);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
         ...
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc7_ == RoomObjectCategoryEnum.const_85)
               {
      ...
      private function handleRoomObjectMouseEnter(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_193,param2,param3,param1.objectId,this._roomEngine.getRoomObjectCategory(param1.objectType)));
         }
      }
      ...
      private function handleRoomObjectMouseLeave(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_178,param2,param3,param1.objectId,this._roomEngine.getRoomObjectCategory(param1.objectType)));
         }
      }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_27 || _loc8_ == RoomObjectCategoryEnum.const_26)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_959,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_29 && _loc7_ != null)
            {
            ...
            if(_loc6_ != null)
            {
               if(_loc5_.category == RoomObjectCategoryEnum.const_27)
               {
                  ...
                  {
                     _loc9_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_809);
         ...
         if(_loc7_ != null)
         {
            switch(param1.type)
            {
               ...
               case RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_173:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_173,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_163:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_163,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_143:
               ...
               case RoomObjectWidgetRequestEvent.const_152:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_168:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_168,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_171:
               ...
               case RoomObjectWidgetRequestEvent.const_146:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_165:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_165,param2,param3,_loc4_,_loc6_));
            }
         }
      }
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_549:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_921,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_639:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_819,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_590:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_780,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_659:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1007,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_579:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_727,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_595:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1731,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_578:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1942,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_573:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_293,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_376);
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_394);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_376);
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_394);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_376);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_594);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_832);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_346,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1448,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            ...
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_634));
            }
         }
      }
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_809);
         }
      ...
      private function placeObject(param1:int, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc7_ == RoomObjectCategoryEnum.const_27 || _loc7_ == RoomObjectCategoryEnum.const_29)
               {
               ...
               if(_loc7_ == RoomObjectCategoryEnum.const_29 && _loc5_.typeId == RoomObjectTypeEnum.const_207)
               {
                  this._roomEngine.connection.send(new PlacePetMessageComposer(_loc6_,int(_loc10_),int(_loc11_)));
               }
               else if(_loc8_.getModelController().getString(RoomObjectVariableEnum.const_1204) != null)
               {
         ...
         if(this._roomEngine && this._roomEngine.events)
         {
            ...
            this._roomEngine.events.dispatchEvent(new RoomEngineObjectPlacedEvent(RoomEngineObjectEvent.const_158,param1,param2,_loc6_,_loc7_,_loc9_,_loc10_,_loc11_,_loc12_,_loc13_,_loc17_,param3,param4,_loc5_.instanceData));
         }
      }
