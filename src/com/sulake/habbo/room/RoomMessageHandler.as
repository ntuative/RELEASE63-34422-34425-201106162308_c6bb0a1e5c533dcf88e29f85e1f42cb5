package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1899:Boolean = true;
      
      private var var_1523:int = -1.0E9;
      
      private var var_997:int = 0;
      
      private var var_996:int = 0;
      
      private var var_810:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_810 = new Object();
         super();
         this.var_12 = param1;
      ...
      {
         if(this.var_997 != 0 || this.var_996 != 0)
         {
            if(this.var_12 != null)
            {
               this.var_12.disposeRoom(this.var_997,this.var_996);
            }
         }
         this.var_997 = param1;
         this.var_996 = param2;
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(this.var_997 != _loc3_.roomId || this.var_996 != _loc3_.roomCategory)
         {
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         while(_loc15_ < _loc8_)
         {
            ...
            while(_loc19_ < _loc7_)
            {
               ...
               if(!_loc13_)
               {
                  if((_loc15_ > 0 && _loc15_ < _loc8_ - 1 || _loc19_ > 0 && _loc19_ < _loc7_ - 1) && _loc20_ != RoomPlaneParser.TILE_BLOCKED)
                  {
                     if(_loc3_.getTileHeight(_loc19_,_loc15_ - 1) == RoomPlaneParser.TILE_BLOCKED && _loc3_.getTileHeight(_loc19_ - 1,_loc15_) == RoomPlaneParser.TILE_BLOCKED && _loc3_.getTileHeight(_loc19_,_loc15_ + 1) == RoomPlaneParser.TILE_BLOCKED)
                     {
                        _loc9_ = Number(_loc19_ + 0.5);
                        _loc10_ = Number(_loc15_);
                        _loc11_ = Number(_loc20_);
                        _loc12_ = 90;
                     ...
                     if(_loc3_.getTileHeight(_loc19_,_loc15_ - 1) == RoomPlaneParser.TILE_BLOCKED && _loc3_.getTileHeight(_loc19_ - 1,_loc15_) == RoomPlaneParser.TILE_BLOCKED && _loc3_.getTileHeight(_loc19_ + 1,_loc15_) == RoomPlaneParser.TILE_BLOCKED)
                     {
                        _loc9_ = Number(_loc19_);
         ...
         if(!_loc13_)
         {
            _loc23_ = <doors><door x="{_loc9_}" y="{_loc10_}" z="{_loc11_}" dir="{_loc12_}"/></doors>;
            _loc18_.appendChild(_loc23_);
         }
         this.var_12.initializeRoom(_loc4_,_loc5_,_loc18_);
         if(this.var_810.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_810.objectData);
            this.var_810.objectData = null;
         }
         else
         {
            this.var_810.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_810.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_810.objectData = _loc6_;
         }
      }
      ...
      private function onItemRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_12.disposeObjectWallItem(_loc4_,_loc5_,_loc3_.itemId);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.getUserCount())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.webID == this.var_2586)
               {
                  this.var_12.setOwnUserId(_loc4_,_loc5_,_loc7_.id);
               }
               this.var_12.updateObjectUserFigure(_loc4_,_loc5_,_loc7_.id,_loc7_.figure,_loc7_.sex,_loc7_.subType);
            }
            _loc6_++;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_991);
         var _loc8_:int = 0;
         while(_loc8_ < _loc3_.userUpdateCount)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               _loc14_ = "null";
               _loc15_ = "";
               this.var_12.updateObjectUserFlatControl(_loc4_,_loc5_,_loc9_.id,null);
               _loc16_ = false;
               _loc17_ = false;
               for each(_loc18_ in _loc9_.actions)
               {
                  ...
                  {
                     case "flatctrl":
                        this.var_12.updateObjectUserFlatControl(_loc4_,_loc5_,_loc9_.id,_loc18_.actionParameter);
                        break;
                     case "sign":
                        this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc9_.id,RoomObjectVariableEnum.const_441,int(_loc18_.actionParameter));
                        break;
                     case "gst":
                        this.var_12.updateObjectPetGesture(_loc4_,_loc5_,_loc9_.id,_loc18_.actionParameter);
                        break;
                     case "wav":
                     case "mv":
                        _loc17_ = true;
               ...
               this.var_12.method_13(_loc4_,_loc5_,_loc9_.id,_loc14_,_loc15_);
            }
            _loc8_++;
         }
      }
      ...
      private function onUserRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_12.disposeObjectUser(_loc4_,_loc5_,_loc3_.id);
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserFigure(_loc3_,_loc4_,_loc2_.id,_loc2_.figure,_loc2_.sex);
      }
      ...
      private function onWave(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_263,_loc6_);
      }
      ...
      private function onDance(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_492,_loc3_.danceStyle);
      }
      ...
      private function onAvatarEffect(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_12.updateObjectUserEffect(_loc4_,_loc5_,_loc3_.userId,_loc3_.effectId,_loc3_.delayMilliSeconds);
      }
      ...
      private function onAvatarSleep(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_245,_loc6_);
      }
      ...
      private function onCarryObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is CarryObjectMessageEvent)
         {
            ...
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_348,_loc2_.itemType,_loc2_.itemName);
         }
      }
      ...
      private function onUseObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is UseObjectMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_306,_loc2_.itemType);
         }
      }
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            while(_loc6_ < _loc5_.length)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_12.updateObjectFurnitureLocation(_loc3_,_loc4_,_loc7_.id,_loc7_.loc,_loc7_.target);
               }
               _loc6_++;
            }
            if(_loc2_.avatar != null)
            {
               ...
               this.var_12.updateObjectUser(_loc3_,_loc4_,_loc8_.id,_loc8_.loc,_loc8_.target);
               switch(_loc8_.moveType)
               {
                  case SlideObjectMessageData.const_1329:
                     _loc9_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1196:
                     _loc9_ = "std";
               }
               this.var_12.method_13(_loc3_,_loc4_,_loc8_.id,_loc9_);
            }
         }
      }
      ...
      private function onChat(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:int = this.getRoomId(_loc2_.roomId);
         var _loc4_:int = this.getRoomCategory(_loc2_.roomCategory);
         this.var_12.updateObjectUserGesture(_loc3_,_loc4_,_loc2_.userId,_loc2_.gesture);
         this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_194,Math.ceil(_loc2_.text.length / 10));
      }
      ...
      private function onTypingStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_612,_loc6_);
      }
      ...
      private function onPetExperience(param1:PetExperienceEvent) : void
      {
         ...
         var _loc3_:int = this.getRoomId(_loc2_.roomId);
         var _loc4_:int = this.getRoomCategory(_loc2_.roomCategory);
         this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.petRoomIndex,RoomObjectVariableEnum.const_449,_loc2_.gainedExperience);
      }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1217,_loc3_.status);
         }
      }
      ...
      private function onGamePlayerNumberValue(param1:IMessageEvent) : void
      {
         ...
         if(param1 is GamePlayerValueMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_458,_loc2_.value);
         }
      }
   }
}
