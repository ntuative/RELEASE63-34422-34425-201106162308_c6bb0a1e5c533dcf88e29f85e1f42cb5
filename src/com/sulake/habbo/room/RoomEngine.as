package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_703:String = "temporary_room";
      
      private static const const_382:int = -1;
      
      private static const const_702:String = "room";
      
      private static const const_1113:int = -2;
      
      private static const const_1573:String = "tile_cursor";
      
      private static const const_1114:int = -3;
      
      private static const const_1574:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_381:String = "object_icon_sprite";
      
      private static const const_473:int = 15;
      
      private static const const_1112:int = 40;
      ...
      private var var_835:IRoomObjectFactory = null;
      
      private var var_513:IRoomObjectVisualizationFactory = null;
      ...
      private var var_73:RoomObjectEventHandler = null;
      
      private var var_466:RoomMessageHandler = null;
      
      private var var_15:RoomContentLoader = null;
      
      private var var_2711:Boolean = false;
      
      private var var_834:NumberBank;
      ...
      {
         this.var_557 = new Array();
         super(param1,param2);
         this.var_285 = new Map();
         this.var_834 = new NumberBank(1000);
         this.var_1280 = new Map();
         this.var_384 = new Map();
         this.var_73 = new RoomObjectEventHandler(this);
         this.var_466 = new RoomMessageHandler(this);
         var _loc3_:DisplayObjectContainer = param1.displayObjectContainer;
         var _loc4_:LoaderInfo = _loc3_.loaderInfo;
         this.var_15 = new RoomContentLoader(_loc4_.loaderURL);
      ...
      public function method_3(param1:String) : Boolean
      {
         if(this.var_15 != null)
         {
            return this.var_15.method_3(param1);
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_835.release(new IIDRoomObjectFactory());
            this.var_835 = null;
         }
         if(this.var_513 != null)
         {
            this.var_513.release(new IIDRoomObjectVisualizationFactory());
            this.var_513 = null;
         }
         ...
         {
            this._toolbar.events.removeEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
         ...
         if(this.var_285 != null)
         {
            ...
            {
               _loc2_ = this.var_285.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         if(this.var_285 != null)
         {
            _loc4_ = this.var_285.getValue(_loc3_) as RoomInstanceData;
            if(_loc4_ == null)
            {
               _loc4_ = new RoomInstanceData(param1,param2);
               this.var_285.add(_loc3_,_loc4_);
            }
         }
         return _loc4_;
      }
      ...
      {
         this.var_1279 = false;
         if(this.var_557 && this.var_557.length > 0)
         {
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         switch(param1)
         {
            case RoomObjectFurnitureActionEvent.const_273:
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:IRoomSession = this.var_16.getSession(this.var_87,this.var_86);
         ...
         var _loc5_:int = this.var_557.indexOf(_loc4_);
         if(_loc5_ == -1)
         {
      ...
      private function removeBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc4_:int = this.var_557.indexOf(_loc3_);
         if(_loc4_ > -1)
         {
            this.var_557.splice(_loc4_,1);
            this.var_1279 = true;
         }
      }
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_1026 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc11_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_285.length)
         {
            _loc5_ = this.var_285.getWithIndex(_loc3_) as RoomInstanceData;
            _loc6_ = null;
            _loc7_ = 0;
            _loc8_ = 0;
            if(_loc5_ != null)
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc11_ != null)
               {
                  if(_loc7_ != this.var_87 || _loc8_ != this.var_86 || !this.var_1025)
                  {
         ...
         if(_loc4_ != null)
         {
            if(this.var_1025)
            {
               _loc4_.screenOffsetX += this.var_1565;
               _loc4_.screenOffsetY += this.var_1564;
               this.var_1565 = 0;
               this.var_1564 = 0;
            }
         }
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_962) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_818) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_1009) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.const_774) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_835 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_513 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_15 != null)
         {
            this.var_15.visualizationFactory = this.var_513;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_29);
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_378);
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_85);
            this._roomManager.setContentLoader(this.var_15);
         }
         this.initializeRoomManager();
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_466 != null)
            {
               this.var_466.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_15 != null)
         {
            events.addEventListener(RoomContentLoader.const_760,this.onContentLoaderReady);
            this.var_15.initialize(events,this.var_149);
         }
         this.var_2709 = this.var_149.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_760)
         {
            this.var_2711 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_335.events.addEventListener(AdEvent.const_572,this.showRoomAd);
         this.var_335.events.addEventListener(AdEvent.const_817,this.onRoomAdImageLoaded);
         this.var_335.events.addEventListener(AdEvent.const_1155,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.sessionDataManager = this.var_394;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_75,this.onRoomSessionEvent);
         this.var_16.events.addEventListener(RoomSessionEvent.const_82,this.onRoomSessionEvent);
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_75:
               if(this.var_466)
               {
                  this.var_466.setCurrentRoom(param1.session.roomId,param1.session.roomCategory);
               }
               break;
            case RoomSessionEvent.const_82:
               if(this.var_466)
               {
                  this.var_466.resetCurrentRoom();
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_835 != null)
         {
            this.var_835.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_835 == null || this.var_513 == null || this._roomManager == null || this._roomRendererFactory == null || this._communication == null || this.var_149 == null || !this.var_2711)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_558 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_797,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_384.length)
            {
               _loc3_ = this.var_384.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      {
         return this.method_3(this.getWorldType(param1,param2));
      }
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1280,_loc5_);
            if(_loc5_ == 0)
            {
            ...
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_498,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1280);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_558)
         {
            _loc5_ = this.var_384.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_384.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_182,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = 1;
         if(this.method_3(param6))
         {
            _loc11_ = this.var_15.getPublicRoomContentType(param6);
            _loc9_ = _loc7_.createRoomObject(const_382,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1167,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_995,1,true);
            _loc12_ = parseInt(this.var_149.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1275,_loc12_,true);
            if(this.var_15 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_382,const_702,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_995,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_991,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_962,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_1009,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_818,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_774,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1218,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_918,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_233,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_870,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_206,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_808,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_201,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_493,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_269);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_914,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_950,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_914,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_950,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1253,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1285,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_1113,const_1573,RoomObjectCategoryEnum.const_378);
         if(this.var_149.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1114,const_1574,RoomObjectCategoryEnum.const_378);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_382,RoomObjectCategoryEnum.const_85);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(_loc7_ == null)
         {
            ...
            _loc11_ = this.var_384.getValue(_loc10_);
            if(_loc11_ == null)
            {
               _loc11_ = new RoomData(param1,param2,null);
               this.var_384.add(_loc10_,_loc11_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            ...
            {
               _loc8_.setString(RoomObjectVariableEnum.const_233,param3);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_918,param3);
         ...
         if(param4 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_206,param4);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_870,param4);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         if(param5 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_201,param5);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_808,param5);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1719,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1374,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1168,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectRoomPlaneThicknesses(param1:int, param2:int, param3:Number, param4:Number) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1387,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_696,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_285.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_347,param1,param2));
      }
      ...
      public function setOwnUserId(param1:int, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            _loc4_.targetCategory = RoomObjectCategoryEnum.const_29;
         }
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1385;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_991);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_914);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_950);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1253);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1285);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1561;
         var _loc9_:int = param3 - this.var_1562;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1025 = true;
               this.var_833 = false;
               this.var_2710 = this.var_1561;
               this.var_2712 = this.var_1562;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1025)
            {
               if(!this.var_833)
               {
                  _loc8_ = param2 - this.var_2710;
                  _loc9_ = param3 - this.var_2712;
                  if(_loc8_ <= -const_473 || _loc8_ >= const_473 || _loc9_ <= -const_473 || _loc9_ >= const_473)
                  {
                     this.var_833 = true;
                  }
                  _loc8_ = 0;
               ...
               {
                  this.var_1565 += _loc8_;
                  this.var_1564 += _loc9_;
                  this.var_833 = true;
               }
            }
         }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_381);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_620,this.var_87,this.var_86,-1,RoomObjectCategoryEnum.const_151));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_73 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_382,const_702);
                     this.var_73.handleRoomObjectEvent(_loc14_,this.var_87,this.var_86);
                  }
               }
            }
            this.var_1563 = param1;
            this.var_1561 = param2;
            this.var_1562 = param3;
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         else if(this.var_15 != null)
         {
            ...
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               ...
               _loc8_ = this.var_15.getActiveObjectColorIndex(param1);
            }
            else if(param2 == RoomObjectCategoryEnum.const_26)
            {
               _loc7_ = this.var_15.getWallItemType(param1,param4);
               _loc8_ = this.var_15.getWallItemColorIndex(param1);
            }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_87,this.var_86,this.var_1563);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_381);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_381,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1561 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1562 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_87,this.var_86,this.var_1563);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_381);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_87,this.var_86,this.var_1563);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_381);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            return this.var_73.modifyRoomObject(this.var_87,this.var_86,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_73.modifyRoomObjectData(this.var_87,this.var_86,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            ...
            {
               return this.var_73.modifyWallItemData(this.var_87,this.var_86,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_73.deleteWallItem(this.var_87,this.var_86,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_995) != 0)
         {
            return false;
         }
         if(this.var_73 != null)
         {
            return this.var_73.initializeRoomObjectInsert(this.var_87,this.var_86,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_73 != null)
         {
            this.var_73.cancelRoomObjectInsert(this.var_87,this.var_86);
         }
      }
         ...
         if(param1 != null)
         {
            ...
            if(_loc2_.length > 1)
            {
               ...
               if(_loc3_ >= 8)
               {
                  if(this.var_15 != null)
                  {
                     return this.var_15.getPetType(_loc3_);
                  }
               }
               return "pet";
            }
      ...
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         if(this.var_15 != null)
         {
            return this.var_15.getPetColor(param1,param2);
         }
         return null;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1114,RoomObjectCategoryEnum.const_378);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1113,RoomObjectCategoryEnum.const_378);
      }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN) : Boolean
      {
         ...
         if(this.method_3(_loc10_) && this.var_15 != null)
         {
            _loc12_ = this.var_15.getPublicRoomContentType(_loc10_) + "_";
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_292,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_285,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_417,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_882,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1183,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1343,getTimer());
            if(param4.knownAsUsable)
            {
               _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_874,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_176,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function changeObjectState(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         {
            _loc6_ = Number(_loc5_.getModelController().getNumber(RoomObjectVariableEnum.const_756));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
            ...
            _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_756,_loc6_);
         }
      }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_292,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_285,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_417,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1385,1,true);
            if(param4.knownAsUsable)
            {
               _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_874,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_176,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1209) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1356);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_493,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_930,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_176,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_204);
         }
      ...
      public function method_13(param1:int, param2:int, param3:int, param4:String, param5:String = "") : Boolean
      {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            if(_loc4_.disposeObject(param2,param3))
            {
               if(events != null)
               {
                  events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_425,this.var_87,this.var_86,param2,param3));
               }
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_73 != null)
         {
            this.var_73.handleRoomObjectEvent(param1,this.var_87,this.var_86);
         }
      }
      ...
      public function getFurnitureImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:uint = 0, param6:String = null, param7:int = -1, param8:int = -1) : ImageResult
      {
         ...
         if(this.var_15 != null)
         {
            _loc9_ = this.var_15.getActiveObjectType(param1);
            _loc10_ = String(this.var_15.getActiveObjectColorIndex(param1));
         }
      ...
      public function getPetImage(param1:int, param2:int, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0) : ImageResult
      {
         ...
         if(this.var_15 != null)
         {
            _loc7_ = this.var_15.getPetType(param1);
         }
      ...
      public function getWallItemImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:uint = 0, param6:String = null, param7:int = -1, param8:int = -1) : ImageResult
      {
         ...
         if(this.var_15 != null)
         {
            _loc9_ = this.var_15.getWallItemType(param1,param6);
            _loc10_ = String(this.var_15.getWallItemColorIndex(param1));
         }
         return this.getGenericRoomObjectImage(_loc9_,_loc10_,param2,param3,param4,param5,param6,param7,param8);
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_292));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_345);
                     break;
                  case RoomObjectCategoryEnum.const_29:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_220);
               }
            }
         }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_233,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_206,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_201,_loc6_);
               if(_loc7_ != null)
               {
                  _loc13_ = null;
                  _loc14_ = "undefined_1";
                  _loc13_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_493,_loc14_,_loc7_,new Vector3d(2.5,0.5,2));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         _loc10_.id = -1;
         if(!this.var_558 || param1 == null)
         {
            return _loc10_;
         }
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_703);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_703,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_834.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_27:
            case RoomObjectCategoryEnum.const_26:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_292,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_345,param7);
               break;
            case RoomObjectCategoryEnum.const_29:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_220,param2);
               }
               else
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_912,int(param2));
               }
               break;
            case RoomObjectCategoryEnum.const_85:
         ...
         if(param8 > -1)
         {
            _loc18_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_101);
         ...
         {
            this.var_1280.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1228,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_834.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_87,this.var_86,const_382,RoomObjectCategoryEnum.const_85,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_703);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1228);
               ...
               this.var_834.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1280.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_101);
            if(_loc7_ != null)
            {
            ...
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_897,_loc4_,_loc5_,param2,param3));
            }
         }
      }
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(this.var_73 != null)
         {
            this.var_73.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getSelectedAvatarId() : int
      {
         if(this.var_73 != null)
         {
            return this.var_73.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         this.var_73.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_430,param1.image,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1160,param1.adWarningL,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1364,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1381,RoomObjectVariableEnum.const_430,param1.clickUrl);
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         {
            this.var_15.addGraphicAsset(_loc3_.getType(),param1.imageUrl,param1.image,true);
         }
         switch(param1.type)
         {
            case AdEvent.const_817:
               ...
               break;
            case AdEvent.const_1155:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1152,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
      ...
      {
         this.var_15.setActiveObjectType(param1,param2);
      }
   }
}
