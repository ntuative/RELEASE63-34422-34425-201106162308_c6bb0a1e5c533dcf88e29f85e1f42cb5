package com.sulake.habbo.room.messages
{
   ...
   public class RoomObjectRoomPlanePropertyUpdateMessage extends RoomObjectUpdateMessage
   {
      ...
      public static const const_1387:String = "RORPPUM_WALL_THICKNESS";
      
      public static const const_696:String = "RORPVUM_FLOOR_THICKNESS";
       
      
      private var _type:String = "";
      
      private var var_204:Number = 0.0;
