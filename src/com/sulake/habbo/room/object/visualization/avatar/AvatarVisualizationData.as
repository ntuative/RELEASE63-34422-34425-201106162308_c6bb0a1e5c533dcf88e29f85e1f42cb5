   ...
   public class AvatarVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public function getAvatar(param1:String, param2:Number, param3:String = null, param4:IAvatarImageListener = null) : IAvatarImage
      {
         ...
         if(this._avatarRenderer != null)
         {
            ...
            if(param2 > 48)
            {
               _loc5_ = this._avatarRenderer.createAvatarImage(param1,AvatarScaleType.const_59,param3,param4);
            }
            else
            {
               _loc5_ = this._avatarRenderer.createAvatarImage(param1,AvatarScaleType.const_117,param3,param4);
            }
            return _loc5_;
         }
         return null;
