package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1592:String = "head";
      
      private static const const_705:int = 1;
      
      private static const const_1122:int = 1000;
      
      private static const const_1594:String = "pet_experience_bubble_png";
      
      private static const const_1595:int = 0;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1044 = [];
         super();
         while(this.var_135.length < ANIMATION_INDEX_COUNT)
         {
            this.var_135.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_135 != null)
         {
            ...
            {
               _loc2_ = this.var_135[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1594) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_391 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2746)
            {
               this.var_2746 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_250);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_166);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_250);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_166);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1848 = _loc3_.getNumber(RoomObjectVariableEnum.const_245) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_204);
            if(!isNaN(_loc8_))
            {
               this.var_2000 = _loc8_;
            }
            else
            {
               this.var_2000 = direction;
            }
            this.var_1421 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2275 = _loc3_.getNumber(RoomObjectVariableEnum.const_449);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_912);
            if(_loc9_ != this.var_2001)
            {
               this.var_2001 = _loc9_;
               this.var_2747 = this.var_2001.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_391 != null)
         {
            ...
            if(this.var_1421 > 0)
            {
               _loc2_ = param1 - this.var_1421;
               if(_loc2_ < const_1122)
               {
                  this.var_391.alpha = int(Math.sin(_loc2_ / const_1122 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_391.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_391.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_705;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_135.length)
         {
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1578 = false;
         var _loc1_:int = this.var_135.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_135[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function updateAnimations(param1:Number) : int
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_135.length)
         {
            _loc5_ = this.var_135[_loc4_];
            if(_loc5_ != null)
            {
      ...
      override protected function getFrameNumber(param1:int, param2:int) : int
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:int = this.var_135.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_135[_loc3_];
            if(_loc4_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_135.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_135[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2747);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_705)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_705))
            {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2000);
         }
         return direction;
      }
      ...
      {
         if(this.var_1044[param1] == null)
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1592)
            {
               this.var_1044[param1] = true;
            }
            else
            {
               this.var_1044[param1] = false;
            }
         }
         return this.var_1044[param1];
      }
   }
}
