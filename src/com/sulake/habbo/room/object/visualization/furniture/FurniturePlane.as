package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_821:Vector3d = null;
      
      private var var_822:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_821 = new Vector3d();
         this.var_821.assign(param2);
         this.var_822 = new Vector3d();
         this.var_822.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != this.var_2628)
         {
            if(!param1)
            {
               this.var_328.assign(this.var_821);
               this.var_327.assign(this.var_822);
            }
            else
            {
               this.var_328.assign(this.var_821);
               this.var_328.mul(this.var_822.length / this.var_821.length);
               this.var_327.assign(this.var_822);
               this.var_327.mul(this.var_821.length / this.var_822.length);
            }
            this.var_1926 = -1;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_106 == null && this.var_1262 != null || this.var_328 == null || this.var_327 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1926)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1542 || _loc4_.y != this.var_2627 || _loc4_.z != this.var_2629 || param1.scale != this.var_1994))
            {
               this.var_1542 = _loc4_.x;
               this.var_2627 = _loc4_.y;
               this.var_2629 = _loc4_.z;
               ...
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_176.z - _loc7_,this.var_131.z - _loc7_,this.var_99.z - _loc7_,this.var_130.z - _loc7_);
               this.var_2630 = _loc8_;
