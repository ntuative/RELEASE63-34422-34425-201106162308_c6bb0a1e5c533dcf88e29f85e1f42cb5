package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1445:String = "shore";
      ...
      {
         if(this.var_2352 == param1 && this.var_2353 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1445)
            {
               this.var_1742 = _loc2_;
               this.var_2352 = param1;
               this.var_2353 = direction;
               return this.var_1742;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1175.indexOf(_loc2_) < 0)
            {
               this.var_1175.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_517 + 2;
         var _loc4_:int = this.var_614 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1743 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_430.length)
         {
            if(this.var_430[_loc5_] == true)
            {
               this.var_1743 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_615[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_615[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_517 == 0 || this.var_614 == 0)
         {
            ...
            this.var_517 = _loc2_.getNumber(RoomObjectVariableEnum.const_376);
            this.var_614 = _loc2_.getNumber(RoomObjectVariableEnum.const_394);
         }
         this.var_430 = [];
         this.var_615 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_517 * 2 + this.var_614 * 2)
         {
            this.var_430.push(false);
            this.var_615.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_517 + 2;
         var _loc2_:int = this.var_614 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(this.var_78 == null || this.var_78.width < param1 || this.var_78.height < param2)
         {
            if(this.var_78 != null)
            {
               this.var_78.dispose();
            }
            this.var_78 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_78,getSize(param3),this.var_430,this.var_615,assetCollection);
      }
