package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1699:String = "branded_image";
      
      private static const const_1700:int = 0;
      
      private static const const_1702:int = 1;
      
      private static const const_1701:int = 2;
      ...
      protected var var_1405:Boolean = false;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1682 = _loc4_.getNumber(RoomObjectVariableEnum.const_623);
                  this.var_1681 = _loc4_.getNumber(RoomObjectVariableEnum.const_530);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_509);
               }
            }
         }
         if(!this.var_1405)
         {
            this.var_1405 = this.checkIfImageReady();
            if(this.var_1405)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_352);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_606);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1699)
         {
