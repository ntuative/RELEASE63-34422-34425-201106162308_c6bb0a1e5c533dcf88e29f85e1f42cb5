package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_2034:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2898:Number = NaN;
      
      private var var_2897:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1347:String = null;
      ...
      private var var_2901:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1632 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1632;
            this.var_1632 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_608 != spriteCount)
         {
            createSprites(this.var_608);
         }
         if(param2)
         {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               if(param2 != this.var_1633)
               {
                  ...
                  _loc4_.color = this.getSpriteColor(param1,param2,this.var_2897);
               ...
               _loc4_.clickHandling = this.var_2791;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_511 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2898)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2897 = _loc3_.getNumber(RoomObjectVariableEnum.const_292);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_346));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1347 = this.getAdClickUrl(_loc3_);
            if(this.var_1347 == null || this.var_1347.indexOf("http") != 0)
            {
               this.var_1347 = null;
            }
            this.var_2791 = this.var_1347 != null;
            this.var_2901 = _loc3_.getNumber(RoomObjectVariableEnum.const_805);
      ...
      {
         if(this.var_2900 != param2 || this.var_2896 != param1)
         {
            this.var_1106 = [];
            this.var_1105 = [];
            this.var_882 = [];
            ...
            this.var_2899 = this.getSize(param1);
      ...
      {
         this.var_608 = param1;
         this.var_1633 = this.var_608 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc3_:String = this.var_1106[param2];
         var _loc4_:Boolean = this.var_1105[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2899;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1633)
            {
      ...
      {
         if(this.var_882[param3] != null)
         {
            return this.var_882[param3];
         }
         if(this._data == null)
         {
            return "";
         ...
         this.var_882[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteAlpha(param1:int, param2:int, param3:int) : int
      {
         if(this.var_887[param3] != null && !this.var_2108)
         {
            return this.var_887[param3];
         }
         if(this._data == null)
         {
            return LayerData.const_631;
         }
      ...
      {
         if(this.var_883[param2] != null)
         {
            return this.var_883[param2];
         }
         if(this._data == null)
         {
         ...
         this.var_883[param2] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         if(this.var_880[param3] != null)
         {
            return this.var_880[param3];
         }
         if(this._data == null)
         {
      ...
      {
         var _loc4_:int = 0;
         if(param3 != this.var_1633)
         {
            if(this.var_884[param3] != null)
            {
         ...
         return Math.ceil(this.var_2901 * (param1 / 2));
      }
      ...
      {
         if(this.var_886[param3] != null)
         {
            return this.var_886[param3];
         }
         if(this._data == null)
         {
         ...
         this.var_886[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteZOffset(param1:int, param2:int, param3:int) : Number
      {
         if(this.var_881[param3] != null)
         {
            return this.var_881[param3];
         }
         if(this._data == null)
         {
