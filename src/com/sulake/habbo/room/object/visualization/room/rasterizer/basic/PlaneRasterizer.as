package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_673:String = "default";
       
      
      private var var_860:IGraphicAssetCollection = null;
      
      private var var_402:Map = null;
      
      private var var_219:Map = null;
      
      private var var_154:Map = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_154 != null)
         {
            ...
            {
               _loc2_ = this.var_154.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_684.length)
            {
               _loc3_ = this.var_684.getWithIndex(_loc1_);
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         _loc1_ = 0;
         while(_loc1_ < this.var_402.length)
         {
            _loc3_ = this.var_402.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
      ...
      private function resetMaterials() : void
      {
         ...
         while(_loc1_ < this.var_402.length)
         {
            _loc2_ = this.var_402.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_402.getValue(param1) as PlaneMaterial;
      }
      
      protected function getPlane(param1:String) : Plane
      {
         return this.var_154.getValue(param1);
      }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(this.var_154.getValue(param1) == null)
         {
            this.var_154.add(param1,param2);
            return true;
         }
         return false;
      }
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = this.var_860.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
      ...
      protected function getGeometry(param1:int, param2:Number, param3:Number) : IRoomGeometry
      {
         ...
         var _loc5_:IRoomGeometry = this.var_684.getValue(_loc4_);
         if(_loc5_ == null)
         {
            _loc5_ = new RoomGeometry(param1,new Vector3d(param2,param3),new Vector3d(-10,0,0));
            this.var_684.add(_loc4_,_loc5_);
         }
         return _loc5_;
      }
