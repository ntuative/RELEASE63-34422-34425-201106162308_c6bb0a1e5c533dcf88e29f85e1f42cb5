package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2210:int = 16777216;
      ...
      private var var_1986:int = 16777216;
      
      private var var_3036:int = 69069;
      
      private var var_3035:int = 5;
      ...
      {
         var _loc1_:int = this.var_3036 * this.var_1985 + this.var_3035;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1986;
         this.var_1985 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1986 * param2);
      }
   }
}
