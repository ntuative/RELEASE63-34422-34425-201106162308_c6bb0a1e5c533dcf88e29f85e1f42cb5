   ...
   public class PlaneVisualization
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_123 != null)
         {
            ...
            {
               _loc2_ = this.var_123[_loc1_] as IDisposable;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_123 != null)
         {
            ...
            while(_loc1_ < this.var_123.length)
            {
               _loc2_ = this.var_123[_loc1_] as PlaneVisualizationLayer;
               _loc3_ = this.var_123[_loc1_] as PlaneVisualizationAnimationLayer;
               if(_loc2_ != null)
               {
                  _loc2_.clearCache();
               }
      ...
      public function setLayer(param1:int, param2:PlaneMaterial, param3:uint, param4:int, param5:int = 0) : Boolean
      {
         ...
         var _loc6_:* = this.var_123[param1] as IDisposable;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
            _loc6_ = null;
      ...
      public function setAnimationLayer(param1:int, param2:XML, param3:IGraphicAssetCollection) : Boolean
      {
         ...
         var _loc4_:* = this.var_123[param1] as IDisposable;
         if(_loc4_ != null)
         {
            _loc4_.dispose();
            _loc4_ = null;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int = 0, param7:int = 0, param8:int = 0, param9:int = 0, param10:Number = 0.0, param11:Number = 0.0, param12:int = 0) : BitmapData
      {
         ...
         if(this.var_33 != null)
         {
            if(this.var_33.width == param2 && this.var_33.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
            {
               if(!this.hasAnimationLayers)
               {
                  if(param1 != null)
                  {
                     param1.copyPixels(this.var_33,this.var_33.rect,new Point(0,0),null,null,false);
                     return param1;
                  }
                  return this.var_33;
               }
         ...
         var _loc13_:int = 0;
         while(_loc13_ < this.var_123.length)
         {
            _loc14_ = this.var_123[_loc13_] as PlaneVisualizationLayer;
            _loc15_ = this.var_123[_loc13_] as PlaneVisualizationAnimationLayer;
            if(_loc14_ != null)
            {
         ...
         if(param1 != null && param1 != this.var_33)
         {
            this.var_33.copyPixels(param1,param1.rect,new Point(0,0),null,null,false);
            return param1;
         }
         return this.var_33;
      }
