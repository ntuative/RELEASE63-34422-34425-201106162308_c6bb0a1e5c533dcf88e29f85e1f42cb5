package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_2002:int = 16777215;
      
      public static const const_1775:int = 13421772;
      
      private static const const_1119:int = 16777215;
      
      private static const const_1120:int = 13421772;
      
      private static const const_1121:int = 10066329;
      
      private static const const_1118:int = 10066329;
      
      public static const const_1804:int = 16777215;
      
      public static const const_1830:int = 13421772;
      
      public static const const_1716:int = 10066329;
      ...
      private var var_840:Rectangle = null;
      
      private var var_563:RoomPlaneBitmapMaskParser = null;
      
      private var var_1470:String = null;
      
      private var _floorType:String = null;
      
      private var var_1469:String = null;
      ...
      private var var_1288:uint = 16777215;
      
      private var var_2736:int = 255;
      
      private var var_2738:int = 255;
      
      private var var_2737:int = 255;
      
      private var var_1992:Boolean = true;
      
      private var var_1289:int = 0;
      
      private var var_1921:int = -1000;
      
      private const const_2326:int = 250;
      
      private var var_1926:int = -1;
      
      private var var_1542:Number = 0.0;
      
      private var var_2627:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_330["null"] = false;
         this.var_330["null"] = true;
         this.var_330["null"] = true;
         this.var_330["null"] = true;
      }
      ...
      private function resetRoomPlanes() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_154.length)
            {
               _loc2_ = this.var_154[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_840 = super.boundingRectangle;
         }
         return new Rectangle(this.var_840.x,this.var_840.y,this.var_840.width,this.var_840.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_154.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_154[_loc2_] as RoomPlane;
            _loc4_ = getSprite(_loc2_);
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               if(_loc3_.type == RoomPlane.const_70 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
               ...
               if(_loc3_.type == RoomPlane.const_70)
               {
                  _loc4_.tag = "plane.wall@" + (_loc2_ + 1);
               }
               else if(_loc3_.type == RoomPlane.const_109)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         {
            this._planeParser.wallThicknessMultiplier = this.var_1531;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1373);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1218);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_70,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_414)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1804;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1830;
               }
               else
               {
                  _loc13_.color = const_1716;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1733)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_70,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_414)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1921 + this.const_2326 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_387.length)
            {
               _loc11_ = this.var_670[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_387[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1992)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2737 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2738 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2736 / 255);
         ...
         var_165 = _loc7_.getUpdateID();
         this.var_1921 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1926)
         {
            this.var_1926 = param1.updateId;
            this.var_840 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1542 || _loc3_.y != this.var_2627 || _loc3_.z != this.var_2629 || param1.scale != this.var_1994))
            {
               this.var_1542 = _loc3_.x;
               this.var_2627 = _loc3_.y;
               this.var_2629 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_165 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1282);
            if(_loc3_ != this.var_1993)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1993 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_940));
            if(_loc4_ != this.var_1288)
            {
               this.var_1288 = _loc4_;
               this.var_2737 = this.var_1288 & 255;
               this.var_2738 = this.var_1288 >> 8 & 255;
               this.var_2736 = this.var_1288 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1180));
            if(_loc5_ != this.var_1992)
            {
               this.var_1992 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_165 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_206);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_233);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_201);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_743));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_735));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_777));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_165 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1254);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1314);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1531))
            {
               this._floorThicknessMultiplier = _loc2_;
               this.var_1531 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_154.length)
         {
            _loc5_ = this.var_154[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_109 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_70 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      {
         if(param1 != this.var_330["null"] || param2 != this.var_330["null"] || param3 != this.var_330["null"])
         {
            this.var_330["null"] = param1;
            this.var_330["null"] = param2;
            this.var_330["null"] = param3;
            this.var_387 = [];
            this.var_670 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_387;
         if(this.var_387.length == 0)
         {
            _loc6_ = this.var_154;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_387.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_109)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_330[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_387.push(_loc12_);
                        this.var_670.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1289;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_154.length)
         {
            _loc3_ = this.var_154[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         while(_loc8_ < this.var_563.maskCount)
         {
            ...
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_154.length)
               {
                  _loc3_ = this.var_154[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_70 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_70 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_269)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_154[_loc18_] as RoomPlane;
