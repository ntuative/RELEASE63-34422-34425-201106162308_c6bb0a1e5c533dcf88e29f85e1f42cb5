package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_803:int = 6;
      
      public static const const_1987:int = const_395;
      ...
      public static const ALIGN_DEFAULT:int = const_134;
      ...
      public function clearCache() : void
      {
         ...
         this.var_658 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_379.length)
         {
            _loc2_ = this.var_379[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_379.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_379[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_379[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_33 != null)
            {
               if(this.var_33.width == param2 && this.var_33.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_658,param6,param7);
                     return param1;
                  }
                  return this.var_33;
               }
         ...
         else if(this.var_33 != null)
         {
            if(this.var_33.width == param2 && this.var_33.height == param3)
            {
               this.var_33.fillRect(this.var_33.rect,16777215);
            }
            else
            {
               this.var_33.dispose();
         ...
         if(!param5)
         {
            ...
            if(this.var_33 == null)
            {
               this.var_33 = new BitmapData(param2,param3,true,4294967295);
            }
            else
            {
               this.var_33.fillRect(this.var_33.rect,4294967295);
            }
            if(param1 != null)
            {
         ...
         {
            this.var_658 = param3;
            this.var_33 = new BitmapData(param2,param3,true,16777215);
         }
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_379.length)
         {
            _loc11_ = this.var_379[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
         ...
         var _loc10_:int = 0;
         switch(this.var_1931)
         {
            case const_246:
               _loc10_ = this.renderRepeatBorders(this.var_33,_loc8_);
               break;
            case const_253:
               _loc10_ = this.renderRepeatCenter(this.var_33,_loc8_);
               break;
            case const_299:
               _loc10_ = this.renderRepeatFirst(this.var_33,_loc8_);
               break;
            case const_281:
               _loc10_ = this.renderRepeatLast(this.var_33,_loc8_);
               break;
            case const_803:
               _loc10_ = this.renderRepeatRandom(this.var_33,_loc8_);
               break;
            default:
               _loc10_ = this.renderRepeatAll(this.var_33,_loc8_);
         }
         this.var_658 = _loc10_;
         if(param1 != null)
         {
      ...
      {
         if(param1 == null || this.var_33 == null || param1 == this.var_33)
         {
            return;
         }
         if(!param4)
         ...
         var _loc5_:* = null;
         if(this._align == const_134)
         {
            _loc5_ = new Rectangle(0,0,this.var_33.width,this.var_658);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_33.height - this.var_658,this.var_33.width,this.var_658);
         }
         param1.copyPixels(this.var_33,_loc5_,new Point(0,param3),null,null,true);
      }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_379.length == 1)
         {
            _loc4_ = this.var_379[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
