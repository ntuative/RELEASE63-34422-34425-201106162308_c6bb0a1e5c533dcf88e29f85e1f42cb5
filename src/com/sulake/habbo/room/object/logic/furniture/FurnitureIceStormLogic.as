   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2519 = param1.extra;
            this.var_1233 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1233 > 0 && param1 >= this.var_1233)
         {
            this.var_1233 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1836,String(this.var_1836),this.var_2519);
