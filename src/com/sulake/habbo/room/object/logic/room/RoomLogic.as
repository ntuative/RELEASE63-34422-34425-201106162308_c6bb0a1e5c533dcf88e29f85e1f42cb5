package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1783:int = 255;
      
      private var var_1465:uint = 16777215;
      
      private var var_1786:int = 255;
      
      private var var_1196:uint = 16777215;
      
      private var var_1785:int = 255;
      
      private var var_1197:int = 0;
      
      private var var_1784:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_601,RoomObjectMouseEvent.const_174];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1373,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_940,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_743,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_735,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_777,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1197)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1783;
            if(_loc2_ - this.var_1197 >= this.var_1784)
            {
               _loc3_ = this.var_1196;
               _loc4_ = this.var_1785;
               this.var_1197 = 0;
            }
            else
            {
               _loc7_ = this.var_1465 >> 16 & 255;
               _loc8_ = this.var_1465 >> 8 & 255;
               _loc9_ = this.var_1465 & 255;
               _loc10_ = this.var_1196 >> 16 & 255;
               _loc11_ = this.var_1196 >> 8 & 255;
               _loc12_ = this.var_1196 & 255;
               _loc13_ = (_loc2_ - this.var_1197) / this.var_1784;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1786 + (this.var_1785 - this.var_1786) * _loc13_;
               this._color = _loc3_;
               this.var_1783 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_940,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_918:
               param2.setString(RoomObjectVariableEnum.const_233,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_870:
               param2.setString(RoomObjectVariableEnum.const_206,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_808:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_493:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_269)
               {
                  _loc5_ = "null";
               }
               this.var_563.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_930:
               _loc4_ = this.var_563.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_563.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1282,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1168:
               param2.setNumber(RoomObjectVariableEnum.const_743,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1374:
               param2.setNumber(RoomObjectVariableEnum.const_735,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_777,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_696:
               param2.setNumber(RoomObjectVariableEnum.const_1254,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1387:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1180,int(param1.bgOnly));
         this.var_1465 = this._color;
         this.var_1786 = this.var_1783;
         this.var_1196 = _loc3_;
         this.var_1785 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_636,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1749,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1923,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1949,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_636,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_266 || _loc12_ == RoomPlaneData.const_414)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
