package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_760:String = "RCL_LOADER_READY";
      
      private static const const_384:String = "RCL_PUBLICROOM_";
      
      private static const const_2068:int = 0;
      
      private static const const_1129:int = 1;
      
      private static const name_5:int = 2;
      
      private static const const_480:String = "place_holder";
      
      private static const const_716:String = "wall_place_holder";
      
      private static const const_715:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_480;
      
      private static const const_717:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1144:String = "selection_arrow";
      ...
      private var var_1628:IEventDispatcher = null;
      ...
      private var var_704:Map = null;
      
      private var _wallItems:Dictionary;
      
      private var var_1100:Map = null;
      
      private var _pets:Dictionary;
      
      private var var_1099:Map = null;
      
      private var var_231:PublicRoomData = null;
      
      private var var_1627:Map = null;
      
      private var var_703:Map = null;
      
      private var var_578:Map = null;
      
      private var var_576:Map = null;
      
      private var var_876:Map = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2883 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2881 = ["room_public","room_public_park","room_public_pool"];
         super();
         ...
         this.var_875 = new Map();
         this.var_1627 = new Map();
      }
      ...
      {
         if(this._state >= const_1129)
         {
            return;
         }
         this.var_1628 = param1;
         this.var_2882 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2884 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_1100.add(_loc2_,_loc3_);
            _loc2_++;
         }
         this.var_1099 = new Map();
      }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_394.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_577.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_577.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_483 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_483.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_876.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_482.add(_loc3_,_loc4_);
               if(this.var_410[_loc7_] == null)
               {
                  this.var_410[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_704.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_703.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_703.remove(_loc7_);
               this.var_703.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2880)
         {
            ...
            {
               this.var_1628.dispatchEvent(new Event(const_760));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_578 != null)
         {
            this.var_578.remove(param1);
            this.var_578.add(param1,param2);
         }
         if(this.var_576 != null)
         {
            this.var_576.remove(param2);
            this.var_576.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_578 != null)
         {
            _loc2_ = this.var_578.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_576 != null)
         {
            _loc2_ = this.var_576.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_231 != null && (this.var_231.type == param1 || this.var_231.hasWorldType(param1)))
         {
      ...
      {
         return [const_480,const_716,const_715,const_717,TILE_CURSOR,const_1144];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_482.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_704.getValue(param1) as String;
      ...
      {
         return this.var_1100.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1099[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_704.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_876.getValue(param1) != null)
         {
            return this.var_876.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_231 != null && this.var_231.hasWorldType(const_384 + param1))
         {
            return this.var_231.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_286 || param1 == RoomObjectVisualizationEnum.const_57 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_703.getValue(param1));
         }
         return 0;
      }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc4_:String = this.method_12(param3);
         switch(param2)
         {
            case RoomObjectCategoryEnum.const_27:
               this.var_482[param1] = _loc4_;
               break;
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_410[_loc4_] == null)
                     {
                        this.var_410[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_390,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1627.getValue(param1) != null)
         {
            this.var_231 = this.var_1627.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_880,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2883.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1768);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         var _loc5_:String = this.method_12(_loc2_);
         ...
         if(_loc4_)
         {
            if(this.var_2881.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_390,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_626,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1099.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1627.add(param1,_loc4_);
         this.var_231 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_875.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_875.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_577.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_875.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_577.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_577.add(_loc5_,_loc4_);
      ...
      private function method_12(param1:IAssetLibrary) : String
      {
         if(param1 == null)
         {
            return null;
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_513.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_483.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_483.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_483[_loc2_] != null)
         {
            _loc3_ = this.var_483.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_384 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_384 + param1) == RoomObjectCategoryEnum.const_85)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_231.getWorldHeightScale(const_384 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_231 != null)
         {
            return this.var_231.getWorldScale(const_384 + param1);
         }
         return 32;
      }
