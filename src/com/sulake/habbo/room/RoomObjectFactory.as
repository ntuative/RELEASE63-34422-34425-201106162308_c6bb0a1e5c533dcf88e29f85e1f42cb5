package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      private var var_1348:Map;
      
      private var var_1108:Array;
      
      public function RoomObjectFactory(param1:IContext, param2:uint = 0)
      {
         this.var_2110 = new Map();
         this.var_1348 = new Map();
         this.var_1108 = [];
         super(param1,param2);
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1108.indexOf(param1) < 0)
         {
            this.var_1108.push(param1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1348.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_1108.indexOf(param1);
         if(_loc3_ >= 0)
         {
            this.var_1108.splice(_loc3_,1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1348.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1348.getValue(param1) == null)
         {
            this.var_1348.add(param1,true);
            for each(_loc2_ in this.var_1108)
            {
               if(_loc2_ != null)
               {
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectLogicEnum.const_1933:
               ...
               break;
            case RoomObjectLogicEnum.const_1996:
               _loc2_ = FurnitureJukeboxLogic;
               break;
            case RoomObjectLogicEnum.const_1950:
               _loc2_ = FurnitureSongDiskLogic;
               break;
            case RoomObjectLogicEnum.const_2012:
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_2110.getValue(param1) == null)
            {
               this.var_2110.add(param1,true);
