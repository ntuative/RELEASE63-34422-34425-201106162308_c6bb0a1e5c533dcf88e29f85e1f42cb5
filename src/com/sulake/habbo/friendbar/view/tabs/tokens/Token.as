package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static var var_1407:IHabboWindowManager;
      
      protected static var var_1408:IAssetLibrary;
      
      protected static const ICON:String = "icon";
      
      protected static const const_2022:String = "title";
      ...
      protected var var_1390:FriendNotification;
      ...
      {
         return this.var_1390.typeCode;
      }
      
      public function get viewOnce() : Boolean
      {
         return this.var_1390.viewOnce;
      }
      ...
      {
         var _loc7_:* = null;
         this._window = var_1407.buildFromXML(var_1408.getAssetByName(param3).content as XML) as IWindowContainer;
         this._window.findChildByName(const_2022).caption = param1;
         this._window.findChildByName(const_1061).caption = !!param2 ? param2 : "";
         ...
         this._icon = var_1407.create("ICON_" + this.typeCode,WindowType.const_362,WindowStyle.const_102,WindowParam.const_31,Token.const_1393) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1407.create("BITMAP_" + this.typeCode,WindowType.const_431,WindowStyle.const_102,WindowParam.const_189,Token.const_1393) as IBitmapWrapperWindow;
