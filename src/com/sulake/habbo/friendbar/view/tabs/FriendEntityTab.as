package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1614:String = "facebook_piece_xml";
      
      private static const const_1612:String = "controls_piece_xml";
      
      protected static const PIECES:String = "pieces";
      
      protected static const const_379:String = "icons";
      
      protected static const const_462:String = "header";
      
      protected static const const_1406:String = "facebook";
      
      protected static const const_1404:String = "controls";
      
      protected static const const_312:String = "canvas";
      
      protected static const const_695:String = "name";
      
      protected static const const_1061:String = "btn_message";
      
      protected static const const_1026:String = "icon_message";
      
      protected static const const_1405:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1022:String = "label";
      
      protected static const const_630:String = "notification";
      
      private static const const_78:uint = 10338138;
      
      private static const const_1066:uint = 13891476;
      
      private static const const_1126:String = null;
      
      private static const const_707:String = "icon_tag_notify";
      
      private static const const_1613:String = "icon_tag_message";
      
      private static const POOL:Vector.<FriendEntityTab> = new Vector.<FriendEntityTab>();
      
      private static const const_477:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
       
      
      protected var var_164:IFriendEntity;
      
      protected var var_142:Vector.<Token>;
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         _loc3_ = _loc2_.getListItemByName(const_1404) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_630,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function recycle() : void
      {
         if(!disposed)
         {
            if(!var_163)
            {
               ...
               if(this.var_142)
               {
                  while(this.var_142.length > 0)
                  {
                     this.var_142.pop().dispose();
                  }
                  this.var_142 = null;
               }
               this.var_164 = null;
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1614).content as XML) as IWindowContainer;
               _loc3_.name = const_1406;
               _loc6_ = _loc3_.getChildByName(const_695) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2174.crop(_loc6_);
               }
            ...
            if(this.var_142)
            {
               for each(_loc7_ in this.var_142)
               {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1612).content as XML) as IWindowContainer;
               _loc3_.name = const_1404;
               _loc8_ = _loc3_.getChildByName(const_1061);
               if(_loc8_)
               {
                  _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClick);
               }
               _loc8_ = _loc3_.getChildByName(const_1405);
               if(_loc8_)
               {
      ...
      override public function deselect(param1:Boolean) : void
      {
         ...
         if(selected)
         {
            if(_window)
            {
               ...
               if(this.var_142)
               {
                  _loc2_ = this.var_142.length - 1;
                  while(_loc2_ > -1)
                  {
                     _loc3_ = this.var_142[_loc2_];
                     if(_loc3_.viewOnce)
                     {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_164)
         {
            _window.id = this.var_164.id;
            _loc1_ = IItemListWindow(_window.getChildByName(PIECES)).getListItemByName(const_462) as IWindowContainer;
            _loc1_.findChildByName(const_695).caption = this.var_164.name;
            var_2174.crop(_loc1_.getChildByName(const_695) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_312));
            _loc2_.bitmap = var_499.getAvatarFaceBitmap(this.var_164.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_477.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1611).content as XML) as IWindowContainer;
         ...
         var _loc4_:IWindow = _loc1_.findChildByName(const_379);
         _loc1_.x = 0;
         _loc1_.y = 0;
         _loc1_.width = name_2;
      ...
      private function releaseFriendTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_ = param1.findChildByName(const_379);
            ...
            _loc4_ = IBitmapWrapperWindow(param1.findChildByName(const_312));
            _loc4_.bitmap = null;
            ITextWindow(param1.findChildByTag("label")).underline = false;
            purgeEntityPieces(param1);
            if(const_477.indexOf(param1) == -1)
            {
               const_477.push(param1);
            }
         }
      }
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1061:
               case const_1026:
                  this.removeNotificationToken(FriendNotification.const_428,true);
                  if(var_348 && this.var_164)
                  {
                     var_348.startConversation(this.var_164.id);
                     this.deselect(true);
                     if(param1.window.name == const_1026)
                     {
               ...
               case const_1405:
                  if(var_348 && this.var_164)
                  {
                     var_348.followToRoom(this.var_164.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1126;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1198:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2194);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_707;
               break;
            case FriendNotification.const_1207:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2194);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_707;
               break;
            case FriendNotification.const_428:
               _loc4_ = new MessengerToken(this.friend,param1,param2);
               _loc4_.iconElement.name = const_1026;
         ...
         if(_loc4_)
         {
            ...
            if(_loc5_ != const_1126)
            {
               _loc7_ = IItemListWindow(_window.findChildByName(const_379));
      ...
      public function removeNotificationToken(param1:int, param2:Boolean) : void
      {
         ...
         var _loc3_:int = this.var_142.length - 1;
         while(_loc3_ > -1)
         {
            _loc4_ = this.var_142[_loc3_];
            if(_loc4_.typeCode == param1)
            {
               this.var_142.splice(_loc3_,1);
               if(param2)
               {
                  this.var_164.notifications.splice(this.var_164.notifications.indexOf(_loc4_.notification),1);
               }
               _loc4_.dispose();
               return;
            }
      ...
      {
         return getQualifiedClassName(this) + " " + this.var_164.name;
      }
   }
}
