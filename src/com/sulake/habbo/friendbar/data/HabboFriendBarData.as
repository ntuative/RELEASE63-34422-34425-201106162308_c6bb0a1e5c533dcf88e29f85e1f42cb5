package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1135:Boolean = false;
      
      private static const const_710:String = "Navigation";
      
      private static const const_709:String = "Friend Bar";
      
      private static const const_1622:String = "go.friendbar";
      
      private static const const_1621:String = "chat_btn_click";
      
      private static const const_1619:String = "find_friends_btn_click";
      
      private static const const_1133:String = "Toolbar";
      
      private static const const_1132:String = "open";
      
      private static const const_1134:String = "close";
      
      private static const const_1620:String = "FRIENDLIST";
      
      private static const const_1623:String = "MESSENGER";
       
      
      private var var_1077:IHabboConfigurationManager;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1077)
            {
               this.var_1077.release(new IIDHabboConfigurationManager());
               this.var_1077 = null;
            }
            if(this.var_93)
            {
            ...
            if(this.var_90)
            {
               ...
               {
                  this.var_90.events.removeEventListener(FriendRequestEvent.const_60,this.onFriendRequestEvent);
                  this.var_90.events.removeEventListener(FriendRequestEvent.const_215,this.onFriendRequestEvent);
               }
      ...
      {
         return !!this.var_121 ? int(this.var_121.length) : 0;
      }
      
      public function getFriendRequestAt(param1:int) : FriendRequest
      {
         return !!this.var_121 ? this.var_121[param1] : null;
      }
      ...
      public function getFriendRequestByID(param1:int) : FriendRequest
      {
         ...
         if(this.var_121)
         {
            for each(_loc2_ in this.var_121)
            {
               if(_loc2_.id == param1)
               {
                  return _loc2_;
      ...
      private function removeFriendRequest(param1:int) : void
      {
         ...
         if(this.var_121)
         {
            for each(_loc2_ in this.var_121)
            {
               if(_loc2_.id == param1)
               {
                  this.var_121.splice(this.var_121.indexOf(_loc2_),1);
                  events.dispatchEvent(new FriendRequestUpdateEvent());
                  return;
               }
            }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_710,const_709,const_1622));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_227)
         {
            ...
            if(this.var_93)
            {
               this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_710,const_709,const_1621));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_710,const_709,const_1619));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_90)
         {
            if(!this.var_90.disposed)
            {
               ...
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1133,const_1620,!!this.var_90.isOpen() ? const_1132 : const_1134));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_227)
         {
            if(!this.var_227.disposed)
            {
               ...
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1133,const_1623,!!this.var_227.isOpen() ? const_1132 : const_1134));
               }
            }
         }
      }
      ...
      {
         this.var_1077 = param2 as IHabboConfigurationManager;
         this.var_2848 = this.var_1077.getBoolean("friendbar.notifications.enabled",false);
         this.var_2071 = this.var_1077.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_90.events.addEventListener(FriendRequestEvent.const_60,this.onFriendRequestEvent);
         this.var_90.events.addEventListener(FriendRequestEvent.const_215,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_114 = !!const_316 ? this.sortByNameAndOnlineStatus(this.var_114) : this.sortByName(this.var_114);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewFriendRequest(param1:NewBuddyRequestEvent) : void
      {
         ...
         if(this.var_2071)
         {
            ...
            this.var_121.push(new FriendRequest(_loc2_.requestId,_loc2_.requesterName,_loc2_.figureString));
            events.dispatchEvent(new FriendRequestUpdateEvent());
         }
      }
      ...
      private function onFriendRequestList(param1:BuddyRequestsEvent) : void
      {
         ...
         if(this.var_2071)
         {
            ...
            {
               this.var_121.push(new FriendRequest(_loc3_.requestId,_loc3_.requesterName,_loc3_.figureString));
            }
            events.dispatchEvent(new FriendRequestUpdateEvent());
         }
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_859));
            this.makeNotification(String(this.var_859),FriendNotification.const_428,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_859));
            this.makeNotification(String(this.var_859),FriendNotification.const_428,null,true,false);
         }
      }
