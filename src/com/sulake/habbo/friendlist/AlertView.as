package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_617[this.var_1126]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var_617[this.var_1126] = this._alert;
      }
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(this._friendList.getXmlWindow(this.var_1126));
