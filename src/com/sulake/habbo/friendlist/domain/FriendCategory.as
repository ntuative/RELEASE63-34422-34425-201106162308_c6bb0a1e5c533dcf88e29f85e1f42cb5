package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_427:int = 100;
      ...
      {
         var _loc4_:* = null;
         if(this.var_249.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_249[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_249.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in this.var_249)
         {
            if(_loc2_.selected)
            {
               param1.push(_loc2_);
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_249)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_249,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_1020 >= this.getPageCount())
         {
            this.var_1020 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_249.length / const_427);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_1020 * const_427;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_1020 + 1) * const_427,this.var_249.length);
      }
