package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1521:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1891:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1891 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1521;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1024 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_280 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1891.prepare(this.var_1024);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1250,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1205,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_907,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_815,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_907,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_815,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1520 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1520.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1893 == -1 ? 0 : int(this.var_17.height - this.var_1893);
         var _loc4_:int = this.var_1894 == -1 ? 0 : int(this.var_17.width - this.var_1894);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_280.y = Util.getLowestPoint(this.var_17.content);
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1237,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_907,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1250,false);
         ...
         this.var_1893 = this.var_17.height;
         this.var_1894 = this.var_17.width;
