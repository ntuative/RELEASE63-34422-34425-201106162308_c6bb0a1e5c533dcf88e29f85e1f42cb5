package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_184:String = "face";
      ...
      private var var_153:IHabboMessenger;
      ...
      private var var_756:ISessionDataManager;
      
      private var var_2341:FriendListLookAndFeel;
      
      private var var_447:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1738:OpenedToWebPopup;
      
      private var var_2260:int;
      
      var var_115:FriendCategories;
      
      private var var_121:FriendRequests;
      
      private var var_1739:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1015:IHabboNotifications;
      ...
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_115 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1739 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_613.stop();
            this.var_613.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_613 = null;
         }
         ...
         if(this.var_153)
         {
            this.var_153.release(new IIDHabboMessenger());
            this.var_153 = null;
         }
         if(this.var_179)
         {
         ...
         if(this.var_1015)
         {
            this.var_1015.release(new IIDHabboNotifications());
            this.var_1015 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_756)
         {
            this.var_756.release(new IIDSessionDataManager());
            this.var_756 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1738 = new OpenedToWebPopup(this);
         }
         this.var_1738.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_115.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_115);
      }
      
      public function openFriendRequests() : void
      {
         this.openFriendListWithTab(FriendListTab.const_90);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_455);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_115.getFriendCount(param1,param2);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_369,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_759.createAvatarImage(param1,AvatarScaleType.const_117,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_179.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_179.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_153 = param2 as IHabboMessenger;
      ...
      {
         this.var_1015 = param2 as IHabboNotifications;
      ...
      {
         this.var_756 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_121 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_115.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_115.addCategory(new FriendCategory(FriendCategory.const_1390,this.getText("friendlist.friends")));
         this.var_115.addCategory(new FriendCategory(FriendCategory.const_411,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_115.addFriend(new Friend(_loc4_));
         }
         this.var_447 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_613)
         {
            this.var_613 = new Timer(120000);
            this.var_613.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_613.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         if(this.var_115.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_115.findCategory(FriendCategory.const_411);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_121.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_121.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_447.findTab(FriendListTab.const_90).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_121.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_447.findTab(FriendListTab.const_90);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1739.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_115.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_115.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_447.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_447.findTab(FriendListTab.const_90);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_756 || !this.var_121)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_756.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this.var_121.vipLimit;
         }
         else if(this.var_756.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_38))
         {
            _loc2_ = this.var_121.clubLimit;
         }
         if(_loc2_ > this.var_121.limit)
         {
            this.var_121.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_115 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_115.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_184) as IBitmapWrapperWindow;
