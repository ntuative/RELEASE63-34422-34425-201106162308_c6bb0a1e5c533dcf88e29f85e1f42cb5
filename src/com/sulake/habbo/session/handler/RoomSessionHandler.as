   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      private function onFlatAccessible(param1:FlatAccessibleMessageEvent) : void
      {
         ...
         else if(listener && false)
         {
            ...
            if(_loc6_ != null)
            {
               listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_60,_loc6_,_loc5_));
            }
         }
      }
      ...
      private function onFlatAccessDenied(param1:FlatAccessDeniedMessageEvent) : void
      {
         ...
         else if(listener && false)
         {
            ...
            if(_loc6_ != null)
            {
               listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_167,_loc6_,_loc5_));
            }
         }
      }
      ...
      private function onYouAreSpectator(param1:YouAreSpectatorMessageEvent) : void
      {
         ...
         var _loc2_:IRoomSession = listener.getSession(_xxxRoomId,var_25);
         if(_loc2_ == null)
         {
            return;
         }
