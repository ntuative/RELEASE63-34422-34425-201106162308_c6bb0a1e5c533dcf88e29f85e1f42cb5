      ...
      private function onPlaceObjectError(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.errorCode)
         {
            case PlaceObjectErrorEnum.const_274:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_295:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_296:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_231:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_277:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_284:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_289:
               _loc4_ = "null";
               break;
            default:
               return;
