package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_3046:Array;
      
      private var var_2105:GroupDetailsView;
      ...
      private var var_706:ProductDataParser;
      ...
      private var var_339:FurnitureDataParser;
      
      private var var_2104:UserTagManager;
      
      private var var_1342:BadgeImageManager;
      
      private var var_1343:HabboGroupInfoManager;
      
      private var var_1102:IgnoredUsersManager;
      ...
      private var var_1346:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_3046 = [];
         this.var_2104 = new UserTagManager(events);
         this.var_1343 = new HabboGroupInfoManager(this,events);
         this.var_1102 = new IgnoredUsersManager(this);
         this.var_1346 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_339)
         {
            this.var_339.removeEventListener(FurnitureDataParser.const_124,this.onFurnitureReady);
            this.var_339.dispose();
            this.var_339 = null;
         }
         if(this.var_706)
         {
            this.var_706.removeEventListener(ProductDataParser.const_124,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         if(this.var_179 == null || this._localization == null)
         {
            return;
         }
         this.var_1342 = new BadgeImageManager(context.root.assets,events,this.var_179,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_2104.communication = this._communication;
         this.var_1343.communication = this._communication;
         this.var_1346.communication = this._communication;
         this.var_1102.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_339)
         {
            ...
            this.var_339 = new FurnitureDataParser(this.var_579,this._wallItems,this.var_580,this._localization);
            this.var_339.addEventListener(FurnitureDataParser.const_124,this.onFurnitureReady);
            if(this.var_179.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_179.getKey("furnidata.load.url");
               this.var_339.loadData(_loc3_);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(this.var_339)
         {
            this.var_339.localization = this._localization;
            this.var_339.registerFurnitureLocalizations();
         }
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2101 = _loc2_.clubLevel;
         this.var_2103 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2546 = _loc3_.respectTotal;
         this.var_1345 = _loc3_.respectLeft;
         this.var_878 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_1109 = _loc3_.sex;
         this.var_1693 = _loc3_.realName;
         this.var_2547 = _loc3_.identityId;
         this.var_1102.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            this.var_1109 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_1109));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2886 = _loc2_.isOpen;
         this.var_2887 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_2103 >= SecurityLevelEnum.const_1156;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_2104.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1342.getBadgeImage(param1);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1342.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_2105 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1343.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_2105.showGroupDetails(param1);
         }
      }
      ...
      {
         return this.var_1342.getBadgeImage(param1,BadgeImageManager.const_1304);
      }
      ...
      {
         return this.var_1102.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_1102.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1102.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1345 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1345 = this.var_1345 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_579.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_580.getValue(param1);
      ...
      public function openHabboHomePage(param1:int) : void
      {
         ...
         {
            urlString = this.var_179.getKey("link.format.userpage");
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1344.indexOf(param1) == -1)
         {
         ...
         {
            _loc2_ = this.var_179.getKey("productdata.load.url");
            this.var_706 = new ProductDataParser(_loc2_,this.var_1299);
            this.var_706.addEventListener(ProductDataParser.const_124,this.onProductsReady);
         }
         return false;
      }
      ...
      private function onProductsReady(param1:Event) : void
      {
         ...
         this.var_706.removeEventListener(ProductDataParser.const_124,this.onProductsReady);
         this.var_2102 = true;
         for each(_loc2_ in this.var_1344)
         {
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         {
            if(this.var_1101.indexOf(param1) == -1)
            {
               this.var_1101.push(param1);
            }
            return null;
         }
         var _loc2_:Array = this.var_579.getValues();
