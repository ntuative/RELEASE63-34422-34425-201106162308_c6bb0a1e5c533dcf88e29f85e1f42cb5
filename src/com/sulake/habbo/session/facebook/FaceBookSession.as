package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1058:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1498:String = "sendAccessTokenToServer";
      
      private static const const_1499:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1498,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1499,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1058);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1058);
         }
      }
