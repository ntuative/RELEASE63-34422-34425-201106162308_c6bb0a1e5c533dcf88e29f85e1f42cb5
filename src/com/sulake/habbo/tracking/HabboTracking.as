package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1123:uint = 11;
      ...
      private var var_225:IHabboFriendList;
      
      private var var_1307:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_203:IHabboHelp;
      
      private var var_1595:Array;
      
      private var _crashed:Boolean = false;
      
      private var var_291:PerformanceTracker = null;
      
      private var var_473:FramerateTracker = null;
      
      private var var_290:LatencyTracker = null;
      
      private var var_679:LagWarningLogger = null;
      
      private var var_472:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_291 = new PerformanceTracker();
         this.var_473 = new FramerateTracker();
         this.var_290 = new LatencyTracker();
         this.var_679 = new LagWarningLogger();
         this.var_472 = new ToolbarClickTracker(this);
         this.var_1595 = new Array(const_1123);
         var _loc4_:int = 0;
         while(_loc4_ < const_1123)
         {
            this.var_1595[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1994,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1811,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1708,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_764,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1212,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1307)
            {
               this.var_1307.release(new IIDHabboWindowManager());
               this.var_1307 = null;
            }
            if(this.var_335)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_370,this.onZoomToggle);
               }
            ...
            if(this.var_225)
            {
               ...
               {
                  Component(this.var_225).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_225).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_225).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_225).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_225).events.removeEventListener(HabboFriendListTrackingEvent.const_592,this.onFriendlistTrackingEvent);
               }
               this.var_225.release(new IIDHabboFriendList());
               this.var_225 = null;
            }
            if(this.var_203)
            {
               ...
               {
                  this.var_203.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_203.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_203.release(new IIDHabboHelp());
               this.var_203 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_182,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_347,this.onRoomAction);
               }
            ...
            {
               this.var_333.stop();
               this.var_333.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_333 = null;
            }
      ...
      {
         this.var_1595[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_179 = IHabboConfigurationManager(param2);
         if(this.var_179)
         {
            if(this.var_290 != null)
            {
               this.var_290.configuration = this.var_179;
            }
            if(this.var_291 != null)
            {
               this.var_291.configuration = this.var_179;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1985);
            if(this.var_179)
            {
               if(this.var_679 != null)
               {
                  this.var_679.configure(this.var_179);
               }
               if(this.var_473 != null)
               {
                  this.var_473.configure(this.var_179);
               }
               if(this.var_472 != null)
               {
                  this.var_472.configure(this.var_179);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_839,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_242,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_982,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_79,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_500,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_291 != null)
            {
               this.var_291.connection = param1;
            }
            if(this.var_290 != null)
            {
               this.var_290.communication = this._communication;
               this.var_290.connection = param1;
            }
            if(this.var_679 != null)
            {
               this.var_679.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_982)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1849);
         }
         else if(param1.type == HabboHotelViewEvent.const_500)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1924);
         }
         else if(param1.type == HabboHotelViewEvent.const_79)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1823);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1725);
               break;
            case HabboCommunicationEvent.const_839:
               this.trackLoginStep(HabboLoginTrackingStep.const_1960,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_242:
               this.trackLoginStep(HabboLoginTrackingStep.const_242);
               break;
      ...
      {
         this.var_1307 = IHabboWindowManager(param2);
         if(this.var_1307)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_179)
            {
               if(this.var_179.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_179.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1595)
                  {
                  ...
                  if(this.var_291 != null)
                  {
                     _loc4_["null"] = this.var_291.flashVersion;
                     _loc4_["null"] = this.var_291.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1306);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1306,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_370,this.onZoomToggle);
      }
      ...
      {
         this.var_225 = param2 as IHabboFriendList;
         Component(this.var_225).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_225).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_225).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_225).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_225).events.addEventListener(HabboFriendListTrackingEvent.const_592,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_592:
      ...
      {
         this.var_203 = param2 as IHabboHelp;
         this.var_203.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_203.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2797)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1946);
            this.var_2797 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1212,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_764,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_182,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_347,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_335 = param2 as IAdManager;
         this.var_335.events.addEventListener(AdEvent.const_572,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_182)
         {
            if(this.var_2031 < 1)
            {
               if(!this.var_333)
               {
                  this.var_333 = new Timer(60000,1);
                  this.var_333.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_333.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_347)
         {
            if(this.var_333)
            {
               this.var_333.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_473)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_473.frameRate),_loc2_);
                  ++this.var_2031;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_472)
         {
            this.var_472.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_472)
         {
            this.var_472.track(param1.type);
         }
      }
      ...
      {
         if(this.var_179 != null && !Boolean(this.var_179.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_679.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_2030;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2030);
         }
         this.var_568 = _loc2_;
         if(this.var_291 != null)
         {
            this.var_291.update(param1,this.var_568);
         }
         if(this.var_290 != null)
         {
            this.var_290.update(param1,this.var_568);
         }
         if(this.var_473 != null)
         {
            this.var_473.trackUpdate(param1,this,this.var_568);
         }
         if(this.var_679 != null)
         {
            this.var_679.update(this.var_568);
         }
      }
   }
}
