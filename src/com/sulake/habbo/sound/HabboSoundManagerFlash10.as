package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1565:int = 60;
      
      private static const const_1566:int = 25165823;
      
      private static const const_1567:int = 16777215;
      ...
      private var var_1014:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1010,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1013.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1363:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1954:
               ...
               case HabboSoundTypesEnum.SOUND_MESSAGE_SENT:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1277:
                  _loc3_ = "sound_catalogue_pixels";
                  break;
               case HabboSoundTypesEnum.const_1208:
            ...
            this.var_1013.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_1014;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_179.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_179.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_661.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1267.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_283,events);
         _loc5_.volume = this.var_1014;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_283.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1015.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_179.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2649 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1015 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_179 == null || this._connection == null || this._roomEngine == null || this.var_239 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1813,this.var_826));
         this.var_826 = -1;
         this.var_827 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_1014 * 100)));
         }
      }
      ...
      private function updateVolumeSetting(param1:Number) : void
      {
         ...
         this.var_239.updateVolume(this.var_1014);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_661.getValue(param1) != null)
         {
            _loc2_ = this.var_661.remove(param1);
            if(this.var_283.getValue(_loc2_) == null)
            {
               this.var_1547.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1547,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1547,_loc2_,TraxSample.const_1732,TraxSample.const_1826);
               this.var_283.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1266.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1565 && this.var_1266.length > 0)
            {
               _loc3_ = this.var_1266.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_661.length == 0 && this.var_826 != -1)
            {
               this.var_827.ready = true;
               _loc4_ = this.var_826;
               this.var_826 = -1;
               this.var_827 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1010,_loc4_));
               if(this.var_2649)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_827 == null && this.var_1267.length > 0)
         {
            _loc1_ = this.var_1267.getKey(0);
            _loc2_ = this.var_1267.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1010,_loc1_));
               }
               else
               {
                  this.var_827 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         {
            _loc5_ = this.var_283.getKey(_loc4_);
            _loc6_ = this.var_283.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1566)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1567 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_283.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_283.remove(_loc11_);
               }
