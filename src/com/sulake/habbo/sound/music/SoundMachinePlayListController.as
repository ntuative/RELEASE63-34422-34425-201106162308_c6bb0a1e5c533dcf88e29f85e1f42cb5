package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_239:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_239 = param2;
         this.var_895 = [];
         this.var_895.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_895.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_895)
         {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_819,this.onSoundMachinePlayEvent);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_780,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_819,this.onSoundMachinePlayEvent);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_780,this.onSoundMachineStopEvent);
               this.var_92 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_494 == param1)
         {
            this.playCurrentSongAndNotify(this.var_494);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_239.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_494 = -1;
         this.var_720 = false;
         this.var_239.stop(HabboMusicPrioritiesEnum.const_125);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_239.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_239.playSong(param1,HabboMusicPrioritiesEnum.const_125,_loc3_,0,0,0))
         {
