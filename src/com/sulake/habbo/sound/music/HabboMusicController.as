package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1578:int = HabboMusicPrioritiesEnum.const_125;
      ...
      private var var_92:IEventDispatcher;
      ...
      private var var_560:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_895.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_895.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_895)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_727,this.onJukeboxInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_293,this.onJukeboxDispose);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_921,this.onSoundMachineInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_1007,this.onSoundMachineDispose);
         this.var_1284 = new Timer(1000);
         this.var_1284.start();
         this.var_1284.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_307)
         {
            this.var_329[_loc6_] = null;
            this.var_838[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.method_11(this._priorityPlaying) == this.var_1984)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_387)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               _loc2_ = 0;
               while(_loc2_ < this.var_286.length)
               {
                  _loc3_ = this.var_286.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_727,this.onJukeboxInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_293,this.onJukeboxDispose);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_921,this.onSoundMachineInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_1007,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_307)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_329[param1] = _loc7_;
         this.var_838[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_329[param1];
         return _loc2_.songId;
      }
      
      private function method_11(param1:int) : int
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_307)
         {
            return -1;
         }
         return this.var_838[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_329.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_329[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_286.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_307)
         {
      ...
      {
         if(this.var_669.getValue(param1) == null)
         {
            this.var_669.add(param1,param2);
            this.var_837.push(param1);
         }
      }
      ...
      {
         return this.var_386.length;
      }
      
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_386.length)
         {
            return this.var_386.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_386.length)
         {
            return this.var_386.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_286.length)
         {
            ...
            if(_loc3_.id != this.var_1570 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_329[_loc2_] != null)
            {
               _loc3_ = this.var_329[_loc2_];
               _loc4_ = this.var_286.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_837));
         Logger.log("Requested song info\'s : " + this.var_837);
         this.var_837 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_286.add(_loc6_.id,_loc10_);
               ...
               this._events.dispatchEvent(new SongInfoReceivedEvent(SongInfoReceivedEvent.const_97,_loc6_.id));
               while(this.var_839.indexOf(_loc6_.id) != -1)
               {
                  this.var_839.splice(this.var_839.indexOf(_loc6_.id),1);
                  if(this.var_839.length == 0)
                  {
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_307)
         {
            return false;
         }
         ...
         this.var_1984 = this.method_11(param1);
         this.var_1570 = param2;
         if(this._priorityPlaying <= const_1578)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_125)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2732 != param1.id || _loc3_ > this.var_2733 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2732 = param1.id;
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_669.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_386.add(_loc5_,_loc6_);
            if(this.var_286.getValue(_loc6_) == null)
            {
               this.var_839.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_560 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_92,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_560 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
