package com.sulake.habbo.sound.object
{
   ...
   public class HabboSound implements IHabboSound
   {
      ...
      private var var_1207:Sound = null;
      ...
      public function HabboSound(param1:Sound)
      {
         ...
         this.var_1207.addEventListener(Event.COMPLETE,this.onComplete);
         this.var_1014 = 1;
      ...
      {
         this._complete = false;
         this.var_444 = this.var_1207.play(0);
      ...
      {
         return this.var_1207.length;
      }
      
      public function get ready() : Boolean
      {
         return !this.var_1207.isBuffering;
      }
