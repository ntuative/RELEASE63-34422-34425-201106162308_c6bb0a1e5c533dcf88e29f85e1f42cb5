   ...
   public class Animation implements IDisposable
   {
      ...
      private function draw() : void
      {
         ...
         if(this.var_1293)
         {
            ...
            {
               if(!_loc2_.isFinished(this.var_1039))
               {
                  _loc1_ = true;
                  _loc3_ = _loc2_.getBitmap(this.var_1039);
                  if(_loc3_ != null)
                  {
                     this.var_100.bitmap.copyPixels(_loc3_,_loc3_.rect,_loc2_.getPosition(this.var_1039));
                  }
               }
            }
         }
