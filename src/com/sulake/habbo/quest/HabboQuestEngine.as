package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1408:int = 5;
      
      private static const const_1409:int = 800;
      
      private static const const_1411:int = 15;
      
      private static const const_1410:int = 300;
      ...
      private var var_1144:QuestController;
      
      private var var_928:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1144 = new QuestController(this);
         this.var_928 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1408);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_394.events.removeEventListener(BadgeImageReadyEvent.const_210,this.var_928.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_394.events.addEventListener(BadgeImageReadyEvent.const_210,this.var_928.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1144.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_928.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1144.questTracker.isVisible();
      }
      ...
      {
         this.var_1144.update(param1);
         this.var_928.update(param1);
      }
