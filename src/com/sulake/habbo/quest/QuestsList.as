package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1604:int = 5;
      
      private static const const_1605:int = 10;
      
      private static const const_1603:int = 10;
      
      private static const const_1602:int = 30;
      ...
      private var var_2010:Boolean = true;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_811 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_811.toggle();
         this.var_2010 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1582.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1582[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_67 = IItemListWindow(this._window.findChildByName("quest_list"));
         this.var_600 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_67.spacing = const_1605;
      }
      
      private function refreshEntry(param1:Boolean, param2:int, param3:QuestMessageData, param4:Boolean) : Boolean
      {
         var _loc5_:IWindowContainer = IWindowContainer(this.var_67.getListItemAt(param2));
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_67.addListItem(_loc5_);
            _loc6_ = true;
         }
         if(param1)
         {
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1603;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1604;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1602;
      ...
      private function refreshEntryQuestDetails(param1:IWindowContainer, param2:QuestMessageData) : void
      {
         ...
         this._questEngine.refreshReward(param2.waitPeriodSeconds < 1,param1,param2.activityPointType,param2.rewardCurrencyAmount);
      ...
      public function refreshDelay(param1:IWindowContainer, param2:QuestMessageData) : Boolean
      {
         ...
         if(param1.findChildByName("delay_desc_txt").visible)
         {
            ...
            _loc4_ = FriendlyTime.getFriendlyTime(this._questEngine.localization,_loc3_);
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2010 && !this.var_2009)
            {
               this.var_2010 = false;
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1474 = NextQuestTimer.const_845;
         this.refresh(true);
      }
   }
}
