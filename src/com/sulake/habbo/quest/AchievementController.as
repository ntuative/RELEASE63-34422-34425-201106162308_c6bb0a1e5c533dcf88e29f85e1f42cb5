package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_718:int = 3;
      
      private static const const_1687:int = 8;
      
      private static const const_1686:int = 5;
      
      private static const const_1678:int = 6;
      
      private static const const_1680:int = 3;
      
      private static const const_1679:int = 2;
      
      private static const const_1147:int = 6;
      
      private static const const_1683:int = 180;
      
      private static const const_1684:int = 246;
      
      private static const const_1581:int = 45;
      
      private static const const_1688:Point = new Point(115,93);
      
      private static const const_1681:Point = new Point(72,1);
      ...
      private var var_484:IWindowContainer;
      
      private var var_892:IWindowContainer;
      
      private var var_485:IWindowContainer;
      
      private var var_1636:IWindowContainer;
      
      private var var_1110:IWindowContainer;
      
      private var var_1354:IWindowContainer;
      
      private var var_115:AchievementCategories;
      ...
      private var var_711:ProgressBar;
      
      private var var_891:ProgressBar;
      
      private var var_1355:Matrix;
      
      private var var_2116:ColorMatrixFilter;
      
      private var var_1637:AchievementData;
      
      private var var_890:Timer;
      
      private var var_712:Dictionary;
      
      private var var_893:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         this.var_584 = new Timer(100,1);
         this.var_584.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_890 = new Timer(2000,1);
         this.var_890.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_893 = new AchievementLevelUp(this._questEngine);
         this.var_1355 = new Matrix();
         this.var_2116 = this.createGrayscaleFilter();
         this.var_712[16] = 1;
         this.var_712[28] = 6;
         this.var_712[38] = 4;
         this.var_712[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_584)
         {
            this.var_584.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
            this.var_584.reset();
            this.var_584 = null;
         }
         if(this.var_890)
         {
            this.var_890.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_890.reset();
            this.var_890 = null;
         }
         if(this.var_711)
      ...
      public function onAchievements(param1:Array, param2:String) : void
      {
         if(this.var_115 == null)
         {
            this.var_115 = new AchievementCategories(param1);
         }
         this.refresh();
         this._window.visible = true;
         this._window.activate();
         var _loc3_:AchievementCategory = this.var_115.getCategoryByCode(param2);
         if(_loc3_ != null)
         {
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1581;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         {
            this.var_484.visible = false;
            return;
         }
         this.var_484.visible = true;
         var _loc1_:Array = this.var_115.categoryList;
         var _loc2_:int = 0;
         while(true)
         {
         ...
         this.var_484.height = getLowestPoint(this.var_484);
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         if(this._category != null)
         {
            this.var_1354.visible = false;
            return;
         }
         this.var_1354.visible = true;
         this.var_891.refresh(this.var_115.getProgress(),this.var_115.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_892.height = getLowestPoint(this.var_892);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         if(this._category == null)
         {
            this.var_1110.visible = false;
            return;
         }
         this.var_1110.visible = true;
         this.var_1110.findChildByName("category_name_txt").caption = this._questEngine.getAchievementCategoryName(this._category.code);
         ...
         this._questEngine.setupAchievementCategoryImage(this.var_1110,this._category,false);
      }
      ...
      private function refreshAchievementsFooter() : void
      {
         if(this._category == null)
         {
            this.var_1636.visible = false;
            return;
         }
         this.var_1636.visible = true;
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         this.var_485.findChildByName("achievement_name_txt").caption = this._questEngine.localization.getBadgeName(_loc1_);
         var _loc2_:String = this._questEngine.localization.getBadgeDesc(_loc1_);
         this.var_485.findChildByName("achievement_desc_txt").caption = _loc2_ == null ? "" : _loc2_;
         this._questEngine.localization.registerParameter("achievements.details.level","level","" + (!!this.var_76.finalLevel ? this.var_76.level : this.var_76.level - 1));
         this._questEngine.localization.registerParameter("achievements.details.level","limit","" + this.var_76.levelCount);
         this._questEngine.refreshReward(!this.var_76.finalLevel,this.var_485,this.var_76.levelRewardPointType,this.var_76.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_485,this.var_76);
         this.var_711.refresh(this.var_76.currentPoints,this.var_76.scoreLimit,this.var_76.type * 10000 + this.var_76.level);
         this.var_711.visible = !this.var_76.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_484 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_1110 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_892 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_485 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1636 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1354 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_711 = new ProgressBar(this._questEngine,this.var_485,const_1683,"achievements.details.progress",true,const_1688);
         this.var_891 = new ProgressBar(this._questEngine,this.var_1354,const_1684,"achievements.categories.totalprogress",true,const_1681);
      }
      
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_484.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_718);
         var _loc5_:* = _loc4_ < const_1680;
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1687) * (param1 % const_718);
            _loc3_.y = (_loc3_.height + const_1686) * Math.floor(param1 / const_718) + const_1678;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_892.getChildByName("" + param1));
      ...
      private function onSelectCategory(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            this.pickCategory(this.var_115.categoryList[_loc3_]);
         }
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_484.numChildren)
         {
            _loc3_ = _loc2_ == param1;
            _loc4_ = IWindowContainer(this.var_484.getChildAt(_loc2_));
            _loc4_.findChildByName("category_bg_act").visible = !_loc3_ && _loc2_ < this.var_115.categoryList.length;
      ...
      private function onSelectAchievement(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.refresh();
         this._questEngine.send(new EventLogMessageComposer("Achievements","" + this.var_76.type,"Achievement selected"));
      }
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc7_:int = const_1146 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1685) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_2116);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1146 - _loc5_.height + this.getPositionFix(param2.type));
         ...
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_2116);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_76 = this.var_1637;
         this.var_115.update(this.var_1637);
         this.var_1637 = null;
         this.refresh();
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_711.updateView();
         }
         if(this.var_891 != null)
         {
            this.var_891.updateView();
         }
         if(this.var_893 != null)
         {
            this.var_893.update(param1);
         }
      }
      ...
      {
         return !!this.var_712[param1] ? int(this.var_712[param1]) : 0;
      }
