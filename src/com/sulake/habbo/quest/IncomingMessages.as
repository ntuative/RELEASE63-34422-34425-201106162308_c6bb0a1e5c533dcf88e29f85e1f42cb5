package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1871:IAlertDialog;
      ...
      private function onAchievements(param1:IMessageEvent) : void
      {
         ...
         this._questEngine.achievementController.onAchievements(_loc3_.achievements,_loc3_.defaultCategory);
      }
      ...
      private function onLevelUp(param1:IMessageEvent) : void
      {
         ...
         this._questEngine.send(new EventLogMessageComposer("Achievements",_loc4_,"Leveled","" + _loc3_.data.level));
