package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1581:int = 56;
      
      private static const const_704:int = 5;
      
      private static const const_1582:int = 5;
      
      private static const const_1116:Point = new Point(8,8);
      
      private static const const_1580:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_140 == null || this.var_140.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc10_.x = const_1116.x;
            _loc10_.y = const_1116.y;
         ...
         var _loc2_:* = this.var_140.waitPeriodSeconds > 0;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1582;
         }
         ...
         var _loc7_:Boolean = const_1580.indexOf(param1.type) > -1 && !_loc2_;
         _loc6_.y = _loc3_.y + _loc3_.height + const_704;
         var _loc8_:int = 0;
         if(_loc7_ && !_loc6_.visible)
         {
            _loc8_ = const_704 + _loc6_.height;
         }
         if(!_loc7_ && _loc6_.visible)
         {
            _loc8_ = -const_704 - _loc6_.height;
         ...
         this._window.height = _loc10_.height + const_1581;
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Boolean = this._questEngine.questController.questsList.refreshDelay(this._window,this.var_140);
         if(_loc2_)
         {
            this.openDetails(this.var_140);
         }
      }
   }
}
