package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1099:int = 60;
      
      private static const const_1098:int = 3600;
      
      private static const const_1547:int = 3 * const_1099;
      
      private static const const_1548:int = 3 * const_1098;
      ...
      {
         if(param2 > const_1548)
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1098));
         }
         if(param2 > const_1547)
         {
            return getLocalization(param1,"friendlytime.minutes",Math.round(param2 / const_1099));
         }
