package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1484:int = 50;
      
      private static const const_1056:Number = 60;
      
      private static const const_1485:Number = 50;
      ...
      private var var_3059:int = 0;
      
      private var var_268:Sprite;
      
      private var var_150:Sprite;
      
      private var var_111:Sprite;
      
      private var var_627:Map;
      
      private var var_530:Point;
      
      private var var_267:BitmapDataCache;
      ...
      private var var_1467:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2449:Number = -1.0E7;
      
      private var var_2447:Number = -1.0E7;
      ...
      private var var_625:Matrix;
      
      private var var_556:Number = 0.0;
      ...
      private var var_1793:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_268 = new Sprite();
         this.var_268.mouseEnabled = false;
         this.var_111 = new Sprite();
         this.var_111.name = "canvas";
         this.var_111.mouseEnabled = false;
         this.var_268.addChild(this.var_111);
         ...
         this.var_267 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
      ...
      {
         this.var_530.x -= param1 - this.var_630;
         this.var_630 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_530.y -= param1 - this.var_629;
         this.var_629 = param1;
      }
      ...
      {
         if(param1 && !this.var_1067)
         {
            this.var_1067 = true;
            if(this.var_150 != null && !this.var_268.contains(this.var_150))
            {
               this.var_268.addChild(this.var_150);
               this.var_111.mask = this.var_150;
            }
         }
         else if(!param1 && this.var_1067)
         {
            this.var_1067 = false;
            if(this.var_150 != null && this.var_268.contains(this.var_150))
            {
               this.var_268.removeChild(this.var_150);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_268.numChildren > 0)
            {
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_150 != null)
         {
            this.var_150.graphics.clear();
         }
         else
         {
            this.var_150 = new Sprite();
            this.var_150.name = "mask";
            if(this.var_1067)
            {
               this.var_268.addChild(this.var_150);
               this.var_111.mask = this.var_150;
         ...
         this.var_150.graphics.beginFill(0);
         this.var_150.graphics.drawRect(0,0,param1,param2);
         this.var_533 = param1;
         this.var_531 = param2;
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_533 != this.var_2451 || this.var_531 != this.var_2450)
         {
            _loc8_ = true;
         }
         if(this.var_111.x != this.var_630 || this.var_111.y != this.var_629)
         {
            this.var_111.x = this.var_630;
            this.var_111.y = this.var_629;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_532.sortOn("z",0 | 0);
         if(_loc5_ < this.var_532.length)
         {
            this.var_532.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_532[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2451 = this.var_533;
         this.var_2450 = this.var_531;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1468 > 0)
         {
            ...
            if(_loc2_ > const_1056 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2445 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_770;
               if(this.var_770 == const_380 + 1)
               {
                  this.var_556 = _loc2_;
                  this.var_1793 = this.var_2448;
               }
               else if(this.var_770 > const_380 + 1)
               {
                  _loc3_ = Number(this.var_770 - const_380);
                  this.var_556 = this.var_556 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1793 = this.var_1793 * (_loc3_ - 1) / _loc3_ + Number(this.var_2448) / _loc3_;
                  if(this.var_770 > const_380 + const_1484)
                  {
                     this.var_770 = const_380;
                     if(!this.var_1200 && this.var_556 > const_1056)
                     {
                        this.var_1200 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1200 && this.var_556 < const_1485)
                     {
                        this.var_1200 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1792 && this.var_1200);
         ...
         _loc13_ += int(this.var_533 / 2);
         _loc14_ += int(this.var_531 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_630;
                  ...
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_532.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_630;
      ...
      {
         if(param1 < this.var_533 && param1 + param3 >= 0 && (param2 < this.var_531 && param2 + param4 >= 0))
         {
            if(!this.var_3025)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_533)
         {
            param3 -= this.var_533 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_531)
         {
            param4 -= this.var_531 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2446)
         {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_532[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_267.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_267.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_267.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_625.identity();
            if(flipH)
            {
               this.var_625.scale(-1,1);
               this.var_625.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_625.scale(1,-1);
               this.var_625.translate(0,data.height);
            }
            finalData.draw(data,this.var_625);
            if(name.length > 0)
            {
               this.var_267.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_708);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_904.redMultiplier = tR;
            this.var_904.greenMultiplier = tG;
            this.var_904.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_904);
            if(name.length > 0)
            {
               this.var_267.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_630;
         param2 -= this.var_629;
         this.var_530.x = param1;
         this.var_530.y = param2;
         if(this.var_1199 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1795;
         }
         this.var_1795 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1199;
         return this.var_1795;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_533 / 2;
         var _loc12_:Number = param2 - this.var_531 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1794,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_627.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_627.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2449 || param2 != this.var_2447)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_627.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_627.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_366 != null && param1 != null)
         {
            this.var_366.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_366 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_366.length)
         {
            _loc2_ = this.var_366.getKey(_loc1_);
            _loc3_ = this.var_366.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1467.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1199 == 0)
         {
            this.checkMouseHits(this.var_530.x,this.var_530.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1199 = 0;
         ++this.var_1794;
      }
