   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_299 != null)
         {
            ...
            {
               _loc3_ = this.var_299.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1610.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1610.push(param1);
         }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_606.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_606[_loc2_]);
      ...
      {
         return this.var_299.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_299.getValue(_loc2_) != null)
         {
            return this.var_299.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_299.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_299.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_299.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
