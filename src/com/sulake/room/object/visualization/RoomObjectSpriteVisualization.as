package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_395:IRoomObject;
      
      private var var_860:IGraphicAssetCollection;
      
      protected var var_511:int = -1;
      
      protected var var_165:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_229 != null)
         {
            ...
            {
               _loc1_ = this.var_229[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_860.removeReference();
         }
         this.var_860 = param1;
         if(this.var_860 != null)
         {
            this.var_860.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_229.length > param1)
         {
            _loc2_ = this.var_229[this.var_229.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_229.length)
         {
      ...
      {
         this.var_511 = 4294967295;
         this.var_165 = 4294967295;
         this.var_102 = -1;
      }
