package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1760:int = 0;
      ...
      private var var_3056:IRoomContentLoader;
      
      private var var_605:IRoomObjectFactory = null;
      
      private var var_513:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1139:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_604 = [];
         this.var_606 = [];
         events.addEventListener(RoomContentLoadedEvent.const_390,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_626,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_1015,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_605 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_605 == null || this.var_513 == null)
         {
            return;
         }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_604.indexOf(_loc5_) < 0)
            {
               this.var_58.loadObjectContent(_loc5_,events);
               this.var_604.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1288;
         return true;
      }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_606.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_606[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_513.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_513.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_605.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_605 != null)
         {
            return this.var_605.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_953)
         {
            return;
         }
         if(this.var_58 == null)
         {
            this._state = const_953;
            return;
         }
         if(this.var_58.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_604.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_604.splice(_loc2_,1);
            }
            if(this.var_604.length == 0)
            {
               this._state = const_729;
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_923.indexOf(_loc2_) < 0)
         {
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_923.length > 0)
         {
            _loc2_ = this.var_923[0];
            this.var_923.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_58 == null || this.var_513 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_513.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_513.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_605.createRoomObjectLogic(_loc6_);
