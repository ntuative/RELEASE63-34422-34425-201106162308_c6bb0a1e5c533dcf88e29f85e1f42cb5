package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_568:Number = 64;
      
      public static const const_1286:Number = 32;
      ...
      private var var_187:Vector3d;
      
      private var var_186:Vector3d;
      
      private var var_1369:Vector3d;
      
      private var var_490:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1368:Vector3d;
      
      private var _scale:Number = 1.0;
      
      private var var_489:Number = 1.0;
      
      private var var_492:Number = 1.0;
      
      private var var_491:Number = 1.0;
      
      private var var_2141:Number = 1.0;
      
      private var var_2140:Number = 1.0;
      
      private var var_2142:Number = 1.0;
      
      private var var_106:Vector3d;
      
      private var var_493:Vector3d;
      
      private var var_3047:Number = -500.0;
      
      private var var_3048:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1369 = new Vector3d();
         this.var_490 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1368 = new Vector3d();
         this.var_2141 = 1;
         this.var_2140 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2142 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_490.assign(this.var_106);
         this.var_490.x *= this.var_489;
         this.var_490.y *= this.var_492;
         this.var_490.z *= this.var_491;
         return this.var_490;
      }
      ...
      {
         if(this.var_489 != param1 * this.var_2141)
         {
            this.var_489 = param1 * this.var_2141;
            ++this.var_185;
         }
      }
      ...
      {
         if(this.var_492 != param1 * this.var_2140)
         {
            this.var_492 = param1 * this.var_2140;
            ++this.var_185;
         }
      }
      ...
      {
         if(this.var_491 != param1 * this.var_2142)
         {
            this.var_491 = param1 * this.var_2142;
            ++this.var_185;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_106.x /= this.var_489;
         this.var_106.y /= this.var_492;
         this.var_106.z /= this.var_491;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_493.x;
         var _loc3_:Number = this.var_493.y;
         var _loc4_:Number = this.var_493.z;
         this.var_493.assign(param1);
         this._direction.assign(param1);
         if(this.var_493.x != _loc2_ || this.var_493.y != _loc3_ || this.var_493.z != _loc4_)
         {
            ++this.var_185;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_187.assign(_loc24_);
            this.var_186.assign(_loc25_);
            this.var_1369.assign(this.var_186);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_187.assign(_loc19_);
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_590 != null)
         {
            ...
            return this.var_590.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1368.assign(_loc22_);
         }
         else
         {
            this.var_1368.assign(_loc17_);
         }
         ++this.var_185;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_187);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_489;
         _loc2_.y *= this.var_492;
         _loc2_.z *= this.var_491;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1368);
         if(_loc3_ < this.var_3047 || _loc3_ > this.var_3048)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_187);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_492;
            _loc2_.z *= this.var_491;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1368);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_187,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_106.x * this.var_489,this.var_106.y * this.var_492,this.var_106.z * this.var_491);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_186;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_489,param2.y * this.var_492,param2.z * this.var_491);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_489,param3.y * this.var_492,param3.z * this.var_491);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_489,param4.y * this.var_492,param4.z * this.var_491);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1286;
         }
         else
         {
            this.scale = const_568;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_568;
      }
