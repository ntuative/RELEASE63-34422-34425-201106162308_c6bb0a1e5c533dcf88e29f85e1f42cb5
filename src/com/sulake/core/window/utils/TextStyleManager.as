package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_227:String = "regular";
      ...
      private static var var_547:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_693:String = "{";
      
      private static const const_694:String = "}";
      
      private static const const_1546:String = "/*";
      
      private static const const_1545:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_98[const_227],var_98[ITALIC],var_98[BOLD]];
            var_98.reset();
            var_98[const_227] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_547.indexOf(_loc4_.name) == -1)
            {
               var_547.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_694);
         if(countSubStrings(param1,const_693) != countSubStrings(param1,const_694))
         {
            throw new Error("Mismatching amount of \"" + const_693 + "\" versus \"" + const_694 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1546) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1545) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_693)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
