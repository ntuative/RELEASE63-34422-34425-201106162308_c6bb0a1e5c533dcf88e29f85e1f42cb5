package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_343:int = -2.147483648E9;
      
      private var var_344:int = 2.147483647E9;
      ...
      {
         this.var_343 = param1;
         if(this.var_343 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_343)
         {
      ...
      {
         this.var_344 = param1;
         if(this.var_344 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_344)
         {
      ...
      {
         return this.var_343 == int.MIN_VALUE && this.var_344 == int.MAX_VALUE && this.var_345 == int.MIN_VALUE && this.var_346 == int.MAX_VALUE;
      }
      
      public function setEmpty() : void
      {
         this.var_343 = int.MIN_VALUE;
         this.var_344 = int.MAX_VALUE;
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_343)
            {
               this._target.width = this.var_343;
            }
            else if(this._target.width > this.var_344)
            {
               this._target.width = this.var_344;
            }
