package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2260:String = "_INCLUDE";
      
      public static const const_2166:String = "_TEMP";
      
      private static const const_1636:String = "layout";
      
      private static const const_1136:String = "window";
      
      private static const const_1137:String = "variables";
      
      private static const const_1138:String = "filters";
      
      private static const const_695:String = "name";
      
      private static const const_1630:String = "style";
      
      private static const const_711:String = "params";
      
      private static const const_1637:String = "tags";
      ...
      private static const const_1625:String = "visible";
      
      private static const const_1626:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1264:String = "blend";
      
      private static const const_1634:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1627:String = "treshold";
      
      private static const const_1633:String = "children";
      
      private static const const_1628:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1635:String = "height_min";
      
      private static const const_1631:String = "height_max";
      
      private static const const_712:String = "true";
      
      private static const const_195:String = "0";
      
      private static const const_1629:String = "$";
      
      private static const const_1558:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1632:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1624:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1398:Dictionary;
      
      protected var var_1397:Dictionary;
      
      protected var var_1135:Dictionary;
      
      protected var var_1678:Dictionary;
      
      protected var var_2228:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1398,this.var_1397);
         this.var_1135 = new Dictionary();
         this.var_1678 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1135,this.var_1678);
         this.var_2228 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1624,const_50);
         return param1.replace(const_1632,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1398)
            {
               delete this.var_1398[_loc1_];
            }
            for(_loc1_ in this.var_1397)
            {
               delete this.var_1397[_loc1_];
            }
            for(_loc1_ in this.var_1135)
            {
               delete this.var_1135[_loc1_];
            }
            for(_loc1_ in this.var_1678)
            {
               delete this.var_1678[_loc1_];
            }
            this.var_2228.dispose();
            this.var_2228 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1636)
         {
            _loc8_ = param1.child(const_1137);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1138).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1136);
         ...
         if(param1.localName() == const_1136)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1398[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_695,variables,"")));
         style = uint(this.parseAttribute(xml,const_1630,variables,style));
         params = uint(this.parseAttribute(xml,const_711,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1637,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_195));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_195));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_195));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_195));
         visible = this.parseAttribute(xml,const_1625,variables,visible.toString()) == const_712;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_711).length() > 0)
         {
            list = xml.child(const_711).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_695,variables,"") as String;
               if(this.var_1135[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_695)) + "\"!");
               }
               params |= this.var_1135[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1626,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1558);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1137)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1628,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1635,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1631,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_712;
         blend = Number(this.parseAttribute(xml,const_1264,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1634,variables,window.clipping.toString()) == const_712;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1627,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1138).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_232)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1397[param1.type];
