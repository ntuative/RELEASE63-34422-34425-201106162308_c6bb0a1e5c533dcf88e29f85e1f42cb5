package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static var var_354:Array;
      
      protected static var var_309:Array;
      
      protected static var var_428:Point = new Point();
       
      
      protected var var_730:Point;
      
      protected var var_188:WindowController;
      
      protected var var_71:WindowController;
      
      protected var var_182:IWindowRenderer;
      
      protected var var_95:IDesktopWindow;
      
      protected var var_916:IWindowContextStateListener;
      ...
      {
         super();
         this.var_730 = new Point();
         if(var_354 == null)
         {
            var_354 = new Array();
            var_354[0] = MouseCursorType.const_377;
            var_354[1] = MouseCursorType.const_30;
            var_354[2] = MouseCursorType.const_377;
            var_354[3] = MouseCursorType.const_377;
            var_354[4] = MouseCursorType.const_377;
            var_354[5] = MouseCursorType.const_30;
            var_354[6] = MouseCursorType.const_377;
         }
         if(var_309 == null)
         {
            var_309 = new Array();
            var_309[0] = WindowState.const_89;
            var_309[1] = WindowState.const_91;
            var_309[2] = WindowState.const_88;
            var_309[3] = WindowState.const_72;
            var_309[4] = WindowState.const_55;
            var_309[5] = WindowState.const_99;
            var_309[6] = WindowState.const_87;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_248;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1385 as WindowController;
         this.var_188 = state.var_1383 as WindowController;
         this.var_182 = state.renderer;
         this.var_916 = state.var_1382;
         eventQueue.begin();
         this.var_730.x = -1;
         this.var_730.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_730.x || event.stageY != this.var_730.y)
            {
               this.var_730.x = event.stageX;
               this.var_730.y = event.stageY;
               array = new Array();
               this.var_95.groupParameterFilteredChildrenUnderPoint(this.var_730,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_71.getGlobalPosition(var_428);
               ...
               if(child != null && child.visible)
               {
                  if(event.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(child != this.var_71)
                     {
                        ...
                        if(!child.disposed)
                        {
                           child.getGlobalPosition(var_428);
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_916.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1385 = this.var_71;
         state.var_1383 = this.var_188;
         state.renderer = this.var_182;
         state.var_1382 = this.var_916;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param2.type == MouseEvent.MOUSE_UP)
         {
            ...
            {
               if(this.var_188 && !this.var_188.disposed)
               {
                  this.var_188.update(this.var_188,convertMouseEventType(new MouseEvent(MouseEvent.MOUSE_UP,false,true,param2.localX,param2.localY,null,param2.ctrlKey,param2.altKey,param2.shiftKey,param2.buttonDown,param2.delta),this.var_188,param1));
                  this.var_188 = null;
                  if(param1.disposed)
                  {
                     return null;
         ...
         var _loc5_:BitmapData = this.var_182.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_563))
         {
