package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_922:Dictionary;
      
      protected var var_921:Dictionary;
      ...
      {
         super(param1);
         this.var_922 = new Dictionary(false);
         this.var_921 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_303 = null;
            this.var_904 = null;
            for(_loc1_ in this.var_922)
            {
               _loc2_ = this.var_922[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_922[_loc1_];
            }
            this.var_922 = null;
            for(_loc1_ in this.var_921)
            {
               _loc2_ = this.var_921[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_921[_loc1_];
            }
            this.var_921 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_504[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.var_349 == SkinLayoutEntity.const_361)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_349 == SkinLayoutEntity.const_588)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_349 == SkinLayoutEntity.const_329)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_349 == SkinLayoutEntity.const_554)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_347 == SkinLayoutEntity.const_361)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_347 == SkinLayoutEntity.const_588)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_347 == SkinLayoutEntity.const_329)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_347 == SkinLayoutEntity.const_554)
                  {
                  ...
                  else if(_loc10_.var_347 == SkinLayoutEntity.const_329 || _loc10_.var_349 == SkinLayoutEntity.const_329)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_349 == SkinLayoutEntity.const_361)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_347 == SkinLayoutEntity.const_361)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_922[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_921[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
