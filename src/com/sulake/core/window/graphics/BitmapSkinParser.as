package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_106:String = "default";
      
      public static const const_89:String = "active";
      
      public static const const_91:String = "focused";
      
      public static const const_88:String = "hovering";
      
      public static const const_55:String = "selected";
      
      public static const const_99:String = "pressed";
      
      public static const const_87:String = "disabled";
      
      public static const const_72:String = "locked";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_349 = SkinLayoutEntity.const_531;
                  break;
               case "move":
                  _loc5_.var_349 = SkinLayoutEntity.const_361;
                  break;
               case "strech":
                  _loc5_.var_349 = SkinLayoutEntity.const_588;
                  break;
               case "tiled":
                  _loc5_.var_349 = SkinLayoutEntity.const_329;
                  break;
               case "center":
                  _loc5_.var_349 = SkinLayoutEntity.const_554;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_347 = SkinLayoutEntity.const_531;
                  break;
               case "move":
                  _loc5_.var_347 = SkinLayoutEntity.const_361;
                  break;
               case "strech":
                  _loc5_.var_347 = SkinLayoutEntity.const_588;
                  break;
               case "tiled":
                  _loc5_.var_347 = SkinLayoutEntity.const_329;
                  break;
               case "center":
                  _loc5_.var_347 = SkinLayoutEntity.const_554;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_89:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_106:
               _loc10_ = 0;
               break;
            ...
            case BitmapSkinParser.const_99:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_55:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_72:
               _loc10_ = 0;
               break;
            default:
