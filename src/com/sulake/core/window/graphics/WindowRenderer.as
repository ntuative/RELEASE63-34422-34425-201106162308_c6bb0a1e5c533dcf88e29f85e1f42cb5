package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_2127:Point;
      
      private var var_1645:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_2127 = new Point();
         this.var_1645 = new Rectangle();
         this.var_341 = new Rectangle();
         this.var_414 = new Dictionary(true);
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_897 = null;
            for(_loc1_ in this.var_414)
            {
               delete this.var_414[_loc1_];
            }
            this.var_414 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_341.x = param2.x - param1.x;
            this.var_341.y = param2.y - param1.y;
            this.var_341.width = param2.width;
            this.var_341.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_33))
            {
               while(param1.testParamFlag(WindowParam.const_33))
               {
                  ...
                  this.var_341.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_341,WindowRedrawFlag.const_1340);
      ...
      {
         var _loc2_:WindowRendererItem = this.var_414[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_414[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_414[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_881,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_881,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_414[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_414[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_897.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_897.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_341.x = _loc3_.dirty.x;
               this.var_341.y = _loc3_.dirty.y;
               this.var_341.width = _loc3_.dirty.width;
               this.var_341.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_341,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_2127,this.var_1645))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_2127,this.var_1645))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_33))
            {
               if(param1.testParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING))
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1645);
