package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_686:uint = 0;
      
      private static const const_1062:uint = 1;
      
      private static const const_1063:uint = 2;
      ...
      private var var_1134:Matrix;
      
      private var var_904:ColorTransform;
      
      private var var_1487:uint;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1487 = 4294967295;
         this.var_976 = 0;
         this.var_904 = new ColorTransform();
         this.var_1134 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1063) : uint(const_686);
         var _loc6_:Boolean = this.var_195.width > 0 && this.var_195.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_976))
            {
               _loc5_ = const_1062;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_1062)
               {
                  ...
                  if(this.var_633)
                  {
                     ...
                     _loc7_.draw(param1,this.var_126,this.var_126.rect,this.var_976,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1134.tx = param2.x;
                     this.var_1134.ty = param2.y;
                     this.var_904.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_126,this.var_1134,this.var_904,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1487;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_1235:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_917:
               this.var_976 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_976 != this.var_1487)
               {
                  this.var_633 = true;
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1264:
               ...
               break;
            case WindowRedrawFlag.const_1340:
               _loc4_ = true;
         }
         if(_loc4_)
         {
