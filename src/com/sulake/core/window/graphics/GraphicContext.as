package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1839:uint = 0;
      
      public static const const_854:uint = 1;
      
      public static const const_1348:uint = 2;
      
      public static const const_936:uint = 4;
      
      public static const const_1915:uint = 8;
      
      public static const const_1837:uint = 16;
      
      public static const const_2187:uint = 64;
      
      public static const const_2086:uint = 128;
      
      public static const const_1173:uint = 256;
      
      protected static var var_603:uint = 0;
      
      protected static var var_356:uint = 0;
       
      
      protected var var_235:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1348:
               ...
               break;
            case GraphicContext.const_1915:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1837:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_936:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1173:
               break;
            case GraphicContext.const_1839:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_235.numChildren > 0)
               {
                  this.var_235.removeChildAt(0);
               }
            }
            this.var_235 = null;
            while(numChildren > 0)
         ...
         if(this.var_920)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_356 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2232,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2232,16777215);
                  }
                  var_356 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_920)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_356 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_235 == null)
         {
            this.var_235 = new Sprite();
            this.var_235.name = this.name + " - Child Container";
            this.var_235.mouseEnabled = false;
      ...
      {
         return this.var_235 != null ? int(this.var_235.numChildren) : 0;
      }
