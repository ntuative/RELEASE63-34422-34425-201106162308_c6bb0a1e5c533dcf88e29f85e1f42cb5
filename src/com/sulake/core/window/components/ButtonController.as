package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_461:String = "_BTN_TEXT";
      
      protected static const const_1396:Number = 0.5;
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_461);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               case WindowEvent.const_147:
                  width = 0;
                  break;
               case WindowEvent.const_247:
                  try
                  {
                     getChildByName(const_461).blend = getChildByName(const_461).blend + const_1396;
                  }
                  catch(e:Error)
                  {
                  }
                  break;
               case WindowEvent.const_270:
                  try
                  {
                     getChildByName(const_461).blend = getChildByName(const_461).blend - const_1396;
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1317:
                  type = "null";
                  break;
               case WindowTouchEvent.const_855:
                  type = "null";
            }
