package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1571:String = "increment";
      
      private static const const_1572:String = "decrement";
      
      private static const const_1111:String = "slider_track";
      
      private static const const_701:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_739:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_189 = false;
         this.var_19 = param12;
         this._horizontal = param2 == WindowType.const_525;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_19.removeEventListener(WindowEvent.const_39,this.onScrollableResized);
            this.var_19.removeEventListener(WindowEvent.const_584,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_39,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_584,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1023 != null)
         {
            _loc2_ = this.var_1023;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1023 = _loc3_.value as String;
               this.var_19 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1111) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_701) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_701:
               if(param2.type == WindowEvent.const_219)
               {
                  if(!this.var_1277)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_514)
         {
            if(this.var_19 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_351)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_739;
                  }
                  else
                  {
                     this.scrollV -= this.var_739;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_855)
         {
            ...
            else if(param2.name == const_1572)
            {
               if(this.var_19)
               {
                  this.var_1277 = true;
            ...
            else if(param2.name == const_1111)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_701).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_351)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1023) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1023) as IScrollableWindow;
               if(_loc1_)
               {
