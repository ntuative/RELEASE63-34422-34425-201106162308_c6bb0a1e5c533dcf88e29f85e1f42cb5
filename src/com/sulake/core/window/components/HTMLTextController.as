package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_986:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_788:String;
      
      private var var_1232:String = null;
      
      private var var_1832:StyleSheet = null;
      ...
      {
         this.var_788 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1232 == param2)
         {
            return;
         }
         param1.var_1232 = param2;
         param1.var_1832 = null;
         if(param1.var_1232 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1232);
            param1.var_1832 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_862.indexOf(param1) > -1)
         {
            this.var_788 = param1;
         }
      }
      ...
      {
         return this.var_788 == LinkTarget.const_30 ? defaultLinkTarget : this.var_788;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1832;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1276)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_788 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1004,this.var_788,PropertyStruct.const_52,true,PropertyDefaults.const_862));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1780);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_1004)
            {
               this.var_788 = _loc2_.value as String;
               break;
            }
