package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1276:IItemListWindow;
      
      private var var_465:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_87))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_465)
         {
            this.var_465.removeEventListener(WindowEvent.const_247,this.scrollBarEventProc);
            this.var_465.removeEventListener(WindowEvent.const_270,this.scrollBarEventProc);
            this.var_465 = null;
         }
         if(this.var_1276)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1276)
         {
            this.var_1276 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_465)
         {
            this.var_465 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_465)
            {
               this.var_465.addEventListener(WindowEvent.const_247,this.scrollBarEventProc);
               this.var_465.addEventListener(WindowEvent.const_270,this.scrollBarEventProc);
            }
         }
         return this.var_465;
      }
      ...
      {
         if(param1.type == WindowEvent.const_247)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_270)
         {
            this.hideScrollBar();
         }
      }
