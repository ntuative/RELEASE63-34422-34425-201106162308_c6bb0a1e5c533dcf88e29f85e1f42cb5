package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1401:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_919:Number;
      
      protected var var_600:Number;
      
      protected var var_599:Boolean;
      
      protected var var_44:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_141:Boolean = false;
      
      protected var var_1132:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_462,this._explicitStyle);
      ...
      private static function setTextMarginMap(param1:TextController, param2:Map) : void
      {
         if(param1.var_44)
         {
            param1.var_44.assign(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         else
         {
            param1.var_44 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         param1.refreshTextImage();
      }
      ...
      {
         if(param1.var_44 && param1.var_44.left != param2)
         {
      ...
      {
         if(param1.var_44 && param1.var_44.top != param2)
         {
      ...
      {
         if(param1.var_44 && param1.var_44.right != param2)
         {
      ...
      {
         if(param1.var_44 && param1.var_44.bottom != param2)
         {
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_462 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_462,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_227);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_894 ? true : null;
         }
      ...
      {
         this.var_919 = param1;
         this._field.scrollH = this.var_919 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_919 * this.maxScrollH,this.var_600 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_600 = this.var_600;
         _loc1_.var_44 = this.var_44.clone(_loc1_.setTextMargins);
         _loc1_._autoSize = this._autoSize;
         _loc1_.var_141 = this.var_141;
         return _loc1_;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         if(!this.var_599)
         {
            if(param2.type == WindowEvent.const_39)
            {
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         this.var_599 = true;
         var _loc2_:int = this.var_44.left + this.var_44.right;
         var _loc3_:int = this.var_44.top + this.var_44.bottom;
         ...
         if(!_loc7_ && !param1)
         {
            _loc8_ = WindowEvent.allocate(WindowEvent.const_39,this,null);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("always_show_selection",this._field.alwaysShowSelection,PropertyStruct.const_37,this._field.alwaysShowSelection != false));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_742,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1251));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1262 ? new PropertyStruct(PropertyDefaults.const_1021,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1268) : PropertyDefaults.const_1962);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_37,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_164,this._field.borderColor != 0));
         _loc1_.push(new PropertyStruct("condense_white",this._field.condenseWhite,PropertyStruct.const_37,this._field.condenseWhite != false));
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_52,this.defaultTextFormat.font != _loc2_.fontFamily));
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_294,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1202 ? new PropertyStruct(PropertyDefaults.const_1279,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1290) : PropertyDefaults.const_1773);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_878) ? new PropertyStruct(PropertyDefaults.const_418,this._field.textColor,PropertyStruct.const_164,true) : PropertyDefaults.const_1328);
         ...
         _loc1_.push(this.var_44.left != PropertyDefaults.const_842 ? new PropertyStruct(PropertyDefaults.const_260,this.var_44.left,PropertyStruct.const_40,true) : PropertyDefaults.const_753);
         _loc1_.push(this.var_44.top != PropertyDefaults.const_961 ? new PropertyStruct(PropertyDefaults.const_251,this.var_44.top,PropertyStruct.const_40,true) : PropertyDefaults.const_789);
         _loc1_.push(this.var_44.right != PropertyDefaults.const_757 ? new PropertyStruct(PropertyDefaults.const_301,this.var_44.right,PropertyStruct.const_40,true) : PropertyDefaults.const_852);
         _loc1_.push(this.var_44.bottom != PropertyDefaults.const_999 ? new PropertyStruct(PropertyDefaults.const_298,this.var_44.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_1020);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1345 ? new PropertyStruct(PropertyDefaults.const_879,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_2006);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_40,this._field.maxChars != 0));
         _loc1_.push(new PropertyStruct("multiline",this._field.multiline,PropertyStruct.const_37,this._field.multiline != false));
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_52,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_132,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_132,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_37,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("bold",this._field.defaultTextFormat.bold != false,PropertyStruct.const_37,this._field.defaultTextFormat.bold != false && _loc2_.fontWeight != FontStyle.BOLD));
         _loc1_.push(new PropertyStruct("italic",this._field.defaultTextFormat.italic != false,PropertyStruct.const_37,this._field.defaultTextFormat.italic != false && _loc2_.fontStyle != FontStyle.ITALIC));
         _loc1_.push(new PropertyStruct("underline",this._field.defaultTextFormat.underline != false,PropertyStruct.const_37,this._field.defaultTextFormat.underline != false && _loc2_.textDecoration != "underline"));
         _loc1_.push(new PropertyStruct("kerning",this._field.defaultTextFormat.kerning != false,PropertyStruct.const_37,this._field.defaultTextFormat.kerning != false && !_loc2_.kerning));
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_132,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
