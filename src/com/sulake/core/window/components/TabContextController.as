package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1413:String = "_SELECTOR";
      
      private static const const_1412:String = "_CONTENT";
       
      
      protected var var_1125:ITabSelectorWindow;
      
      protected var var_2207:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1125 = findChildByTag(const_1413) as ITabSelectorWindow;
            if(this.var_1125 != null)
            {
               this.var_1125.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2207 == null)
         {
            this.var_2207 = findChildByTag(const_1412) as IWindowContainer;
         }
      ...
      {
         return !!this.var_856 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1125.numSelectables;
      }
