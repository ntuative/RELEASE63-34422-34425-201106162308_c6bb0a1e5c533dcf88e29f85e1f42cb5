package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1680:uint = 500;
      
      protected var var_1403:String = "";
      
      protected var var_1396:Boolean = false;
      ...
      {
         this.var_1403 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1348,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_856 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         if(!_loc2_ && !param1)
         {
            _loc3_ = WindowEvent.allocate(WindowEvent.const_39,this,null);
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_187,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_400,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_356,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_843,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1999);
         _loc1_.push(this.var_1396 != PropertyDefaults.const_1227 ? new PropertyStruct(PropertyDefaults.const_900,this.var_1396,PropertyStruct.const_37,true) : PropertyDefaults.const_1787);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1369 ? new PropertyStruct(PropertyDefaults.const_1005,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_2007);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1231 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1873);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_843:
                  ...
                  break;
               case PropertyDefaults.const_1320:
