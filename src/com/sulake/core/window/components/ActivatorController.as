package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_372)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1238)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_914;
         if(this.var_914 != param1)
         {
            if(this.var_914 != null)
            {
               if(!this.var_914.disposed)
               {
                  this.var_914.deactivate();
               }
            }
            this.var_914 = param1;
