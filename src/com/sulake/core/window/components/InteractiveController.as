package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1680 = PropertyDefaults.const_919;
         this.var_1403 = PropertyDefaults.const_459;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_459)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_191)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_459)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_811,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1757);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_919)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_871,param1.toolTipDelay,PropertyStruct.const_294,true));
         }
         else
         {
      ...
      {
         this.var_1403 = param1 == null ? "null" : param1;
      }
