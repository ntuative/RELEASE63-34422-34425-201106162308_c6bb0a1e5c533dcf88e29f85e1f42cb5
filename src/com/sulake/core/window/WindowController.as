package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1309:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1402:String = "_COLORIZE";
      
      protected static const const_1403:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1124:Point = new Point();
      ...
      protected var var_740:Function;
      
      protected var var_189:Boolean = true;
      ...
      private var var_397:Rectangle;
      
      private var var_2798:uint;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_397 = new Rectangle();
         if(_loc12_ != null)
         {
            var_426 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_68 = var_426.clone();
            var_11 = var_426.clone();
         ...
         if(_loc13_)
         {
            ...
            var_508 = _loc13_.var_2993;
            if(var_507 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_262 != _loc13_.color)
            {
               this.color = _loc13_.color;
            }
            if(_loc13_.hasRectLimits())
            {
               var_81.assign(_loc13_.width_min,_loc13_.width_max,_loc13_.height_min,_loc13_.height_max);
            }
         }
         if(param9)
         {
      ...
      {
         return this.var_740 != null ? this.var_740 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_507 = param1;
         var_262 = !!var_507 ? uint(var_262 | var_597) : uint(var_262 & 16777215);
         this.var_189 = this.var_189 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      
      public function set color(param1:uint) : void
      {
         var_597 = param1 & 4278190080;
         var_262 = !!var_507 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      {
         var_597 = param1 << 24;
         var_262 = !!var_507 ? uint(var_597 | var_262) : uint(16777215 & var_262);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1264);
      }
      ...
      {
         var_508 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_917);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_91)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1403) == -1)
               {
                  _loc4_.style = var_91;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_397 = this._parent.rectangle.clone();
               var_68.x = var_11.x;
               var_68.y = var_11.y;
               var_68.width = var_11.width;
               var_68.height = var_11.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_514,this,this._parent);
            ...
            else
            {
               this.var_397.x = 0;
               this.var_397.y = 0;
               this.var_397.width = 0;
               this.var_397.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1734,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_854,var_11);
            this.var_22.visible = var_326;
         }
         return this.var_22;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_91,var_21,_context,var_11,null,this.var_740,this.properties,var_918.concat(),_id) as WindowController;
         _loc2_.var_508 = var_508;
         _loc2_.var_189 = this.var_189;
         _loc2_._debug = this._debug;
         _loc2_.var_397 = this.var_397.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_426 = var_426.clone();
         _loc2_.var_68 = var_68.clone();
         _loc2_.var_161 = !!var_161 ? var_161.clone() : null;
         _loc2_.var_162 = !!var_162 ? var_162.clone() : null;
         _loc2_.var_81 = !!var_81 ? var_81.clone(_loc2_) : null;
         _loc2_._context = _context;
         _loc2_.var_262 = var_262;
         _loc2_.var_597 = var_597;
         _loc2_.var_738 = var_738;
         _loc2_.var_326 = var_326;
         _loc2_._blend = _blend;
         _loc2_.var_21 = var_21;
         _loc2_._state = _state;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_18;
         _loc2_.background = var_507;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2798 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            _loc7_ = uint(var_21 & 0);
            if(_loc7_ == WindowParam.const_553)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_524)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_21 & 0);
            if(_loc7_ == WindowParam.const_628)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_613)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         }
         if(testParamFlag(WindowParam.const_104))
         {
            if(this._parent != null)
            {
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1246,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_410,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_161 != null)
         {
            param3.x = var_161.x;
            param3.y = var_161.y;
            param3.width = var_161.width;
            param3.height = var_161.height;
         }
         if(param4 != null && var_162 != null)
         {
            param4.x = var_162.x;
            param4.y = var_162.y;
            param4.width = var_162.width;
            param4.height = var_162.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            if(var_162 == null)
            {
               var_162 = new Rectangle();
            }
            var_162.x = param3.x;
            var_162.y = param3.y;
            var_162.width = param3.width;
            var_162.height = param3.height;
         }
         if(param2 != null)
         {
            ...
            if(var_161 == null)
            {
               var_161 = new Rectangle();
            }
            var_161.x = param2.x;
            var_161.y = param2.y;
            var_161.width = param2.width;
            var_161.height = param2.height;
         }
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_750))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_45:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1256;
                  if(testParamFlag(WindowParam.const_402))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_297))
                        {
                  ...
                  if((var_21 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_324))
                        {
                           _context.getWindowServices().getMouseScalingService().begin(_loc3_,var_21 & 0);
                           break;
                        }
                        _loc3_ = _loc3_.parent;
                     }
               ...
               case WindowMouseEvent.const_58:
                  ...
                  if(testParamFlag(WindowParam.const_297))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_39:
                  _context.invalidate(this,var_11.union(var_68),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_658,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_232,WindowParam.const_183))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_214,WindowParam.const_180))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc7_ = uint(var_21);
                        var_21 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_532))
                        {
                           this._parent.width += 0 - 0;
                        }
                        if(testParamFlag(WindowParam.const_495))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_21 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_147,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_410:
                  _loc6_ = var_11.union(var_68);
                  if(this._parent)
                  {
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1235);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1765,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_219,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_587:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1238,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_372,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_514:
                  if(testParamFlag(WindowParam.const_232,WindowParam.const_183))
                  {
                     this.updateScaleRelativeToParent();
                  }
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
                  break;
               case WindowEvent.const_658:
                  this._parent.getRegionProperties(null,this.var_397);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowEvent.const_619:
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_508);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_508);
      }
         ...
         if(this.var_189 && var_508 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1124,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1124,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:* = null;
         var _loc3_:uint = var_91;
         var _loc7_:*;
         var_91 = !!param2 ? (_loc7_ = var_91 | param1, var_91 |= param1, uint(_loc7_)) : (_loc7_ = var_91 & ~param1, var_91 &= ~param1, uint(_loc7_));
         if(var_91 != _loc3_)
         {
            _loc4_ = new Array();
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1403) == -1)
               {
                  _loc6_.style = var_91;
               }
            }
      ...
      {
         return (var_21 & param1) != 0;
      }
      
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         var _loc3_:uint = var_21;
         var _loc4_:*;
         var_21 = !!param2 ? (_loc4_ = var_21 | param1, var_21 |= param1, uint(_loc4_)) : (_loc4_ = var_21 & ~param1, var_21 &= ~param1, uint(_loc4_));
         if(var_21 != _loc3_)
         {
            if(!(var_21 & 0))
            {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_156,WindowParam.const_183);
         var _loc2_:* = !testParamFlag(WindowParam.const_169,WindowParam.const_180);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_397.width;
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_446)
               {
                  _loc3_.width += _loc4_;
               }
               ...
               else if(_loc5_ == WindowParam.const_232)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_397.height;
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_358)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_255)
               {
                  _loc3_.y += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_214)
               {
         ...
         else if(testParamFlag(WindowParam.const_104))
         {
            _loc3_ = var_11.clone();
            if(this._parent != null)
            {
      ...
      {
         if(_state == WindowState.const_541)
         {
            return true;
         }
         _state = WindowState.const_541;
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1798,this,null);
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_332,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1747,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1841,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1963,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_72,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1966,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1866,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1926,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1794,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_587,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1781,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_516,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1870,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_72,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1752,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1930,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_72,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1901,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         if(!this.getStateFlag(WindowState.const_87))
         {
            return true;
         }
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_841,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_87,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_247,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_767,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_87,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_270,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1710,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1310 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_619,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1310 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_619,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_436,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
