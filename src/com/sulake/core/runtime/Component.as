package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_463:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_2241:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1200:uint = 4;
       
      
      protected var var_763:uint = 0;
      
      protected var var_1400:String = "";
      
      protected var var_2229:String = "";
      ...
      private var var_1576:uint;
      
      private var var_582:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_582 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_582.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_582.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1400 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1400);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1576 & const_1200)
         {
            if(_loc3_ == 0)
            {
               if(this.var_582.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_1107 = false;
            this._events.dispatchEvent(new LockEvent(const_463,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_763 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_582.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_582.getStructByIndex(_loc8_);
