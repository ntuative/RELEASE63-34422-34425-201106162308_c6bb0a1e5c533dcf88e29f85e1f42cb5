package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1133 = new LoaderContext();
         this.var_1133.checkPolicyFile = true;
         ...
         {
            this.var_45.load(param2,this.var_1133);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_351 = 0;
         this.var_45.load(param1,this.var_1133);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_351 < var_2999)
            {
               ...
               this.var_45.load(new URLRequest(this.var_1128 + (this.var_1128.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_351),this.var_1133);
               return true;
            }
         }
         return false;
