package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1179:String = "AssetLibraryReady";
      
      public static const const_880:String = "AssetLibraryLoaded";
      
      public static const const_1828:String = "AssetLibraryUnloaded";
      
      public static const const_2003:String = "AssetLibraryLoadError";
      
      private static const const_695:String = "name";
      
      private static const const_1096:String = "asset";
      
      private static const const_1095:String = "param";
      ...
      private static var var_1904:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_549:uint = 0;
      
      private static var var_1003:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_549;
         this.var_455 = new Dictionary(false);
         this.var_548 = new Dictionary(false);
         this.var_1002 = new Dictionary(false);
         this.var_175 = new Dictionary(false);
         var_1003.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_651 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1097);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1096);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_695);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1095);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_651 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1003.splice(var_1003.indexOf(this),1);
            --var_549;
            this.var_548 = null;
            this.var_1002 = null;
            this.var_175 = null;
      ...
      {
         if(this.var_651 == param1.url && this.var_1001)
         {
            if(!this.var_1004 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_652);
            }
            this.var_1004 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1179));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         {
            _loc2_ = this.var_548[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_548[_loc1_];
         }
         for(_loc1_ in this.var_175)
         {
            delete this.var_175[_loc1_];
         }
         for(_loc1_ in this.var_1002)
         {
            delete this.var_1002[_loc1_];
         }
         if(this.var_45 != null)
         {
            this.var_45.dispose();
         ...
         this.var_1001 = false;
         this.var_651 = null;
         dispatchEvent(new Event(AssetLibrary.const_1828));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1002[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_548[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1382,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1389,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1378,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1186,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_548[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_548[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_175[struct.assetName] == null)
                  {
                     ++this.var_456;
                     this.var_454.push(struct.assetName);
                  }
                  this.var_175[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_548[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_175[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_454.length ? this.getAssetByName(this.var_454[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_175)
         {
            if(this.var_175[_loc2_] == param1)
            {
               return this.var_454.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_175[param1] != null || (this.var_652 != null ? this.var_652[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_175[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            if(_loc4_)
            {
               ++this.var_456;
               this.var_454.push(param1);
            }
            this.var_175[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_1904.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_175)
            {
               if(this.var_175[_loc2_] == param1)
               {
                  this.var_454.splice(this.var_454.indexOf(_loc2_),1);
                  delete this.var_175[_loc2_];
                  --this.var_456;
                  return param1;
               }
            }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_455.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_455[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_455[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_455)
         {
            _loc3_ = AssetTypeDeclaration(this.var_455[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_455)
         {
            _loc4_ = AssetTypeDeclaration(this.var_455[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_652 = _loc2_.resource;
         this.var_651 = _loc2_.url;
         if(this.var_1004)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_652);
         }
         this.var_1001 = true;
         dispatchEvent(new Event(AssetLibrary.const_880));
         dispatchEvent(new Event(AssetLibrary.const_1179));
         if(this.var_1004)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_2003));
         this.var_45 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1097);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1096);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_695) && _loc3_.attribute(const_695).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_651 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_652[param1]);
                     _loc6_ = _loc3_.child(const_1095);
