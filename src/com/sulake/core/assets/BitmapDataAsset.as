package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_602:uint = 0;
      
      protected static var var_587:uint = 0;
       
      
      private var _disposed:Boolean = false;
      
      private var var_116:Object;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_587 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_116 is Class)
         {
            _loc1_ = new this.var_116() as Bitmap;
            if(_loc1_ != null)
            {
            ...
            this._bitmap = new this.var_116() as BitmapData;
            if(this._bitmap != null)
            {
               this.var_116 = null;
               return;
         ...
         if(this.var_116 is Bitmap)
         {
            this._bitmap = Bitmap(this.var_116).bitmapData;
            if(this._bitmap == null)
            {
         ...
         if(this.var_116 is BitmapData)
         {
            this._bitmap = this.var_116 as BitmapData;
            if(this._bitmap != null)
            {
               this.var_116 = null;
               return;
         ...
         if(this.var_116 is BitmapDataAsset)
         {
            this._bitmap = BitmapDataAsset(this.var_116)._bitmap;
            this._offset = BitmapDataAsset(this.var_116)._offset;
            this.var_1439 = BitmapDataAsset(this.var_116).var_1439;
            this.var_1438 = BitmapDataAsset(this.var_116).var_1438;
            if(this._bitmap != null)
            {
               this.var_116 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1439 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1438 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
